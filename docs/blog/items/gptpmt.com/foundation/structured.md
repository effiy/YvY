# 原始URL: https://gptpmt.com/foundation/structured
...
`CTRL K`
  ...
  * [基础篇](https://gptpmt.com/foundation)
    ...
    * [结构化Prompt模板与技巧](https://gptpmt.com/foundation/structured)
      ...
      * [一个好的Prompt应该包含什么？](https://gptpmt.com/foundation/structured#一个好的prompt应该包含什么)
      * [Prompt标准化结构](https://gptpmt.com/foundation/structured#prompt标准化结构)
...
[Question? Give us feedback → (opens in a new tab)](https://github.com/CarGod/gptpmt/issues/new?title=Feedback%20for%20%E2%80%9C%E7%BB%93%E6%9E%84%E5%8C%96Prompt%E6%A8%A1%E6%9D%BF%E4%B8%8E%E6%8A%80%E5%B7%A7%E2%80%9D&labels=feedback)[Edit this page](https://github.com/CarGod/gptpmt/pages/foundation/structured.zh.mdx)
[基础篇](https://gptpmt.com/foundation)
结构化Prompt模板与技巧
# 结构化Prompt模板与技巧
## 无规矩不成方圆[](https://gptpmt.com/foundation/structured#无规矩不成方圆)
...
💬
恭喜学完本章节，你已经了解了一个优秀的Prompt应该具备什么样的结构，并且掌握了一个常用的Prompt结构化模版。如果你有任何疑问或想要跟大家进行交流，欢迎到 [Github issues (opens in a new tab)](https://github.com/CarGod/gptpmt/issues/new?labels=feedback) 发表学习心得以及反馈问题 👏🏻
微信扫码关注公众号，开启专属于你的
Ai 新纪元
🎉
...
[获得优质输出的六大技巧](https://gptpmt.com/foundation/grammar "获得优质输出的六大技巧")[让GPT输出JSON数据](https://gptpmt.com/foundation/json_format "让GPT输出JSON数据")
中文
System
