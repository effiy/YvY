# 原始URL: https://comfyui-wiki.com/zh/workflows

# 抓取时间: 2025-03-30 21:03:18

[Skip to content](https://comfyui-wiki.com/zh/workflows#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档](https://comfyui-wiki.com/zh/workflows#文档)
  * [WIP LLM辅助文档 每个节点的文档](https://comfyui-wiki.com/zh/workflows#wip-llm辅助文档-每个节点的文档)
  * [其他示例/信息来源：](https://comfyui-wiki.com/zh/workflows#其他示例信息来源)
  * [工作流程和其他一般信息：](https://comfyui-wiki.com/zh/workflows#工作流程和其他一般信息)
  * [自定义节点/扩展：](https://comfyui-wiki.com/zh/workflows#自定义节点扩展)
  * [ComfyUI自定义节点管理器](https://comfyui-wiki.com/zh/workflows#comfyui自定义节点管理器)
...
# [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 工作流示例
这个[仓库](https://github.com/comfyanonymous/ComfyUI_examples)包含了使用[ComfyUI](https://github.com/comfyanonymous/ComfyUI)所能实现的示例。这个仓库中的所有图片都包含元数据，这意味着它们可以通过ComfyUI的加载按钮加载（或拖放到窗口上）以获取用于创建图像的完整工作流程。
如果你对这些如何工作一无所知，可以从以下教程开始：
[ComfyUI基础教程 VN](https://comfyanonymous.github.io/ComfyUI_tutorial_vn/): 所有的艺术作品都是用ComfyUI制作的。（早期的，尚未完成）
这里有一些更高级的示例：
All (20)Img2imgText2imgUpscale (2)InpaintLoraControlNetEmbeddingsModel mergingSdxlCascadeUnCLIP3d视频LcmTurbo
[![1. 图生图工作流](https://comfyui-wiki.com/cover/workflows/img2img.jpg)](https://comfyui-wiki.com/zh/workflows/img2img)
[1. 图生图工作流](https://comfyui-wiki.com/zh/workflows/img2img)
Img2img
[![2. 两步文生图工作流](https://comfyui-wiki.com/cover/workflows/2-pass-txt2img.jpg)](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img)
[2. 两步文生图工作流](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img)
以下是一些示例，展示了如何实现“高分辨率修复”功能。
Text2img
Upscale
[![3. 局部重绘工作流](https://comfyui-wiki.com/cover/workflows/inpaint.jpg)](https://comfyui-wiki.com/zh/workflows/inpaint)
[3. 局部重绘工作流](https://comfyui-wiki.com/zh/workflows/inpaint)
Inpaint
[![4. 区域合成工作流](https://comfyui-wiki.com/cover/workflows/area-composition.jpg)](https://comfyui-wiki.com/zh/workflows/area-composition)
[4. 区域合成工作流](https://comfyui-wiki.com/zh/workflows/area-composition)
[![5. 超分辨率模型工作流](https://comfyui-wiki.com/cover/workflows/upscale-models.jpg)](https://comfyui-wiki.com/zh/workflows/upscale-models)
[5. 超分辨率模型工作流](https://comfyui-wiki.com/zh/workflows/upscale-models)
这篇文章介绍了 ComfyUI 的放大模型示例。
Upscale
[![6. LoRA 模型工作流](https://comfyui-wiki.com/cover/workflows/lora.jpg)](https://comfyui-wiki.com/zh/workflows/lora)
[6. LoRA 模型工作流](https://comfyui-wiki.com/zh/workflows/lora)
Lora
[![7. ControlNet 工作流](https://comfyui-wiki.com/cover/workflows/controlnet.jpg)](https://comfyui-wiki.com/zh/workflows/controlnet)
[7. ControlNet 工作流](https://comfyui-wiki.com/zh/workflows/controlnet)
ControlNet
[![8. 噪声潜空间合成工作流](https://comfyui-wiki.com/cover/workflows/noisy-latent-composition.jpg)](https://comfyui-wiki.com/zh/workflows/noisy-latent-composition)
[8. 噪声潜空间合成工作流](https://comfyui-wiki.com/zh/workflows/noisy-latent-composition)
[![9. 文本反转嵌入工作流](https://comfyui-wiki.com/cover/workflows/textual-inversion-embeddings.jpg)](https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings)
[9. 文本反转嵌入工作流](https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings)
Embeddings
[![10. 模型编辑工作流](https://comfyui-wiki.com/cover/workflows/edit-models.jpg)](https://comfyui-wiki.com/zh/workflows/edit-models)
[10. 模型编辑工作流](https://comfyui-wiki.com/zh/workflows/edit-models)
[![11. 模型合并工作流](https://comfyui-wiki.com/cover/workflows/model-merging.jpg)](https://comfyui-wiki.com/zh/workflows/model-merging)
[11. 模型合并工作流](https://comfyui-wiki.com/zh/workflows/model-merging)
Model merging
[![12. SDXL 工作流](https://comfyui-wiki.com/cover/workflows/sdxl.jpg)](https://comfyui-wiki.com/zh/workflows/sdxl)
[12. SDXL 工作流](https://comfyui-wiki.com/zh/workflows/sdxl)
Sdxl
[![13. Stable Cascade 工作流](https://comfyui-wiki.com/cover/workflows/stable-cascade.jpg)](https://comfyui-wiki.com/zh/workflows/stable-cascade)
[13. Stable Cascade 工作流](https://comfyui-wiki.com/zh/workflows/stable-cascade)
Cascade
[![14. UnCLIP 工作流](https://comfyui-wiki.com/cover/workflows/unclip.jpg)](https://comfyui-wiki.com/zh/workflows/unclip)
[14. UnCLIP 工作流](https://comfyui-wiki.com/zh/workflows/unclip)
ComfyUI 的 unCLIP 模型示例,以及对应工作流
UnCLIP
[![15. Hypernetworks 工作流](https://comfyui-wiki.com/cover/workflows/hypernetworks.jpg)](https://comfyui-wiki.com/zh/workflows/hypernetworks)
[15. Hypernetworks 工作流](https://comfyui-wiki.com/zh/workflows/hypernetworks)
[![16. Gligen 工作流](https://comfyui-wiki.com/cover/workflows/gligen.jpg)](https://comfyui-wiki.com/zh/workflows/gligen)
[16. Gligen 工作流](https://comfyui-wiki.com/zh/workflows/gligen)
[![17. 3D 示例工作流](https://comfyui-wiki.com/cover/workflows/3d.jpg)](https://comfyui-wiki.com/zh/workflows/3d)
[17. 3D 示例工作流](https://comfyui-wiki.com/zh/workflows/3d)
This article introduces some examples of 3D generation in ComfyUI.
3d
[![18. 视频生成工作流](https://comfyui-wiki.com/cover/workflows/video.jpg)](https://comfyui-wiki.com/zh/workflows/video)
[18. 视频生成工作流](https://comfyui-wiki.com/zh/workflows/video)
这篇文章介绍了 ComfyUI 的图生视频示例。
视频
[![LCM 示例](https://comfyui-wiki.com/cover/workflows/lcm.jpg)](https://comfyui-wiki.com/zh/workflows/lcm)
[LCM 示例](https://comfyui-wiki.com/zh/workflows/lcm)
Lcm
[![ComfyUI SDXL Turbo 示例](https://comfyui-wiki.com/cover/workflows/sdturbo.jpg)](https://comfyui-wiki.com/zh/workflows/sdturbo)
[ComfyUI SDXL Turbo 示例](https://comfyui-wiki.com/zh/workflows/sdturbo)
Turbo
## 文档[](https://comfyui-wiki.com/zh/workflows#文档)
#### [WIP LLM辅助文档](https://docs.getsalt.ai/md/) 每个节点的文档[](https://comfyui-wiki.com/zh/workflows#wip-llm辅助文档-每个节点的文档)
旧的[节点指南(WIP)](https://blenderneko.github.io/ComfyUI-docs/)记录了大多数节点的功能。
你也可能想要查看：[常见问题](https://comfyui-wiki.com/zh/faq)
...
#### 自定义节点/扩展：[](https://comfyui-wiki.com/zh/workflows#自定义节点扩展)
ComfyUI是可扩展的，许多人为它编写了一些很棒的自定义节点。
请注意，如果其中之一破坏了你的工作流程，你的ComfyUI安装或任何其他东西，我不负责任。
以下是你可以找到一些自定义节点的地方：
#### [ComfyUI自定义节点管理器](https://github.com/ltdrdata/ComfyUI-Manager)[](https://comfyui-wiki.com/zh/workflows#comfyui自定义节点管理器)
<https://github.com/WASasquatch/comfyui-plugins>
[如果你滚动到这篇博客文章的底部](https://comfyanonymous.github.io/ComfyUI_Blog/comfyui/update/2023/05/18/ComfyUi-is-4-months-old.html)
Last updated on 2025年3月24日
[Terminal Log (Manager)](https://comfyui-wiki.com/zh/comfyui-nodes/utils/terminal-log "Terminal Log \(Manager\)")[1. 图生图工作流](https://comfyui-wiki.com/zh/workflows/img2img "1. 图生图工作流")
中文
System
