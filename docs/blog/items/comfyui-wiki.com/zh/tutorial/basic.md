# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic

# 抓取时间: 2025-03-30 21:02:04

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic#reach-skip-nav)
...
# ComfyUI 基础入门教程
## ComfyUI 基础教程
开始了解 ComfyUI 的一些基础功能
All (11)InpaintingOutpaintingEmbeddingSD1.5 (2)LoRA
[![1.启动服务](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve)
[1.启动服务](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve)
这篇文章介绍了如何启动 ComfyUI 服务。
[![2.首次图片生成](https://comfyui-wiki.com/cover/images/first-image.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time)
[2.首次图片生成](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time)
使用ComfyUI默认设置进行图片生成
[![3.与WebUI共用模型设置](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/link-models-between-comfyui-and-a1111)
[3.与WebUI共用模型设置](https://comfyui-wiki.com/zh/tutorial/basic/link-models-between-comfyui-and-a1111)
这篇文章介绍了 ComfyUI 与其它 Stable diffusion AI绘图 WebUI 要如何共享绘图模型。
[![4.如何升级ComfyUI](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui)
[4.如何升级ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui)
这篇文章介绍了如何升级 ComfyUI。
[![5.安装不同类型的模型](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/how-to-install-different-type-of-models)
[5.安装不同类型的模型](https://comfyui-wiki.com/zh/tutorial/basic/how-to-install-different-type-of-models)
不同模型安装的和使用的基础教程
[![6.提示词基础](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic)
[6.提示词基础](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic)
这篇文章介绍了 ComfyUI 中一些简单的 Prompt 书写要求和规则。
[![7.局部重绘](https://comfyui-wiki.com/tutorial/basic/inpainting.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/how-to-inpaint-an-image-in-comfyui)
[7.局部重绘](https://comfyui-wiki.com/zh/tutorial/basic/how-to-inpaint-an-image-in-comfyui)
本篇将讲解在 ComfyUI 中如何进行局部重绘的工作流以及完整说明和示例问文件
Inpainting
[![8.扩图](https://comfyui-wiki.com/cover/workflows/basic-outpainting.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui)
[8.扩图](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui)
ComfyUI 扩图教程及工作流，详细介绍如何使用 ComfyUI 进行图片扩展
Outpainting
[![9.图像放大](https://comfyui-wiki.com/cover/images/upscale-image.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/upscale-image)
[9.图像放大](https://comfyui-wiki.com/zh/tutorial/basic/upscale-image)
本教程介绍了 ComfyUI 中三种不同的图片放大方法：像素重新采样、SD二次采样放大以及使用专门的放大模型。每种方法都有其特点和适用场景。
[![10. Embedding](https://comfyui-wiki.com/cover/embedding.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/embedding)
[10. Embedding](https://comfyui-wiki.com/zh/tutorial/basic/embedding)
本教程详细介绍了在ComfyUI中如何使用Embedding模型，包括模型下载、安装、使用方法等。
Embedding
SD1.5
[![11. LoRA](https://comfyui-wiki.com/cover/images/lora.jpg)](https://comfyui-wiki.com/zh/tutorial/basic/lora)
[11. LoRA](https://comfyui-wiki.com/zh/tutorial/basic/lora)
本教程详细介绍了在ComfyUI中如何使用LoRA模型，从基础的单模型使用到多个LoRA模型的组合应用，实现更丰富的AI绘画效果。包括模型安装、参数调整等详细步骤说明。
LoRA
SD1.5
