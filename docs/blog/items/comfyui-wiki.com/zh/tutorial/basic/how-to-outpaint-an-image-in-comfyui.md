# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui

# 抓取时间: 2025-03-30 21:02:07

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ComfyUI 扩图教程相关文件下载](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-扩图教程相关文件下载)
  * [ComfyUI工作流文件](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui工作流文件)
  * [Stable Diffusion 模型文件](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#stable-diffusion-模型文件)
  * [ComfyUI 基础扩图工作流使用方式](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-基础扩图工作流使用方式)
  * [ComfyUI 基础扩图工作流简单讲解](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-基础扩图工作流简单讲解)
  * [1. Text2Img 部分](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#1-text2img-部分)
  * [2. 创建扩图用的 Latent Image](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#2-创建扩图用的-latent-image)
  * [3. 扩图生成](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#3-扩图生成)
  * [使用说明](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#使用说明)
  * [ComfyUI 基础扩图工作流注意事项](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-基础扩图工作流注意事项)
  * [ComfyUI 基础扩图工作流结构](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-基础扩图工作流结构)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")8.扩图
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
![basic-outpainting-workflow](https://comfyui-wiki.com/_next/static/media/basic-outpainting-workflow.2ef5dee6.jpg)
# ComfyUI 基础扩图工作流以及教程
...
模型名称| 用途| 仓库地址| 下载地址  
---|---|---|---  
`v1-5-pruned-emaonly.safetensors`| 生成初始图像| [仓库地址](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5/)| [下载地址](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5/blob/main/v1-5-pruned-emaonly.safetensors)  
`sd-v1-5-inpainting.ckpt`| 扩图| [仓库地址](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-inpainting)| [下载地址](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-inpainting/resolve/main/sd-v1-5-inpainting.ckpt?download=true)  
下载后请将这两个模型文件放置在以下目录:
  * `Path-to-your-ComfyUI/models/checkpoints`


如果你想要了解更多：[如何安装 Checkpoints 模型](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint) 如果你要查找使用其它模型：[Stable Diffusion 模型资源](https://comfyui-wiki.com/zh/resource/stable-diffusion-models)
## ComfyUI 基础扩图工作流使用方式[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#comfyui-基础扩图工作流使用方式)
...
## 使用说明[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-outpaint-an-image-in-comfyui#使用说明)
  1. 调整扩展区域:
     * 在 `ImagePadForOutpaint` 节点中设置四个方向的扩展像素值
     * 数值代表要在该方向扩展的像素数量
  2. 提示词设置:
     * 正面提示词描述你想要的场景和风格
     * 负面提示词帮助避免不想要的元素出现
