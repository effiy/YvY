# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic

# 抓取时间: 2025-03-30 21:02:05

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [第一部分：提示词书写的基础规则](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#第一部分提示词书写的基础规则)
  * [英文书写](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#英文书写)
  * [词组使用](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#词组使用)
  * [注释支持](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#注释支持)
  * [权重管理](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#权重管理)
  * [第二部分：Comfy UI提示词的权重规则和语法](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#第二部分comfy-ui提示词的权重规则和语法)
  * [权重表达](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#权重表达)
  * [快速权重调整](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#快速权重调整)
  * [降权方法](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#降权方法)
  * [随机生成](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#随机生成)
  * [第三部分：提示词书写建议及辅助工具推荐](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#第三部分提示词书写建议及辅助工具推荐)
  * [3.1 提示词结构化书写规则](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#31-提示词结构化书写规则)
  * [3.2 提示词抄作业网站推荐](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#32-提示词抄作业网站推荐)
  * [3.3 提示词书写辅助网站推荐](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#33-提示词书写辅助网站推荐)
  * [第四部分：提示词增强插件推荐](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#第四部分提示词增强插件推荐)
  * [4.1 ComfyUI-Custom-Scripts](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#41-comfyui-custom-scripts)
  * [4.2 ComfyUI ArtGallery](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#42-comfyui-artgallery)
  * [4.3 comfyui-prompt-composer](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#43-comfyui-prompt-composer)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")6.提示词基础
←→
...
💡
本篇文章撰写的时候，还仅有类似 SDXL 之类版本的模型，对于多语言支持并不丰富，但随着后来的发展有些模型的提示词以及不再限定为英文了，但大多数条件下，建议使用英文来达到比较好的效果。
### 词组使用[](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#词组使用)
...
### 3.3 提示词书写辅助网站推荐[](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#33-提示词书写辅助网站推荐)
  * AI辅助生成提示词： 
    * [Drawing Prompt](https://drawing-prompt.com/zh-Hans)
    * [PromptPerfect](https://promptperfect.jina.ai/)
  * 提示词可视化： 
    * [Danbooru 标签超市](https://tags.novelai.dev/)（使用体验最佳）
...
更多信息请访问：[GitHub - pythongosssss/ComfyUI-Custom-Scripts](https://github.com/pythongosssss/ComfyUI-Custom-Scripts)
### 4.2 ComfyUI ArtGallery[](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#42-comfyui-artgallery)
这个插件提供了风格提示词的可视化预览，帮助用户更好地理解和选择适合的提示词风格。
更多信息请访问：[GitHub - ZHO-ZHO-ZHO/ComfyUI-ArtGallery](https://github.com/ZHO-ZHO-ZHO/ComfyUI-ArtGallery)
作者B站视频：[提示词可视化｜ComfyUI ArtGallery｜艺术画廊｜Stable Diffusion](https://www.bilibili.com/video/BV1JN4y1s7he/)
### 4.3 comfyui-prompt-composer[](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic#43-comfyui-prompt-composer)
这个工具提供了提示词的组织节点化管理，帮助用户更有效地管理和组合提示词。
更多信息请访问：[GitHub - florestefano1975/comfyui-prompt-composer](https://github.com/florestefano1975/comfyui-prompt-composer)
