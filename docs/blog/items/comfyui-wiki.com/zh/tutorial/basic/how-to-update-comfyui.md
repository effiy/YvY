# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui

# 抓取时间: 2025-03-30 21:02:05

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Windows 使用 ComfyUI 官便版本的用户如何升级更新 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#windows-使用-comfyui-官便版本的用户如何升级更新-comfyui)
  * [手动安装 ComfyUI 的用户如何通过 Git 升级更新 ComfyUI 版本](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#手动安装-comfyui-的用户如何通过-git-升级更新-comfyui-版本)
  * [使用 秋叶启动器 的用户如何升级更新 ComfyUI 版本](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#使用-秋叶启动器-的用户如何升级更新-comfyui-版本)
  * [ComfyUI Manager 用户](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#comfyui-manager-用户)
  * [如何升级 ComfyUI 的 Web 前端](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#如何升级-comfyui-的-web-前端)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")4.如何升级ComfyUI
←→
...
本篇讲解将涉及以下几种升级ComfyUI的方法:
  ...
  4. 如果你安装了 ComfyUI Manager 则你可以通过 ComfyUI Manager 来升级更新 ComfyUI
  5. ComfyUI Desktop ,目前 ComfyUI Desktop 的版本是采用自动更新的，正常情况下检测到有新版本会自动提示更新，或者你可以访问 [ComfyUI Desktop 的 Github 仓库](https://github.com/Comfy-org/Desktop) 查看最新版本
  6. 如何单独更新 ComfyUI 的 Web 前端
...
## 手动安装 ComfyUI 的用户如何通过 Git 升级更新 ComfyUI 版本[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#手动安装-comfyui-的用户如何通过-git-升级更新-comfyui-版本)
首先确保你的电脑已经是安装了 [Git](https://git-scm.com/) 并且你的ComfyUI 也是通过 Git 安装的代码
...
## 使用 秋叶启动器 的用户如何升级更新 ComfyUI 版本[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#使用-秋叶启动器-的用户如何升级更新-comfyui-版本)
  1. 打开秋叶启动器，点击 `版本管理`选项
  2. 在 `内核`选项卡，你可以看到最新的 ComfyUI 版本和日期
  3. 选择你想要切换到的版本，进行切换(Switch)即可


![秋叶启动器更新 ComfyUI](https://comfyui-wiki.com/_next/static/media/akkki-luncher-update-comfyui.1cfce345.jpg)
秋叶启动器会在你切换版本后自动更新 ComfyUI 的依赖。
## ComfyUI Manager 用户[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#comfyui-manager-用户)
ComfyUI Manager 插件内置了更新功能，你只需要在 `插件管理` 选项卡中找到 `ComfyUI Manager` 插件，点击 `update comfyui` ，如果一切顺利，运行完成之后重启 ComfyUI 即可。 ![update comfyui with comfyui-manager](https://comfyui-wiki.com/_next/static/media/comfyui-manager-update-comfyui.68ea5fa8.webp)
## 如何升级 ComfyUI 的 Web 前端[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui#如何升级-comfyui-的-web-前端)
目前 ComfyUI 的 Web 前端是使用 `comfyui-frontend-package` 这个包来管理的，你可以在 [这里](https://pypi.org/project/comfyui-frontend-package/#history) 查看对应包的更新历史，
对应的版本要求会在`ComfyUI/requirements.txt`文件中体现，ComfyUI 不一定会使用最新版本的 `comfyui-frontend-package`，所以如果你想要使用最新版本的 `comfyui-frontend-package`，你需要手动更新
```
...
如果你使用的是 ComfyUI Portable 版本，你只需要在 `ComfyUI_windows_portable\` 目录下打开命令行，然后运行以下命令
```
...
如果你在中国国内，如果遇到网络问题，可以尝试使用国内镜像来安装，比如添加 `-i https://pypi.tuna.tsinghua.edu.cn/simple` 参数来使用清华大学镜像
```
