# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time

# 抓取时间: 2025-03-30 21:02:04

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [准备工作](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#准备工作)
  * [加载 ComfyUI 预设的文生图工作流](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#加载-comfyui-预设的文生图工作流)
  * [加载模型并进行图片生成](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#加载模型并进行图片生成)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")2.首次图片生成
←→
...
## 准备工作[](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#准备工作)
在开始这个教程之前:
  1. 请先确保你已经安装好了 ComfyUI，如果你还没有安装请先按照 [ComfyUI 安装指南](https://comfyui-wiki.com/zh/install/install-comfyui) 进行安装
  2. 你的 ComfyUI 中至少应该有一个 [chekcpoint](https://comfyui-wiki.com/zh/resource/stable-diffusion-models) 模型


如果你没有安装对应的模型，我推荐你从以下模型开始(选择其中一个就可以了)：
  * Dreamshaper: 这是一个基于SD1.5 的模型，写实、人像变现上都有不错的效果，[前往下载](https://civitai.com/models/4384?modelVersionId=128713)
  * SD1.5: [前往下载](https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5/tree/main),找到 v1-5-pruned-emaonly.ckpt 下载即可
...
> 如果你需要了解详情说明可以参考[ComfyUI 如何安装 SD 模型](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint)
  1. 确定你已经启动了 ComfyUI 服务，如果没有启动请参考 [启动 ComfyUI 服务](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve) 进行启动


## 加载 ComfyUI 预设的文生图工作流[](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#加载-comfyui-预设的文生图工作流)
在运行 ComfyUI 之后如果没有加载默认的工作流，请参考下面图片的步骤加载 ComfyUI 默认的文生图工作流
![加载工作流](https://comfyui-wiki.com/_next/static/media/firset-image-workflow-1.435679c8.jpg)
  1. 点击侧边栏的 `Workflow` 面板
  2. 点击进入浏览工作流模板


![加载文生图工作流](https://comfyui-wiki.com/_next/static/media/firset-image-workflow-2-text2img.7edc419c.jpg)
  1. 默认工作流模板中选择`Image Generation` 加载默认的工作流


![missing model 提示](https://comfyui-wiki.com/_next/static/media/firset-image-workflow-3-missing-models.105373a4.jpg)
  1. 如果你出现了这个弹窗提示


  * 如果你有按我的建议自己下载了模型并进行安装，那么你可以忽略关闭这个弹窗
  * 如果你没有下载任何模型文件，你可以选择 点击 `Download` ComfyUI 会自动为你下载对应的模型文件到对应文件夹


## 加载模型并进行图片生成[](https://comfyui-wiki.com/zh/tutorial/basic/creating-your-first-image-by-the-first-time#加载模型并进行图片生成)
![加载图片](https://comfyui-wiki.com/_next/static/media/firset-image-workflow-4-gen-img.933d36b4.jpg)
  1. 在工作流加载完成后，请鼠标缩放到 [Load checkpoint](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/checkpoint-loader-simple) 的位置，在 `ckpt_name` 中选择你需要的模型文件，可以使用右键或者使用对应节点的箭头进行操作选择模型文件。
  2. 点击`Queue` 进行图片生成


![图片生成结果](https://comfyui-wiki.com/_next/static/media/firset-image-workflow-5-output.475322c1.jpg)
  1. 如果一切无误，你可以在 [Save Image](https://comfyui-wiki.com/zh/comfyui-nodes/image/save-image) 节点上看到生成的图片，你可以右键将对应图片保存到本地或者查看`ComfyUI/output` 文件夹下看看有没有其它的图片


你可以继续尝试修改提示词节点 [CLIP Text Encode](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/clip-text-encode),看看不同提示词带来的效果 8. 因为它连接到的是`[Ksampler](/zh/comfyui-nodes/sampling/k-sampler)`节点的` positive` 输入，所以在这里的文本框输入的内容是你想要在画面中出现的内容 9. 因为它连接到的是`[Ksampler](/zh/comfyui-nodes/sampling/k-sampler)`节点的` negative` 输入，所以在这里的文本框输入的内容是你不想要在画面中出现的内容
修改`8`和`9`处的内容，进行不同类型内容的尝试
关于提示词你可以查看： [ComfyUI提示词基础语法tips](https://comfyui-wiki.com/zh/tutorial/basic/stable-diffusion-prompt-basic)
