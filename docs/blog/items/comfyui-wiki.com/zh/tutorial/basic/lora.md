# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/lora

# 抓取时间: 2025-03-30 21:02:07

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/lora#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [准备工作](https://comfyui-wiki.com/zh/tutorial/basic/lora#准备工作)
  * [第一步：下载本篇教程所使用到的模型](https://comfyui-wiki.com/zh/tutorial/basic/lora#第一步下载本篇教程所使用到的模型)
  * [第二步：重启ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/lora#第二步重启comfyui)
  * [第三步：下载工作流文件并导入 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/lora#第三步下载工作流文件并导入-comfyui)
  * [工作流文件说明](https://comfyui-wiki.com/zh/tutorial/basic/lora#工作流文件说明)
  * [其它相关内容](https://comfyui-wiki.com/zh/tutorial/basic/lora#其它相关内容)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")11. LoRA
←→
...
![在 ComfyUI 中使用 LoRA](https://comfyui-wiki.com/_next/static/media/lora.82627401.jpg)
...
本篇教程提供了 ComfyUI 中使用多LoRA模型的基础教程，使用 SD1.5 模型,核心的节点是 [LoRA Loader](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader) 节点，它负责加载 LoRA 模型。
## 准备工作[](https://comfyui-wiki.com/zh/tutorial/basic/lora#准备工作)
### 第一步：下载本篇教程所使用到的模型[](https://comfyui-wiki.com/zh/tutorial/basic/lora#第一步下载本篇教程所使用到的模型)
如果你的电脑里面有其他的相关模型，那你可以跳过这一步，如果没有，那你可以下载本篇教程所使用到的模型
模型类型| 模型名称| 下载链接  
---|---|---  
SD1.5 模型| DreamShaper v8| [前往下载](https://civitai.com/models/4384?modelVersionId=128713)  
LoRA模型| 墨心/MoXin| [前往下载](https://civitai.com/models/12597/moxin?modelVersionId=14856)  
LoRA模型| 清漪/QingYi| [前往下载](https://civitai.com/models/383239?modelVersionId=427733)  
...
```
  ...
  1. 将DreamShaper模型放入 `models/checkpoints/SD1.5` 文件夹
  2. 将MoXin和QingYi的LoRA文件放入 `models/loras/SD1.5` 文件夹


💡
在这里在对应的模型目录使用 `SD1.5` 子文件夹的原因是，因为目前有大量的各种模型比如 SD1.5、SD3.0、SDXL、FLUX 等等，他们的模型资源并不一定通用，所以需要使用子文件夹来区分。另外你也可以重命名对应的模型文件添加上一些简单的模型信息说明，这样在后期模型数量很多时，可以方便进行区分。
### 第二步：重启ComfyUI[](https://comfyui-wiki.com/zh/tutorial/basic/lora#第二步重启comfyui)
安装完成后重启或刷新ComfyUI，让 ComfyUI 识别新增的模型
### 第三步：下载工作流文件并导入 ComfyUI[](https://comfyui-wiki.com/zh/tutorial/basic/lora#第三步下载工作流文件并导入-comfyui)
下载 SD1.5 基础 LoRA 工作流
## 工作流文件说明[](https://comfyui-wiki.com/zh/tutorial/basic/lora#工作流文件说明)
...
## 其它相关内容[](https://comfyui-wiki.com/zh/tutorial/basic/lora#其它相关内容)
[ComfyUI 加载 LoRA 节点功能说明](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader) [ComfyUI 中要如何安装 LoRA 模型](https://comfyui-wiki.com/zh/install/install-models/install-lora)
