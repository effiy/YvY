# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#使用-comfyui-portable-官方便携版本如何启动-comfyui

# 抓取时间: 2025-03-30 21:04:27

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ComfyUI Desktop 桌面版](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#comfyui-desktop-桌面版)
  * [使用 ComfyUI Portable 官方便携版本如何启动 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#使用-comfyui-portable-官方便携版本如何启动-comfyui)
  * [使用秋叶启动器如何启动 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#使用秋叶启动器如何启动-comfyui)
  * [如何在局域网内其它的设备访问当前运行的 ComfyUI 服务](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#如何在局域网内其它的设备访问当前运行的-comfyui-服务)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")1.启动服务
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 安装好 ComfyUI 之后要如何运行？
在开始这个教程之前:
  1. 请先确保你已经安装好了 ComfyUI
  2. 你的 ComfyUI 中至少应该有一个 [chekcpoint](https://comfyui-wiki.com/zh/resource/stable-diffusion-models) 模型，如果你仅仅是为了测试能否正常运行软件，这个步骤可以省略


如果你还没有安装 ComfyUI，请先按照 [ComfyUI 安装指南](https://comfyui-wiki.com/zh/install/install-comfyui) 进行安装,并且对应章节也已经将对应的首次生成图片的细节讲解完了
...
```
Starting server
To See the GUI go to: http://192.168.3.58:8188 // 这里的网址可能设备显示的不同
```

则说明 ComfyUI 已经成功启动，如果浏览器没有正常启动，你可以通过浏览器访问`To See the GUI go to:` 后的网址直接访问，如在上面的例子中应该是 <http://192.168.3.58:8188>
## 使用秋叶启动器如何启动 ComfyUI[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#使用秋叶启动器如何启动-comfyui)
![ComfyUI启动器界面](https://comfyui-wiki.com/_next/static/media/aaaki_start_up.25f61c10.jpg)
点击启动器首页中的右下角蓝色图标 ` ▶︎一键启动` 即可一键启动 ComfyUI，如果运行无误应该会自动为你打开 **控制台** 为你运行相关脚本
![ComfyUI主界面](https://comfyui-wiki.com/_next/static/media/aaaki_console.7df69bb8.jpg)
如上图，当你看到
```
Starting server
To See the GUI go to: http://192.168.3.58:8188 // 这里的网址可能设备显示的不同
...
则说明 ComfyUI 已经成功启动，如果浏览器没有正常启动，你可以通过浏览器访问`To See the GUI go to:` 后的网址直接访问，如在上面的例子中应该是 <http://192.168.3.58:8188>
## 如何在局域网内其它的设备访问当前运行的 ComfyUI 服务[](https://comfyui-wiki.com/zh/tutorial/basic/how-to-run-comfyui-serve#如何在局域网内其它的设备访问当前运行的-comfyui-服务)
如果你的 ComfyUI 已经在局域网内的设备部署，其设备想要访问当前设备的服务，不同客户端的访问方式有所不同 不过具体的教程我在 [如何在局域网中访问 ComfyUI](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan) 中有详细说明，你可以参考对应部分的说明进行设置
...
![Load checkpoint](https://comfyui-wiki.com/_next/static/media/comfyui_sys_console.a11d8075.jpg)
