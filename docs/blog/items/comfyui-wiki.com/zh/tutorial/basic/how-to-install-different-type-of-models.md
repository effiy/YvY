# 原始URL: https://comfyui-wiki.com/zh/tutorial/basic/how-to-install-different-type-of-models

# 抓取时间: 2025-03-30 21:02:05

[Skip to content](https://comfyui-wiki.com/zh/tutorial/basic/how-to-install-different-type-of-models#reach-skip-nav)
...
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 基础入门教程](https://comfyui-wiki.com/zh/tutorial/basic "ComfyUI 基础入门教程")5.安装不同类型的模型
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 如何在 ComfyUI 中安装各类型模型
