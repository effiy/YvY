# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced

# 抓取时间: 2025-03-30 21:02:09

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced#reach-skip-nav)
...
# ComfyUI 高级教程
## ComfyUI 高级教程
深入了解comfyUI的高级功能以及自定义技巧
All (20)Controlnet (6)CannySd1.5 (4)DepthOpenposeFlux (5)Img2img (2)Text2imgInpaintingSD3.5Video (4)I2v (2)HunyuanvideoIC-LightDeepseekT2vV2v3D
[![1. Controlnet 教程](https://comfyui-wiki.com/tutorial/controlnet/controlnet.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-install-and-use-controlnet-models-in-comfyui)
[1. Controlnet 教程](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-install-and-use-controlnet-models-in-comfyui)
这篇文章介绍了 ComfyUI 中如何安装和使用 ControlNet 模型。
Controlnet
[![1.1 SD1.5 Canny ControlNet](https://comfyui-wiki.com/cover/images/sd1.5-controlnet-canny.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-canny-controlnet-with-sd1.5)
[1.1 SD1.5 Canny ControlNet](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-canny-controlnet-with-sd1.5)
本教程详细介绍了如何在 ComfyUI 中使用 Canny ControlNet,包括安装配置、工作流使用和参数调整等内容,适合新手入门学习。
Controlnet
Canny
Sd1.5
[![1.2 SD1.5 Depth ControlNet](https://comfyui-wiki.com/cover/sd1.5-controlnet-depth-comfyui-wiki.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-depth-controlnet-with-sd1.5)
[1.2 SD1.5 Depth ControlNet](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-depth-controlnet-with-sd1.5)
本教程详细介绍了如何在 ComfyUI 中使用 Depth ControlNet，包括安装配置、工作流使用和参数调整等内容，帮助你更好地控制图像的深度信息和空间结构。
Controlnet
Depth
Sd1.5
[![1.3 SD1.5 OpenPose ControlNet](https://comfyui-wiki.com/cover/images/sd1.5-controlnet-openpose.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5)
[1.3 SD1.5 OpenPose ControlNet](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5)
本文详细介绍了 ComfyUI OpenPose ControlNet，包括安装配置、工作流使用和参数调整，提供一步步的安装和使用教程
Controlnet
Openpose
Sd1.5
[![1.4 SD1.5 多ControlNet组合使用](https://comfyui-wiki.com/cover/images/sd1.5-muti-controlnet.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-muti-contorlnet-in-comfyui)
[1.4 SD1.5 多ControlNet组合使用](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-muti-contorlnet-in-comfyui)
ComfyUI 中多个 ControlNet 组合使用的方法，通过在多个 ControlNet 之间串联 Apply ControlNet 节点，实现更精准的控制和生成效果。
Controlnet
Sd1.5
[![2.1 FLUX.1 文生图教程](https://comfyui-wiki.com/tutorial/flux-1.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-guide-workflow-and-examples)
[2.1 FLUX.1 文生图教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-guide-workflow-and-examples)
这篇文章介绍了 Flux.1 ComfyUI 的安装指南、工作流和示例。
Flux
Img2img
[![2.2 FLUX.1 图生图教程](https://comfyui-wiki.com/tutorial/flux-1.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-image-to-image-workflow-example)
[2.2 FLUX.1 图生图教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-image-to-image-workflow-example)
这篇文章介绍了 Flux ComfyUI 的图生图工作流教程。
Flux
Text2img
[![2.3 FLUX.1 Fill](https://comfyui-wiki.com/cover/images/flux-fill-workflow.jpeg)](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide)
[2.3 FLUX.1 Fill](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide)
学习如何使用 Flux Fill 模型进行图像修复和扩展
Flux
Inpainting
[![2.4 FLUX.1 Redux](https://comfyui-wiki.com/cover/images/redux.png)](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide)
[2.4 FLUX.1 Redux](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide)
学习如何使用 Flux Redux 模型进行图像变体生成
Flux
Img2img
[![2.5 FLUX.1 ControlNet](https://comfyui-wiki.com/cover/images/flux-contorlnet-workflow.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide)
[2.5 FLUX.1 ControlNet](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide)
详细介绍如何在ComfyUI中使用Flux官方ControlNet模型的分步指南
Flux
Controlnet
[![3. SD 3.5 文生图教程](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow)
[3. SD 3.5 文生图教程](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow)
这篇文章介绍了 Stable Diffusion 3.5 在 ComfyUI 中的工作流教程。
SD3.5
[![4. LTX 视频生成教程](https://github.com/Lightricks/LTX-Video/raw/main/docs/_static/ltx-video_example_00004.gif)](https://comfyui-wiki.com/zh/tutorial/advanced/ltx-video-workflow-step-by-step-guide)
[4. LTX 视频生成教程](https://comfyui-wiki.com/zh/tutorial/advanced/ltx-video-workflow-step-by-step-guide)
学习如何使用 LTX Video 模型进行视频生成和编辑
Video
[![5.1. 腾讯混元 文生视频](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/hunyuan-text-to-video-workflow-guide-and-example)
[5.1. 腾讯混元 文生视频](https://comfyui-wiki.com/zh/tutorial/advanced/hunyuan-text-to-video-workflow-guide-and-example)
[![5.2. 腾讯混元 图生视频](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/hunyuan-image-to-video-workflow-guide-and-example)
[5.2. 腾讯混元 图生视频](https://comfyui-wiki.com/zh/tutorial/advanced/hunyuan-image-to-video-workflow-guide-and-example)
详细介绍如何在 ComfyUI 中使用腾讯混元 HunyuanVideo 模型进行图生视频生成的完整教程，包括环境配置、模型安装和工作流使用说明
Video
I2v
Hunyuanvideo
[![6. IC Light V2](https://comfyui-wiki.com/cover/images/ic-light-v2.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/ic-light-v2)
[6. IC Light V2](https://comfyui-wiki.com/zh/tutorial/advanced/ic-light-v2)
通过 Hugging Face Space 在线体验 IC-Light V2 的图像编辑功能，无需本地部署即可使用这个强大的图像处理工具
IC-Light
[![7. DeepSeek Janus Pro](https://comfyui-wiki.com/cover/images/deepseek-janus-pro.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow)
[7. DeepSeek Janus Pro](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow)
如何在 ComfyUI 中设置和使用 DeepSeek Janus Pro，基于 ComfyUI-Janus-Pro 插件
Deepseek
[![8. Lumina Image 2](https://comfyui-wiki.com/cover/images/lumina-image-2.0.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2)
[8. Lumina Image 2](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2)
详细讲解 Lumina Image 2.0 模型在 ComfyUI 中的使用方法，包含模型安装、工作流配置和参数优化建议。
[![9. Sonic Video](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video)
[9. Sonic Video](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video)
腾讯 Sonic ComfyUI 工作流详细教程
Video
[![10. Wan2.1](https://comfyui-wiki.com/cover/images/wan2.1.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/wan21-video-model)
[10. Wan2.1](https://comfyui-wiki.com/zh/tutorial/advanced/wan21-video-model)
本教程详细介绍了如何在 ComfyUI 中使用通义 Wan2.1 模型，包括安装配置、工作流使用和参数调整等内容，包括文生视频、图生视频、视频转视频等。
Video
T2v
I2v
V2v
[![Hunyuan3D 2.0 ComfyUI 工作流完整指南，ComfyUI-Hunyuan3DWrapper 和 ComfyUI 原生支持工作流示例](https://comfyui-wiki.com/cover/hunyuan3d_2.jpg)](https://comfyui-wiki.com/zh/tutorial/advanced/3d/huanyuan3d-2)
[Hunyuan3D 2.0 ComfyUI 工作流完整指南，ComfyUI-Hunyuan3DWrapper 和 ComfyUI 原生支持工作流示例](https://comfyui-wiki.com/zh/tutorial/advanced/3d/huanyuan3d-2)
本篇指南包含 Hunyuan3D 2.0 ComfyUI 工作流完整指南，包括单视角和多视角的完整工作流，并提供对应的模型下载链接
3D
