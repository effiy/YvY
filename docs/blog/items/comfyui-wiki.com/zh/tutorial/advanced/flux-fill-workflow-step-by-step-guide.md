# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide

# 抓取时间: 2025-03-30 21:02:11

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Flux Fill 模型简介](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#flux-fill-模型简介)
  * [准备工作](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#准备工作)
  * [1. 更新 ComfyUI](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#1-更新-comfyui)
  * [2. 下载必要模型](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#2-下载必要模型)
  * [3. 下载工作流文件](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#3-下载工作流文件)
  * [工作流使用指南](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#工作流使用指南)
  * [工作流节点说明](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#工作流节点说明)
  * [使用步骤](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#使用步骤)
  * [参数调优建议](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#参数调优建议)
  * [常见问题解决](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#常见问题解决)
  * [进阶技巧](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#进阶技巧)
  * [示例展示](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#示例展示)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")2.3 FLUX.1 Fill
←→
...
![Fulx Fill Workflow](https://comfyui-wiki.com/_next/static/media/flux-fill-workflow.2904e935.jpeg)
...
Flux Fill 模型仓库地址: [Flux Fill](https://huggingface.co/black-forest-labs/FLUX.1-Fill-dev)
## 准备工作[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#准备工作)
### 1. 更新 ComfyUI[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#1-更新-comfyui)
...
`t5xxl_fp16.safetensors`| `ComfyUI/models/clip`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp16.safetensors)  
Flux Fill 模型| `flux1-fill-dev.safetensors`| `ComfyUI/models/unet`| [Flux Fill Release](https://huggingface.co/black-forest-labs/FLUX.1-Fill-dev/)  
### 3. 下载工作流文件[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#3-下载工作流文件)
下载 Flux Fill 工作流
## 工作流使用指南[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#工作流使用指南)
### 工作流节点说明[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#工作流节点说明)
...
### 使用步骤[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide#使用步骤)
  1. **加载模型**
     * 在 `UNETLoader` 中选择 `flux1-fill-dev.safetensors`
     * 在 `DualCLIPLoader` 中加载 `clip_l.safetensors` 和 `t5xxl_fp16.safetensors`
     * 在 `VAELoader` 中加载 `ae.safetensors`
  2. **准备图片和蒙版**
     * 在 `LoadImage` 节点中加载你需要修复的图片
     * 图片需要包含白色区域作为修复区域的蒙版
  3. **设置提示词**
     * 在正向提示词框中输入你希望生成内容的描述
     * 在负向提示词框中输入你不希望出现的内容描述
     * 通过 `FluxGuidance` 节点调整提示词引导强度（默认值 30）
  4. **调整采样参数** 在 `KSampler` 节点中设置：
     * Steps: 建议 20-30 步
     * CFG: 建议 7-8
     * Sampler: 建议使用 euler
