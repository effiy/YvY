# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow

# 抓取时间: 2025-03-30 21:02:15

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Janus Pro ComfyUI Setp by Step 教程](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#janus-pro-comfyui-setp-by-step-教程)
  * [1. 安装 ComfyUI-Janus-Pro 插件](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#1-安装-comfyui-janus-pro-插件)
  * [2. 下载 DeepSeek Janus Pro 相关模型](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#2-下载-deepseek-janus-pro-相关模型)
  * [DeepSeek Janus Pro 模型下载和安装](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#deepseek-janus-pro-模型下载和安装)
  * [3. Janus Pro 工作流文件下载](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#3-janus-pro-工作流文件下载)
  * [Janus Pro 相关链接](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#janus-pro-相关链接)
  * [Janus Pro Huggingface 模型下载](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#janus-pro--huggingface-模型下载)
  * [Janus Pro Github地址：](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#janus-pro--github地址)
  * [在 Huggingface Space 体验 DeepSeek Janus Pro](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#在-huggingface-space-体验-deepseek-janus-pro)
  * [DeepSeek Janus-Pro ComfyUI 节点](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#deepseek-janus-pro-comfyui-节点)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")7. DeepSeek Janus Pro
←→
...
插件地址为： <https://github.com/CY-CHENYUE/ComfyUI-Janus-Pro> 安装方法：
  ...
  * 其它安装方法请参考[ComfyUI 插件安装教程](https://comfyui-wiki.com/zh/install/install-custom-nodes)
...
模型名称| 模型地址| 安装位置  
---|---|---  
Janus-Pro-1B| [🤗 Hugging Face](https://huggingface.co/deepseek-ai/Janus-Pro-1B/tree/main)| `ComfyUI/models/Janus-Pro/Janus-Pro-1B/`  
Janus-Pro-7B| [🤗 Hugging Face](https://huggingface.co/deepseek-ai/Janus-Pro-7B/tree/main)| `ComfyUI/models/Janus-Pro/Janus-Pro-7B/`  
你需要下载所有的 `json`格式文件以及 `.bin`格式的模型文件，最后安装完成后对应的文件夹结构如下
```
📁ComfyUI
├── 📁models
│  ├── 📁 Janus-Pro
...
### 3. Janus Pro 工作流文件下载[](https://comfyui-wiki.com/zh/tutorial/advanced/deepseek-janus-pro-workflow#3-janus-pro-工作流文件下载)
Janus Pro ComfyUI Workflow
这个工作流节点包含了图像描述和图像生成
![DeepSeek Janus Pro Workflow file](https://comfyui-wiki.com/_next/static/media/deepseek-janus-pro-workflow-file.a600fb61.jpg)
  1. 在序号`1` 选择 1B 或者 7B 模型
  2. 在序号`2` 上传你需要用于 Janus Pro 解读的图片
  3. 在序号`3` 可以调整用于图片描述的 Prompt, 我测试过中文、英文、日语输入都没有问题，但是如果你需要特定语言的输出，请你在 prompt 中声明，类似 _请使用日语输出_ 这样的要求
  4. 序号`4` 是一个展示 文本的节点，我这里使用的是[ComfyUI-Custom-Scripts](https://github.com/pythongosssss/ComfyUI-Custom-Scripts) 插件中的 `Show Text` 节点
  5. 请在序号`5` 出输入用于图像生成的 prompt
