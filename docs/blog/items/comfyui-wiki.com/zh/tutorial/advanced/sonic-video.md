# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video

# 抓取时间: 2025-03-30 21:02:15

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [1. ComfyUI Sonic插件安装](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#1-comfyui-sonic插件安装)
  * [2. Sonic 相关模型的下载及安装](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#2-sonic-相关模型的下载及安装)
  * [2.1 Stable video diffusion 下面两个模型选择一个：](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#21-stable-video-diffusion-下面两个模型选择一个)
  * [2.2 下载 Sonic 相关模型](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#22-下载-sonic-相关模型)
  * [2.3 下载 whisper-tiny 模型](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#23-下载-whisper-tiny-模型)
  * [ComfyUI Sonic 工作流相关素材](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#comfyui-sonic-工作流相关素材)
  * [ComfyUI Sonic 工作流讲解](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#comfyui-sonic-工作流讲解)
  * [问题解决](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#问题解决)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")9. Sonic Video
←→
...
如果你不熟悉对应的安装，请参考[ComfyUI 插件安装教程](https://comfyui-wiki.com/zh/install/install-custom-nodes)完成对应插件的安装
## 2. Sonic 相关模型的下载及安装[](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#2-sonic-相关模型的下载及安装)
...
## ComfyUI Sonic 工作流相关素材[](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#comfyui-sonic-工作流相关素材)
请下载下面的音频、照片、以及工作流文件，或者使用你自己的素材 图片： ![Sonic input anime](https://comfyui-wiki.com/_next/static/media/sonic-input-anime.8444a2d8.png)
音频，请下载示例部分的任意音频： <https://github.com/smthemex/ComfyUI_Sonic/tree/main/examples/wav>
ComfyUI Sonic 数字人工作流
## ComfyUI Sonic 工作流讲解[](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#comfyui-sonic-工作流讲解)
![Sonic Workflow](https://comfyui-wiki.com/_next/static/media/sonic-workflow.0e730055.jpg)
  1. 在序号`1`处，加载 stable video diffusion 相关模型 如 _svd_xt_1_1.safetensors_
  2. 在序号`2`处，上传音频文件，加载音频文件
  3. 在序号`3`处，上传示例图片
  4. 在序号`4`处，加载 _unet.pth_ 模型文件
  5. 使用 Queue 或者快捷键 `Ctrl(Command)+Enter` 运行工作流进行图片生成


### 问题解决[](https://comfyui-wiki.com/zh/tutorial/advanced/sonic-video#问题解决)
  1. transformers 版本问题 由于该插件要求使用 transformers==4.43.2, 如果你的工作流无法正常运行请修改
...
然后重启 ComfyUI 或者使用 pip 安装对应的依赖
  1. frame_rate 类型不匹配问题 在最后一个节点我遇到了数字类型不匹配的问题，我试着使用 primitive 节点作为输入 ![类型不匹配](https://comfyui-wiki.com/_next/static/media/sonic-primitive.da7986ed.jpg)
...
![Sonic input anime](https://comfyui-wiki.com/_next/static/media/sonic-input-anime.8444a2d8.png)
