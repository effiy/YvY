# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5

# 抓取时间: 2025-03-30 21:02:10

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [SD1.5 OpenPose ControlNet 简介](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#sd15-openpose-controlnet-简介)
  * [OpenPose ControlNet 使用](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#openpose-controlnet-使用)
  * [使用 OpenPose ControlNet 的 Step by Step 教程](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#使用-openpose-controlnet-的-step-by-step-教程)
  * [1. 升级 ComfyUI](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#1-升级-comfyui)
  * [2. 安装必要插件](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#2-安装必要插件)
  * [3. 下载工作流所需模型](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#3-下载工作流所需模型)
  * [4. 模型存放位置](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#4-模型存放位置)
  * [5. 工作流文件](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#5-工作流文件)
  * [使用 OpenPose 图和 ControlNet 模型来进行图片生成](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#使用-openpose-图和-controlnet-模型来进行图片生成)
  * [使用ComfyUI ControlNet Auxiliary Preprocessors 对参考图片进行预处理](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#使用comfyui-controlnet-auxiliary-preprocessors-对参考图片进行预处理)
  * [5.1 涉及的主要节点说明](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#51-涉及的主要节点说明)
  * [5.2 ComfyUI ControlNet Auxiliary Preprocessors 节点](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#52-comfyui-controlnet-auxiliary-preprocessors-节点)
  * [相关资源](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#相关资源)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")1.3 SD1.5 OpenPose ControlNet
←→
...
![SD1.5 OpenPose ControlNet Workflow Img](https://comfyui-wiki.com/_next/static/media/sd1.5-openpose-controlnet-1.d8070a8c.jpg)
## SD1.5 OpenPose ControlNet 简介[](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#sd15-openpose-controlnet-简介)
...
![OpenPose 图](https://comfyui-wiki.com/_next/static/media/sd1.5-openpose-controlnet-input-preprocess.cc8b9707.png)
...
由于本文使用的相关节点是新的 Apply ControlNet 与老的节点有所不同，所以建议你先升级或安装最新版本的 ComfyUI 相关教程你可以参考:
  * [ComfyUI 安装教程](https://comfyui-wiki.com/zh/install/install-comfyui/)
  * [ComfyUI 更新教程](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui)
...
请下载下面的图片，并在 [Load Image](https://comfyui-wiki.com/zh/comfyui-nodes/image/load-image) 节点中载入使用 ![OpenPose ControlNet Img](https://comfyui-wiki.com/_next/static/media/SD1.5-controlnet-openpose.cc8b9707.png)
![SD1.5 OpenPose ControlNet Workflow Img](https://comfyui-wiki.com/_next/static/media/SD1.5-controlnet-openpose-comfyui-wiki.com-1.24fbab5c.jpg)
...
#### 使用[ComfyUI ControlNet Auxiliary Preprocessors](https://github.com/Fannovel16/comfyui_controlnet_aux) 对参考图片进行预处理[](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-use-openpose-controlnet-with-sd1.5#使用comfyui-controlnet-auxiliary-preprocessors-对参考图片进行预处理)
...
ComfyUI Core 节点，核心节点文档在当前网站文档已有对应说明
  1. 应用ControlNet节点: [Apply ControlNet](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/controlnet-apply)
  2. 加载 ControlNet 模型: [ControlNet Loader](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/controlnet-loader)
...
![OpenPose Pose 节点](https://comfyui-wiki.com/_next/static/media/sd1.5-openpose-controlnet-contrast.d789ebdf.jpg)
**OpenPose Pose 节点**
![OpenPose Pose](https://comfyui-wiki.com/_next/static/media/openpose-pose.497db1c2.jpg)
输入参数| 描述| 参数选项  
---|---|---  
images| 输入图像| -  
...
POSE_KEYPOINT| 骨架点| -  
**DWPose Estimator 节点**
![DWPose Estimator](https://comfyui-wiki.com/_next/static/media/dwpose-estimator.febe10cd.jpg)
输入参数| 描述| 参数选项  
---|---|---  
images| 输入图像| -  
detect_hand| 是否检测手部| enable / disable  
