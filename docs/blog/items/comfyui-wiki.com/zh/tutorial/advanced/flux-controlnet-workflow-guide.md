# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide

# 抓取时间: 2025-03-30 21:02:11

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [模型介绍](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#模型介绍)
  * [FLUX.1 Depth [dev]](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#flux1-depth-dev)
  * [FLUX.1 Canny [dev]](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#flux1-canny-dev)
  * [模型版本说明](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#模型版本说明)
  * [完整模型版本](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#完整模型版本)
  * [LoRA版本](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#lora版本)
  * [准备工作](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#准备工作)
  * [1. 更新 ComfyUI](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#1-更新-comfyui)
  * [2. 完整版本模型下载](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#2-完整版本模型下载)
  * [3. LoRA版本模型下载](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#3-lora版本模型下载)
  * [4. 工作流文件下载](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#4-工作流文件下载)
  * [5. 系统要求](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#5-系统要求)
  * [Flux ControlNet 工作流使用说明](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#flux-controlnet-工作流使用说明)
  * [完整版本使用提示](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#完整版本使用提示)
  * [LoRA版本使用提示](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#lora版本使用提示)
  * [版本选择建议](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#版本选择建议)
  * [参数调优要点](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#参数调优要点)
  * [Depth控制](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#depth控制)
  * [Canny控制](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#canny控制)
  * [通用建议](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#通用建议)
  * [进阶应用](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#进阶应用)
  * [参考资源](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#参考资源)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")2.5 FLUX.1 ControlNet
←→
...
![Flux ControlNet Workflow](https://comfyui-wiki.com/_next/static/media/flux-contorlnet-workflow.eee6dbdd.jpg)
本教程将指导你如何在ComfyUI中使用Flux官方的ControlNet模型。我们将分别介绍FLUX.1 Depth和FLUX.1 Canny两个官方控制模型的使用方法。
> 此教程基于[ComfyUI Flux示例](https://comfyanonymous.github.io/ComfyUI_examples/flux/) 整理更新
## 模型介绍[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#模型介绍)
### FLUX.1 Depth [dev][](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#flux1-depth-dev)
  * 120亿参数的整流流变换器模型
  * 基于深度图进行结构引导
...
## 准备工作[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#准备工作)
### 1. 更新 ComfyUI[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#1-更新-comfyui)
首先确保你的 ComfyUI 已更新到最新版本，如果你不知道如何更新和升级 ComfyUI 请参考[如何更新和升级 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui)。
> 注意：Flux ControlNet 功能需要最新版本的 ComfyUI 支持，请务必先完成更新。
### 2. 完整版本模型下载[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#2-完整版本模型下载)
模型名称| 文件名| 安装位置| 下载链接| 说明  
---|---|---|---|---  
CLIP 模型| `clip_l.safetensors`| `ComfyUI/models/clip/`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/clip_l.safetensors)| 标准CLIP编码器  
CLIP 模型| `t5xxl_fp16.safetensors`| `ComfyUI/models/clip/`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp16.safetensors)| 标准精度版本  
CLIP 模型| `t5xxl_fp8_e4m3fn.safetensors`| `ComfyUI/models/clip/`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp8_e4m3fn.safetensors)| 低精度版本  
VAE 模型| `ae.safetensors`| `ComfyUI/models/vae/`| [下载](https://huggingface.co/comfyanonymous/flux_vae/resolve/main/ae.safetensors)| VAE编码解码器  
Flux Depth| `flux1-depth-dev.safetensors`| `ComfyUI/models/diffusion_models/`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-Depth-dev/resolve/main/flux1-depth-dev.safetensors)| 深度控制模型  
Flux Canny| `flux1-canny-dev.safetensors`| `ComfyUI/models/diffusion_models/`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-Canny-dev/resolve/main/flux1-canny-dev.safetensors)| 边缘控制模型  
### 3. LoRA版本模型下载[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#3-lora版本模型下载)
模型名称| 文件名| 安装位置| 下载链接| 说明  
---|---|---|---|---  
Flux基础模型| `flux1-dev.safetensors`| `ComfyUI/models/diffusion_models/`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-dev)| LoRA基础模型  
Depth LoRA| `flux1-depth-dev-lora.safetensors`| `ComfyUI/models/loras/`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-Depth-dev-lora/resolve/main/flux1-depth-dev-lora.safetensors)| 深度控制LoRA  
Canny LoRA| `flux1-canny-dev-lora.safetensors`| `ComfyUI/models/loras/`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-Canny-dev-lora/resolve/main/flux1-canny-dev-lora.safetensors)| 边缘控制LoRA  
### 4. 工作流文件下载[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#4-工作流文件下载)
下载完整版本工作流 下载LoRA版本工作流
### 5. 系统要求[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#5-系统要求)
  * 显存要求：建议至少16GB VRAM
...
## 参考资源[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-controlnet-workflow-guide#参考资源)
  * [FLUX.1 Depth Dev官方页面](https://huggingface.co/black-forest-labs/FLUX.1-Depth-dev)
  * [FLUX.1 Canny Dev官方页面](https://huggingface.co/black-forest-labs/FLUX.1-Canny-dev)
  * [ComfyUI Flux示例](https://comfyanonymous.github.io/ComfyUI_examples/flux/)
  * [blackforestlabs 黑森林实验室博客](https://blackforestlabs.ai/flux-1-tools/)
