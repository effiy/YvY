# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow

# 抓取时间: 2025-03-30 21:02:11

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Stable Diffusion 3.5模型介绍](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35模型介绍)
  * [Stable Diffusion 3.5 社区许可](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35-社区许可)
  * [Stable Diffusion 3.5 原始 FP16版本 ComfyUI 相关工作流](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35-原始-fp16版本-comfyui-相关工作流)
  * [下载 Stable Diffusion 3.5 模型文件](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-模型文件)
  * [下载 Stable Diffusion 3.5 工作流workflow文件](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-工作流workflow文件)
  * [Stable Diffusion 3.5 FP8低显存解决方案](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35-fp8低显存解决方案)
  * [下载 Stable Diffusion 3.5 FP8 模型文件](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-fp8-模型文件)
  * [下载 Stable Diffusion 3.5 FP8 工作流workflow文件](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-fp8-工作流workflow文件)
  * [在线运行 Stable Diffusion 3.5](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#在线运行-stable-diffusion-35)
  * [其他资源](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#其他资源)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")3. SD 3.5 文生图教程
←→
...
![Stable Diffusion 3.5 Diverse Outputs](https://images.squarespace-cdn.com/content/v1/6213c340453c3f502425776e/3c9a05b4-aa10-4a46-882e-1c32ac7bf18e/diverse_sd3.5.jpg?format=2500w)
...
## Stable Diffusion 3.5 社区许可[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35-社区许可)
社区许可允许研究、非商业和年收入总额不超过 100 万美元的组织或个人免费使用。更多详细信息请参阅[社区许可协议](https://stability.ai/license)。
## Stable Diffusion 3.5 原始 FP16版本 ComfyUI 相关工作流[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#stable-diffusion-35-原始-fp16版本-comfyui-相关工作流)
本部分将会介绍官方认识版本的相关模型安装以及工作流文件的下载,工作流文件以及事例均来自[ComfyUI 博客](https://blog.comfy.org/sd3-5-comfyui/)
### 下载 Stable Diffusion 3.5 模型文件[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-模型文件)
  1. 下载 Stable Diffusion 3.5 模型文件

资源名称| 下载链接| 安装文件夹  
---|---|---  
Stable Diffusion 3.5 Large| [下载链接](https://huggingface.co/stabilityai/stable-diffusion-3.5-large)| models/checkpoint  
Stable Diffusion 3.5 Large Turbo| [下载链接](https://huggingface.co/stabilityai/stable-diffusion-3.5-large-turbo)| models/checkpoint  
请参考对应的这个说明以及安装文件路径，完成对应的模型的下载和安装，按你的需要选择一个就可以
  1. 对应的 clip 模型文件

资源名称| 下载链接| 安装文件夹  
---|---|---  
clip_g.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/clip_g.safetensors)| models/clip  
clip_l.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/clip_l.safetensors)| models/clip  
t5xxl_fp16.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/t5xxl_fp16.safetensors)| models/clip  
...
### 下载 Stable Diffusion 3.5 FP8 模型文件[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-fp8-模型文件)
  1. 下载 Stable Diffusion 3.5 FP8 模型文件

资源名称| 下载链接| 安装文件夹  
---|---|---  
Stable Diffusion 3.5 Large FP8| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/sd3.5_large_fp8_scaled.safetensors?ref=blog.comfy.org)| models/checkpoint  
...
clip_g.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/clip_g.safetensors)| models/clip  
clip_l.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/clip_l.safetensors)| models/clip  
t5xxl_fp8_e4m3fn.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/t5xxl_fp8_e4m3fn.safetensors)| models/clip  
(experimental)t5xxl_fp8_e4m3fn_scaled.safetensors| [下载链接](https://huggingface.co/Comfy-Org/stable-diffusion-3.5-fp8/blob/main/text_encoders/t5xxl_fp8_e4m3fn_scaled.safetensors)| models/clip  
如果您的内存超过32GB，仍然建议使用t5xxl_fp16模型。
### 下载 Stable Diffusion 3.5 FP8 工作流workflow文件[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#下载-stable-diffusion-35-fp8-工作流workflow文件)
下面是Comfy官方提供的相例子，你可以下载对应的这个工作流文件
Download Stable Diffusion 3.5 FP8 Workflow
相对应的这个文件拖入 ComfyUI 界面，并运行生成
## 在线运行 Stable Diffusion 3.5[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#在线运行-stable-diffusion-35)
您还可以通过 Hugging Face 的 Space 在线运行 Stable Diffusion 3.5：
  * [Stable Diffusion 3.5 Large 在线运行](https://huggingface.co/spaces/stabilityai/stable-diffusion-3.5-large)
  * [Stable Diffusion 3.5 Large Turbo 在线运行](https://huggingface.co/spaces/stabilityai/stable-diffusion-3.5-large-turbo)
...
## 其他资源[](https://comfyui-wiki.com/zh/tutorial/advanced/stable-diffusion-3-5-comfyui-workflow#其他资源)
  1. Stable Diffusion 3.5 LoRA 模型 <https://huggingface.co/Shakker-Labs/SD3.5-LoRA-Linear-Red-Light> <https://huggingface.co/Shakker-Labs/SD3.5-LoRA-Futuristic-Bzonze-Colored> <https://huggingface.co/Shakker-Labs/SD3.5-LoRA-Chinese-Line-Art>
