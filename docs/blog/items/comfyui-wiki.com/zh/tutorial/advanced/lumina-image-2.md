# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2

# 抓取时间: 2025-03-30 21:02:15

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Lumina Image 2.0 工作流示例](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#lumina-image-20-工作流示例)
  * [1. 下载并安装 Lumina Image 2.0 模型](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#1-下载并安装-lumina-image-20-模型)
  * [2. Lumina Image 2.0 ComfyUI 工作流](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#2-lumina-image-20-comfyui-工作流)
  * [Lumina Image 2.0 工作流说明](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#lumina-image-20-工作流说明)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")8. Lumina Image 2
←→
...
![Lumina Image 2.0](https://comfyui-wiki.com/_next/static/media/lumina-image-2.0.4c60c515.jpg) [Lumina-Image-2.0](https://huggingface.co/Alpha-VLLM/Lumina-Image-2.0) 是由 Alpha-VLLM 团队在 2025 年春节期间开源的一款文生图模型，参数量为 2.6B，基于 DiT 架构 这一模型在图像质量、排版、提示词理解等诸多方面都有不错的表现。
...
本文将基于 [ComfyUI Example](https://comfyanonymous.github.io/ComfyUI_examples/lumina2/) 的相关示例进行讲解
## Lumina Image 2.0 工作流示例[](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#lumina-image-20-工作流示例)
### 1. 下载并安装 Lumina Image 2.0 模型[](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#1-下载并安装-lumina-image-20-模型)
名称| 体积| 安装位置| 下载链接  
---|---|---|---  
Lumina Image 2.0| 10.6GB| ComfyUI/models/checkpoints| [前往下载](https://huggingface.co/Comfy-Org/Lumina_Image_2.0_Repackaged/blob/main/all_in_one/lumina_2.safetensors)  
```
📁ComfyUI
└── 📁models
  └── 📁checkpoints
    └── lumina_2.safetensors   // 请将模型保存至这个文件位置
```

### 2. Lumina Image 2.0 ComfyUI 工作流[](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#2-lumina-image-20-comfyui-工作流)
请点击下面的按钮下载对应的 ComfyUI 工作流，并使用 ComfyUI 打开
Lumina Image 2.0 ComfyUI 工作流
## Lumina Image 2.0 工作流说明[](https://comfyui-wiki.com/zh/tutorial/advanced/lumina-image-2#lumina-image-20-工作流说明)
![Lumina Image 2.0 工作流说明](https://comfyui-wiki.com/_next/static/media/lumina-image-2.0-comfyui-workflow.76fef450.jpg)
参考图片，请在对应序号出完成对应操作
  1. 请确保`lumina_2.safetensors`模型在[Load Checkpoint](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/checkpoint-loader-simple) 处有正常载入，如没有对应模型，请检查对应模型位置，或者刷新/重启 ComfyUI


载入对应的模型后使用 Queue 或者快捷键 `Ctrl(Command)+Enter` 运行工作流进行图片生成
如果你修改采样步数序号`3` 对应序号 `2` 处的偏移量可以采取等比例修改 如：
  * step 36 对应 shift 6
  * step 20 对应 shift 3
