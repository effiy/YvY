# 原始URL: https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide

# 抓取时间: 2025-03-30 21:02:11

[Skip to content](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Flux Redux 模型简介](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#flux-redux-模型简介)
  * [准备工作](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#准备工作)
  * [1. 更新 ComfyUI](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#1-更新-comfyui)
  * [2. 下载必要模型](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#2-下载必要模型)
  * [3. 下载工作流文件](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#3-下载工作流文件)
  * [工作流使用指南](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#工作流使用指南)
  * [工作流节点说明](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#工作流节点说明)
  * [使用步骤](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#使用步骤)
  * [参数调优建议](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#参数调优建议)
  * [进阶技巧](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#进阶技巧)
  * [常见问题解决](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#常见问题解决)
  * [示例展示](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#示例展示)
  * [资源链接](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#资源链接)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[系列教程](https://comfyui-wiki.com/zh/tutorial "系列教程")[ComfyUI 进阶教程](https://comfyui-wiki.com/zh/tutorial/advanced "ComfyUI 进阶教程")2.4 FLUX.1 Redux
←→
...
![Flux Redux Workflow](https://comfyui-wiki.com/_next/static/media/redux.412675b5.png)
...
Flux Redux 模型仓库地址: [Flux Redux](https://huggingface.co/black-forest-labs/FLUX.1-Redux-dev)
## 准备工作[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#准备工作)
### 1. 更新 ComfyUI[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#1-更新-comfyui)
...
模型名称| 文件名| 安装位置| 下载链接  
---|---|---|---  
CLIP Vision 模型| `sigclip_vision_patch14_384.safetensors`| `ComfyUI/models/clip_vision`| [下载](https://huggingface.co/Comfy-Org/sigclip_vision_384/resolve/main/sigclip_vision_patch14_384.safetensors?download=true)  
Redux 模型| `flux1-redux-dev.safetensors`| `ComfyUI/models/style_models`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-Redux-dev/resolve/main/flux1-redux-dev.safetensors?download=true)  
CLIP 模型| `clip_l.safetensors`| `ComfyUI/models/clip`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/clip_l.safetensors)  
T5 模型| `t5xxl_fp16.safetensors`| `ComfyUI/models/clip`| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp16.safetensors)  
Flux Dev 模型| `flux1-dev.safetensors`| `ComfyUI/models/unet`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-dev/blob/main/flux1-dev.safetensors)  
VAE 模型| `ae.safetensors`| `ComfyUI/models/vae`| [下载](https://huggingface.co/black-forest-labs/FLUX.1-schnell/blob/main/ae.safetensors)  
### 3. 下载工作流文件[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#3-下载工作流文件)
下载 Flux Redux 工作流
## 工作流使用指南[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#工作流使用指南)
### 工作流节点说明[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#工作流节点说明)
...
### 使用步骤[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#使用步骤)
  1. **加载模型**
     * 在 `CLIPVisionLoader` 中选择 `sigclip_vision_patch14_384.safetensors`
     * 在 `StyleModelLoader` 中加载 `flux1-redux-dev.safetensors`
     * 在 `UNETLoader` 中加载 `flux1-dev.safetensors`
     * 在 `DualCLIPLoader` 中加载 CLIP 模型
     * 在 `VAELoader` 中加载 VAE 模型
  2. **准备参考图片**
     * 在 `LoadImage` 节点中加载你想要变体的图片
     * 图片会被自动处理和编码
  3. **调整生成参数**
     * 通过 `FluxGuidance` 节点调整生成强度（默认值 3.5）
     * 在 `BasicScheduler` 中设置采样步数（建议 20 步）
     * 选择合适的采样器（建议使用 euler）
  4. **设置图像尺寸**
     * 使用 `PrimitiveNode` 设置输出图像的宽度和高度
     * 默认设置为 1024x1024
...
你可以尝试以下示例来熟悉 Flux Redux 的使用：
  ...
  * 使用两个参考图片
  * 分别设置 FluxGuidance：2.5 和 3.0
  * Steps：25


记得保存你满意的参数组合，以便后续使用。
## 资源链接[](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide#资源链接)
  * [Black Forest Labs Flux Redux 官方仓库](https://huggingface.co/black-forest-labs/FLUX.1-Redux-dev)
  * [ComfyUI Flux 示例](https://comfyanonymous.github.io/ComfyUI_examples/flux/)
  * [ComfyUI 官方博客](https://blog.comfy.org/day-1-support-for-flux-tools-in-comfyui/)
