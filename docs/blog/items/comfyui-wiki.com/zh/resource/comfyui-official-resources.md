# 原始URL: https://comfyui-wiki.com/zh/resource/comfyui-official-resources

# 抓取时间: 2025-03-30 21:04:22

[Skip to content](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ComfyUI 官网](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-官网)
  * [ComfyUI 官方资源](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-官方资源)
  * [1. comfyui 官方文档](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#1-comfyui-官方文档)
  * [2. 社区论坛](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#2-社区论坛)
  * [3. GitHub 仓库](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#3-github-仓库)
  * [4. 官方社群](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#4-官方社群)
  * [5. 官方博客](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#5-官方博客)
  * [常见问题解答（FAQ）](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#常见问题解答faq)
  * [ComfyUI 是什么？](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-是什么)
  * [如何访问 ComfyUI 官网？](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#如何访问-comfyui-官网)
  * [ComfyUI 的官方资源有哪些？](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-的官方资源有哪些)
  * [结论](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#结论)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")ComfyUI官方资源
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# ComfyUI 官网与 ComfyUI 官方资源
ComfyUI 是一个强大的用户界面工具，专为 AI 绘图和图像生成而设计。以下是一些关于 ComfyUI 官网和 ComfyUI 官方资源的信息，帮助你更好地了解和使用这个工具。
## ComfyUI 官网[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-官网)
ComfyUI 官网是获取最新版本、更新日志和官方公告的最佳来源。你可以在 ComfyUI 官网上找到详细的安装指南、使用教程以及常见问题解答。访问 ComfyUI 官网可以确保你获取到最准确和最新的官方信息。
  * 官网链接：[ComfyUI 官网](https://www.comfy.org/)


## ComfyUI 官方资源[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-官方资源)
### 1. comfyui 官方文档[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#1-comfyui-官方文档)
ComfyUI 提供了详尽的官方文档，不过目前文档还在建设中，我也希望那你可以更多使用 comfyui-wiki.com,我们也正在建设中，
  * 文档链接：[ComfyUI 官方文档](https://docs.comfy.org/get_started/introduction)


### 2. 社区论坛[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#2-社区论坛)
ComfyUI 拥有一个活跃的社区论坛，用户可以在这里交流经验、分享作品、提出问题并获得帮助。ComfyUI 官方社区是一个学习和成长的好地。
  * reddit 论坛链接：[ComfyUI 官方社区论坛](https://www.reddit.com/r/comfyui/)


### 3. GitHub 仓库[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#3-github-仓库)
ComfyUI 的源代码托管在 GitHub 上，开发者可以在这里查看代码、提交问题和贡献代码。ComfyUI 官方 GitHub 仓库也是了解项目进展和参与开发的好地方。
  * GitHub 链接：[ComfyUI 官方 GitHub 仓库](https://github.com/comfyanonymous/ComfyUI)


### 4. 官方社群[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#4-官方社群)
ComfyUI 官方社群是一个开放的交流群组，用户可以在这里与其他用户和开发者互动。
  * Discord 社群链接：[ComfyUI 官方社群](https://discord.com/invite/comfyorg)
  * ComfyUI官方微信公众号：[ComfyUI 中文](https://mp.weixin.qq.com/s/sQkIw6ph_5Tg1DxcEMKzmw)


### 5. 官方博客[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#5-官方博客)
ComfyUI 官方博客提供了最新的新闻、更新和教程，是获取官方信息的好地方。
  * 博客链接：[ComfyUI 官方博客](https://x.com/comfyui)


## 常见问题解答（FAQ）[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#常见问题解答faq)
### ComfyUI 是什么？[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-是什么)
ComfyUI 是一个专为 AI 绘图和图像生成设计的用户界面工具，提供了丰富的功能和资源，帮助用户更好地进行创作。
### 如何访问 ComfyUI 官网？[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#如何访问-comfyui-官网)
你可以通过访问 [ComfyUI 官网](https://www.comfy.org/) 来获取最新的版本和官方信息。
### ComfyUI 的官方资源有哪些？[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#comfyui-的官方资源有哪些)
ComfyUI 提供了官方文档、社区论坛、GitHub 仓库、官方社群和官方博客等资源，帮助用户全面了解和使用 ComfyUI。
## 结论[](https://comfyui-wiki.com/zh/resource/comfyui-official-resources#结论)
通过访问以上 ComfyUI 官网和 ComfyUI 官方资源，你可以全面了解 ComfyUI 的功能和使用方法。无论你是新手还是有经验的用户，这些 ComfyUI 官网和官方资源都能帮助你更好地利用 ComfyUI 进行 AI 绘图和图像生成。
希望这些信息对你有所帮助！如果你有任何问题或需要进一步的帮助，请随时访问 ComfyUI 官网和社区论坛。
Last updated on 2025年3月24日
[Unet](https://comfyui-wiki.com/zh/resource/unet-models "Unet")[ComfyUI 相关工具与资源](https://comfyui-wiki.com/zh/resource/others "ComfyUI 相关工具与资源")
中文
System
