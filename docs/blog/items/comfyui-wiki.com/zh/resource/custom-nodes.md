# 原始URL: https://comfyui-wiki.com/zh/resource/custom-nodes

# 抓取时间: 2025-03-30 21:04:20

[Skip to content](https://comfyui-wiki.com/zh/resource/custom-nodes#reach-skip-nav)
...
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")Custom Nodes
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# ComfyUI 自定义节点插件推荐
以下是一些优秀的 ComfyUI 自定义节点插件推荐，这些插件可以大大增强 ComfyUI 的功能和使用体验：
插件名称| 简介| GitHub 链接| GitHub 星标  
---|---|---|---  
ComfyUI| ComfyUI 的核心框架，提供了革命性的 AI 图像生成能力和高度可定制的节点式界面，是 AI 艺术创作的基石。| [链接](https://github.com/comfyanonymous/ComfyUI)| ![GitHub Repo stars](https://img.shields.io/github/stars/comfyanonymous/ComfyUI)  
ComfyUI-manager| 全能型节点管理工具，支持一键安装、更新、删除和管理各类 ComfyUI 自定义节点，大大简化了插件管理流程。| [链接](https://github.com/ltdrdata/ComfyUI-Manager)| ![GitHub Repo stars](https://img.shields.io/github/stars/ltdrdata/ComfyUI-Manager)  
ComfyUI-Custom-Scripts| 多功能增强套件，集成了图像浏览器、会话历史记录、工作流保存等实用功能，显著提升了用户体验。| [链接](https://github.com/pythongosssss/ComfyUI-Custom-Scripts)| ![GitHub Repo stars](https://img.shields.io/github/stars/pythongosssss/ComfyUI-Custom-Scripts)  
comfyui_controlnet_aux| ControlNet 预处理器的集大成者，将多种图像预处理技术整合到一个强大的 `AIO Aux Preprocessor` 节点中。| [链接](https://github.com/Fannovel16/comfyui_controlnet_aux)| ![GitHub Repo stars](https://img.shields.io/github/stars/Fannovel16/comfyui_controlnet_aux)  
rgthree-comfy| 工作流优化大师，提供了一系列精心设计的节点，旨在简化复杂操作，提高工作效率。| [链接](https://github.com/rgthree/rgthree-comfy)| ![GitHub Repo stars](https://img.shields.io/github/stars/rgthree/rgthree-comfy)  
ComfyUI_LayerStyle| Photoshop 功能的 AI 化身，不仅移植了图层样式，还创新性地加入了 AI 驱动的背景移除和智能抠图功能。| [链接](https://github.com/chflame163/ComfyUI_LayerStyle)| ![GitHub Repo stars](https://img.shields.io/github/stars/chflame163/ComfyUI_LayerStyle)  
comfyui-inpaint-nodes| 图像修复的革新者，集成了包括 SDXL Fooocus、LaMa、MAT 在内的多种先进修复算法，大幅提升修复质量。| [链接](https://github.com/Acly/comfyui-inpaint-nodes)| ![GitHub Repo stars](https://img.shields.io/github/stars/Acly/comfyui-inpaint-nodes)  
ComfyUI-N-Sidebar| 界面交互的革新者，引入了直观的侧边栏设计，支持节点快速访问、智能搜索和个性化收藏，极大提升了工作效率。| [链接](https://github.com/Nuked88/ComfyUI-N-Sidebar)| ![GitHub Repo stars](https://img.shields.io/github/stars/Nuked88/ComfyUI-N-Sidebar)  
ComfyUI-KJNodes| 工作流整理专家，通过创新的 set/get 机制，巧妙解决了复杂工作流中的”面条线”问题，使界面更加清晰整洁。| [链接](https://github.com/kijai/ComfyUI-KJNodes)| ![GitHub Repo stars](https://img.shields.io/github/stars/kijai/ComfyUI-KJNodes)  
cg-use-everywhere| 无线连接的先驱，突破传统连线限制，实现了同类型接口的智能无线连接，大幅简化了复杂工作流的构建过程。| [链接](https://github.com/chrisgoringe/cg-use-everywhere)| ![GitHub Repo stars](https://img.shields.io/github/stars/chrisgoringe/cg-use-everywhere)  
ComfyUI-AnimateDiff-Evolved| AI 动画制作的新纪元，提供了丰富的动画生成和编辑工具，是创作高质量 AI 动画的必备利器。| [链接](https://github.com/Kosinkadink/ComfyUI-AnimateDiff-Evolved)| ![GitHub Repo stars](https://img.shields.io/github/stars/Kosinkadink/ComfyUI-AnimateDiff-Evolved)  
ComfyUI-IF_AI_tools| AI 创意助手，通过整合本地大语言模型，为图像生成提供智能化的提示词生成和优化建议。| [链接](https://github.com/if-ai/ComfyUI-IF_AI_tools)| ![GitHub Repo stars](https://img.shields.io/github/stars/if-ai/ComfyUI-IF_AI_tools)  
ComfyUI-Easy-Use| 全能型节点整合包，在 tinyterraNodes 的基础上进行了深度优化和扩展，为用户提供了一站式的节点解决方案。| [链接](https://github.com/yolain/ComfyUI-Easy-Use)| ![GitHub Repo stars](https://img.shields.io/github/stars/yolain/ComfyUI-Easy-Use)  
sdxl_prompt_styler| 提示词设计师，基于预设模板智能生成和优化提示词，帮助用户更轻松地创造出理想的图像风格。| [链接](https://github.com/twri/sdxl_prompt_styler)| ![GitHub Repo stars](https://img.shields.io/github/stars/twri/sdxl_prompt_styler)  
ComfyUI_Fill-Nodes| 图像批处理专家，提供了灵活的图像序列和随机提取功能，极大地提高了批量图像处理的效率和多样性。| [链接](https://github.com/filliptm/ComfyUI_Fill-Nodes)| ![GitHub Repo stars](https://img.shields.io/github/stars/filliptm/ComfyUI_Fill-Nodes)  
这些插件大大扩展了 ComfyUI 的功能，从基本的界面优化到高级的图像处理和动画生成，为用户提供了丰富的工具和选择。建议根据自己的需求选择合适的插件进行安装和使用，以充分发挥 ComfyUI 的潜力。
注意：在安装和使用这些插件时，请务必查看各插件的官方文档，了解其具体的安装方法、使用说明和注意事项。同时，请确保插件与你当前使用的 ComfyUI 版本兼容。
Last updated on 2025年3月24日
[V1 for SD1.5](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15 "V1 for SD1.5")[Embedding](https://comfyui-wiki.com/zh/resource/embedding-models "Embedding")
中文
System
