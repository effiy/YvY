# 原始URL: https://comfyui-wiki.com/zh/resource/lora-models

# 抓取时间: 2025-03-30 21:04:18

[Skip to content](https://comfyui-wiki.com/zh/resource/lora-models#reach-skip-nav)
...
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")LoRA
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# Stable diffusion LoRA 模型资源下载
对于下载 Stable Diffusion 系列模型来说，civitai 总会是一个最佳选择 <https://civitai.com/models>
如果你需要下载LoRA模型，在 `Filters` 里选择 `LoRA` 即可
Last updated on 2025年3月24日
[Flux](https://comfyui-wiki.com/zh/resource/flux "Flux")[ControlNet](https://comfyui-wiki.com/zh/resource/controlnet-models "ControlNet")
中文
System
