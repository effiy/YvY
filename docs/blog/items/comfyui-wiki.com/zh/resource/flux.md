# 原始URL: https://comfyui-wiki.com/zh/resource/flux

# 抓取时间: 2025-03-30 21:04:18

[Skip to content](https://comfyui-wiki.com/zh/resource/flux#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Flux 官方工具套件](https://comfyui-wiki.com/zh/resource/flux#flux-官方工具套件)
  * [Flux 基础模型版本](https://comfyui-wiki.com/zh/resource/flux#flux-基础模型版本)
  * [社区优化版本](https://comfyui-wiki.com/zh/resource/flux#社区优化版本)
  * [ControlNet 资源](https://comfyui-wiki.com/zh/resource/flux#controlnet-资源)
  * [LoRA 资源](https://comfyui-wiki.com/zh/resource/flux#lora-资源)
  * [在线服务](https://comfyui-wiki.com/zh/resource/flux#在线服务)
  * [训练工具](https://comfyui-wiki.com/zh/resource/flux#训练工具)
  * [相关教程](https://comfyui-wiki.com/zh/resource/flux#相关教程)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")Flux
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# Flux 模型资源合集
本文整理了 Flux 模型的各个版本及相关资源,包括官方发布的工具、社区优化版本、插件等内容。
## Flux 官方工具套件[](https://comfyui-wiki.com/zh/resource/flux#flux-官方工具套件)
Black Forest Labs 于 2024 年 11 月 21 日发布了 Flux.1 Tools 工具套件,包含以下四个主要功能:
工具名称| 功能描述| 开源版本| API版本  
---|---|---|---  
FLUX.1 Fill| 图像修复和扩展工具| [Dev版本](https://huggingface.co/black-forest-labs/FLUX.1-Fill-dev)| Pro版本  
FLUX.1 Depth| 基于深度图的结构引导| [Dev版本](https://huggingface.co/black-forest-labs/FLUX.1-Depth-dev)| Pro版本  
FLUX.1 Canny| 基于边缘检测的结构引导| [Dev版本](https://huggingface.co/black-forest-labs/FLUX.1-Canny-dev)| Pro版本  
FLUX.1 Redux| 图像混合与重建适配器| [Dev版本](https://huggingface.co/black-forest-labs/FLUX.1-Redux-dev)| Pro版本  
## Flux 基础模型版本[](https://comfyui-wiki.com/zh/resource/flux#flux-基础模型版本)
版本名称| 许可证| 显存要求| 下载链接| 特点  
---|---|---|---|---  
FLUX.1 Pro| 商业许可| 16GB+| API调用| 最佳性能和质量  
FLUX.1 Dev| 非商用许可| 16GB+| [下载](https://huggingface.co/black-forest-labs/FLUX.1-dev)| 开源研究版本  
FLUX.1 Schnell| Apache 2.0| 12GB+| [下载](https://huggingface.co/black-forest-labs/FLUX.1-schnell)| 轻量商用版本  
## 社区优化版本[](https://comfyui-wiki.com/zh/resource/flux#社区优化版本)
版本名称| 作者| 显存要求| 下载链接| 特点  
---|---|---|---|---  
Flux FP8| ComfyUI| 8GB+| [Dev](https://huggingface.co/Comfy-Org/flux1-dev/blob/main/flux1-dev-fp8.safetensors) / [Schnell](https://huggingface.co/Comfy-Org/flux1-schnell/blob/main/flux1-schnell-fp8.safetensors)| 单文件版本  
Flux GGUF| City96| 6GB+| [Dev](https://huggingface.co/city96/FLUX.1-dev-gguf) / [Schnell](https://huggingface.co/city96/FLUX.1-schnell-gguf)| 低显存优化  
Flux NF4| lllyasviel| 6GB+| [V2版本](https://huggingface.co/lllyasviel/flux1-dev-bnb-nf4)| 需要特定插件  
## ControlNet 资源[](https://comfyui-wiki.com/zh/resource/flux#controlnet-资源)
名称| 作者| 下载链接| 说明  
---|---|---|---  
Flux ControlNet Collections| XLabs-AI| [下载](https://huggingface.co/XLabs-AI/flux-controlnet-collections)| 控制网络合集  
Flux Union Controlnet Pro| Shakker-Labs| [下载](https://huggingface.co/Shakker-Labs/FLUX.1-dev-ControlNet-Union-Pro)| 专业联合控制网络  
Flux Depth Controlnet| Shakker-Labs| [下载](https://huggingface.co/Shakker-Labs/FLUX.1-dev-ControlNet-Depth)| 深度图控制网络  
Flux Canny Controlnet| InstantX| [下载](https://huggingface.co/InstantX/FLUX.1-dev-Controlnet-Canny)| 边缘检测控制网络  
Flux Inpainting Controlnet| Alimama| [下载](https://github.com/alimama-creative/FLUX-Controlnet-Inpainting)| 修复控制网络  
## LoRA 资源[](https://comfyui-wiki.com/zh/resource/flux#lora-资源)
名称| 作者| 下载链接| 风格类型  
---|---|---|---  
RealismLora| XLabs-AI| [下载](https://huggingface.co/XLabs-AI/flux-RealismLora)| 写实风格  
Text Poster| Shakker-Labs| [下载](https://huggingface.co/Shakker-Labs/FLUX.1-dev-LoRA-Text-Poster)| 文字海报风格  
Frosting Lane| alvdansen| [下载](https://huggingface.co/alvdansen/frosting_lane_flux)| 艺术风格  
Softserve Anime| alvdansen| [下载](https://huggingface.co/alvdansen/softserve_anime)| 动漫风格  
Half Illustration| davisbro| [下载](https://huggingface.co/davisbro/half_illustration)| 插画风格  
AntiBlur| Shakker-Labs| [下载](https://huggingface.co/Shakker-Labs/FLUX.1-dev-LoRA-AntiBlur)| 清晰增强  
## 在线服务[](https://comfyui-wiki.com/zh/resource/flux#在线服务)
服务名称| 链接| 说明  
---|---|---  
Hugging Face Demo| [Dev](https://huggingface.co/spaces/black-forest-labs/FLUX.1-dev) / [Schnell](https://huggingface.co/spaces/black-forest-labs/FLUX.1-schnell)| 在线体验  
Replicate| [链接](https://replicate.com/black-forest-labs)| API服务  
Mystic.ai| [链接](https://www.mystic.ai/black-forest-labs)| API服务  
FAL.ai| [链接](https://fal.ai/models/fal-ai/flux/schnell)| API服务  
## 训练工具[](https://comfyui-wiki.com/zh/resource/flux#训练工具)
名称| 类型| 链接| 说明  
---|---|---|---  
Flux Gym| 本地训练| [GitHub](https://github.com/cocktailpeanut/fluxgym)| 12GB显存即可训练  
Flux LoRA Trainer| 在线训练| [Replicate](https://replicate.com/ostris/flux-dev-lora-trainer)| 支持少量样本训练  
Flux DreamBooth| 示例代码| [GitHub](https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/README_flux.md)| DreamBooth训练示例  
## 相关教程[](https://comfyui-wiki.com/zh/resource/flux#相关教程)
  * [Flux 安装指南和文生图教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-guide-workflow-and-examples)
  * [Flux Fill 工作流程详细教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux-fill-workflow-step-by-step-guide)
  * [Flux Redux 工作流程详细教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux-redux-workflow-step-by-step-guide)
  * [Flux 图生图工作流教程](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-image-to-image-workflow-example)


Last updated on 2025年3月24日
[Stable Diffusion](https://comfyui-wiki.com/zh/resource/stable-diffusion-models "Stable Diffusion")[LoRA](https://comfyui-wiki.com/zh/resource/lora-models "LoRA")
中文
System
