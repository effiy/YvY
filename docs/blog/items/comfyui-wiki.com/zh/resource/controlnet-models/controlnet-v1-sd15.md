# 原始URL: https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15

# 抓取时间: 2025-03-30 21:04:20

[Skip to content](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ControlNet v1.0 对应模型文件及下载](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#controlnet-v10-对应模型文件及下载)
  * [如何在 ComfyUI 中使用 controlNet 模型](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#如何在-comfyui-中使用-controlnet--模型)
  * [controlNet原理](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#controlnet原理)
  * [ControlNet 使用的使用场景](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#controlnet-使用的使用场景)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")[ControlNet](https://comfyui-wiki.com/zh/resource/controlnet-models "ControlNet")V1 for SD1.5
←→
...
**作者** : lllyasviel **Github仓库** :<https://github.com/lllyasviel/ControlNet> **Hugging face仓库** :<https://huggingface.co/lllyasviel/ControlNet/tree/main> **兼容Stable diffusion 版本** : stable diffusion SD1.5 / 2.0
这里整理的是 ControlNet 作者 lllyasviel 最早提供的ControlNet 的模型资源
## ControlNet v1.0 对应模型文件及下载[](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#controlnet-v10-对应模型文件及下载)
文件名| 大小| 更新时间| 说明| 下载链接  
---|---|---|---|---  
`control_sd15_canny.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_canny.pth?download=true)  
`control_sd15_depth.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_depth.pth?download=true)  
`control_sd15_hed.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_hed.pth?download=true)  
`control_sd15_mlsd.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_mlsd.pth?download=true)  
`control_sd15_normal.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_normal.pth?download=true)  
`control_sd15_openpose.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_openpose.pth?download=true)  
`control_sd15_scribble.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_scribble.pth?download=true)  
`control_sd15_seg.pth`| 5.71 GB| 2023年2月| [下载链接](https://huggingface.co/lllyasviel/ControlNet/resolve/main/models/control_sd15_seg.pth?download=true)  
## 如何在 ComfyUI 中使用 controlNet 模型[](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15#如何在-comfyui-中使用-controlnet--模型)
...
Stable Diffusion ControlNet 1.0 是一个强大的插件，能够通过各种条件来控制图像生成。在不同类型的图像生成任务中，可以灵活应用该插件以达到预期效果。以下是几种具体的应用方法：
  1. 图像精准控制 ControlNet 可以根据边缘检测、草图处理或人体姿势等各种条件来控制图像生成。例如，在需要对人物的特定部分进行详细描绘时，可以通过定义这些条件来实现精准的图像生成。
  2. 固定构图与姿势定义 ControlNet 允许用户固定图像的构图和定义姿势，从而生成符合预期的图像。这对于需要特定动作或姿态的角色设计尤其有用。
  3. 描绘轮廓与线稿生成 使用ControlNet，仅凭线稿就能生成一张丰满精致的插画。这在艺术创作中非常实用，特别是在需要从简单的线条开始构建复杂图像的情况下。
  4. 头像转二次元效果 ControlNet 还可以用于将真实系头像转换为二次元风格，并且能准确还原原图中的人物发型和发色。这种功能对于动漫制作和角色设计非常有帮助。


Last updated on 2025年3月24日
[v1.1 for SD1.5/SD2](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-1-sd15-sd2 "v1.1 for SD1.5/SD2")[Custom Nodes](https://comfyui-wiki.com/zh/resource/custom-nodes "Custom Nodes")
中文
System
