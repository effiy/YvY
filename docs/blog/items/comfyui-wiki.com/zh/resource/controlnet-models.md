# 原始URL: https://comfyui-wiki.com/zh/resource/controlnet-models

# 抓取时间: 2025-03-30 21:04:18

[Skip to content](https://comfyui-wiki.com/zh/resource/controlnet-models#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ControlNet 是什么？它的作用是什么？](https://comfyui-wiki.com/zh/resource/controlnet-models#controlnet-是什么它的作用是什么)
  * [ControlNet 的功能和特点](https://comfyui-wiki.com/zh/resource/controlnet-models#controlnet-的功能和特点)
  * [易于理解的类比](https://comfyui-wiki.com/zh/resource/controlnet-models#易于理解的类比)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")ControlNet
←→
...
All (4)FluxSdxlSd1.5 (2)
[![Flux](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-flux-1)
[Flux](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-flux-1)
本文汇编了适用于 Flux 生态系统的 ControlNet 模型，包括由 XLabs-AI、InstantX 和 Jasperai 开发的各种 ControlNet 模型，涵盖了边缘检测、深度图和表面法线等多种控制方法。
Flux
[![SDXL](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-sdxl)
[SDXL](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-sdxl)
本文整理了 Stable Diffusion XL 模型的 ControlNet 模型，包括不同作者开发的多种 ControlNet 模型。
Sdxl
[![v1.1 for SD1.5/SD2](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-1-sd15-sd2)
[v1.1 for SD1.5/SD2](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-1-sd15-sd2)
这篇文章整理了不同类型的支持 SD1.5 / 2.0 的 ControlNet 模型
Sd1.5
[![V1 for SD1.5](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15)
[V1 for SD1.5](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15)
...
[LoRA](https://comfyui-wiki.com/zh/resource/lora-models "LoRA")[Flux](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-flux-1 "Flux")
中文
System
