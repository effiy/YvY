# 原始URL: https://comfyui-wiki.com/zh/resource/upscale-models

# 抓取时间: 2025-03-30 21:04:21

[Skip to content](https://comfyui-wiki.com/zh/resource/upscale-models#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [BSRGAN](https://comfyui-wiki.com/zh/resource/upscale-models#bsrgan)
  * [Swin2SR](https://comfyui-wiki.com/zh/resource/upscale-models#swin2sr)
  * [SwinIR](https://comfyui-wiki.com/zh/resource/upscale-models#swinir)
  * [Real-ESRGAN](https://comfyui-wiki.com/zh/resource/upscale-models#real-esrgan)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")Upscale Models
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# Upscale Models SD放大模型资源
以下是我收集的一些放大模型的资源库。 你可以在 <https://openmodeldb.info/> 找到各种用于照片、人物、动画等的放大模型。
## BSRGAN[](https://comfyui-wiki.com/zh/resource/upscale-models#bsrgan)
<https://github.com/cszn/BSRGAN> <https://openmodeldb.info/models/2x-BSRGAN> <https://openmodeldb.info/models/4x-BSRGAN>
## Swin2SR[](https://comfyui-wiki.com/zh/resource/upscale-models#swin2sr)
<https://github.com/mv-lab/swin2sr>
## SwinIR[](https://comfyui-wiki.com/zh/resource/upscale-models#swinir)
<https://github.com/JingyunLiang/SwinIR> <https://openmodeldb.info/users/jingyunliang>
## Real-ESRGAN[](https://comfyui-wiki.com/zh/resource/upscale-models#real-esrgan)
<https://github.com/xinntao/Real-ESRGAN> <https://openmodeldb.info/models/2x-realesrgan-x2plus> <https://openmodeldb.info/models/4x-realesrgan-x4plus>
Last updated on 2025年3月24日
[Embedding](https://comfyui-wiki.com/zh/resource/embedding-models "Embedding")[VAE](https://comfyui-wiki.com/zh/resource/vae-models "VAE")
中文
System
