# 原始URL: https://comfyui-wiki.com/zh/resource/stable-diffusion-models

# 抓取时间: 2025-03-30 21:04:18

[Skip to content](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [官方模型](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#官方模型)
  * [Stable diffusion 1.5](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-15)
  * [Stable diffusion 2.0](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-20)
  * [Stable diffusion XL](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-xl)
  * [融合模型推荐](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#融合模型推荐)
  * [SD1.5](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#sd15)
  * [SD XL](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#sd-xl)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")Stable Diffusion
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# Stable diffusion 官方及第三方模型资源
本文整理来自 Stable diffusion 官方和第三方的一些经典模型资源推荐
## 官方模型[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#官方模型)
下面是 Stability 官方初始发布的Stable diffusion 各版本的原始发布地址
### Stable diffusion 1.5[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-15)
Stable diffusion 1.5 <https://huggingface.co/stable-diffusion-v1-5/stable-diffusion-v1-5> Stable diffusion 1.5 inpainting <https://huggingface.co/runwayml/stable-diffusion-inpainting/tree/main>
### Stable diffusion 2.0[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-20)
Stable diffusion 2.0 <https://huggingface.co/stabilityai/stable-diffusion-2-1/tree/main>
### Stable diffusion XL[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#stable-diffusion-xl)
Stable diffusion XL（较之前版本提升较大，对自然语言理解能力更强） <https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/tree/main>
Stable diffusion XL turbo（速度快，但效果有一定损失） <https://huggingface.co/stabilityai/sdxl-turbo>
stable-diffusion-xl-refiner-1.0 <https://huggingface.co/stabilityai/stable-diffusion-xl-refiner-1.0>
## 融合模型推荐[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#融合模型推荐)
### SD1.5[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#sd15)
DreamShaper 8 <https://civitai.com/models/4384?modelVersionId=128713> DreamShaper 8 - inpainting <https://civitai.com/models/4384?modelVersionId=131004>
### SD XL[](https://comfyui-wiki.com/zh/resource/stable-diffusion-models#sd-xl)
Last updated on 2025年3月24日
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")[Flux](https://comfyui-wiki.com/zh/resource/flux "Flux")
中文
System
