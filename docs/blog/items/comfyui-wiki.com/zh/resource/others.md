# 原始URL: https://comfyui-wiki.com/zh/resource/others

# 抓取时间: 2025-03-30 21:04:22

[Skip to content](https://comfyui-wiki.com/zh/resource/others#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [SD-PPP (Photoshop Picture Portal)](https://comfyui-wiki.com/zh/resource/others#sd-ppp-photoshop-picture-portal)
  * [快速开始](https://comfyui-wiki.com/zh/resource/others#快速开始)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")ComfyUI 相关工具与资源
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# ComfyUI 相关工具与资源
## SD-PPP (Photoshop Picture Portal)[](https://comfyui-wiki.com/zh/resource/others#sd-ppp-photoshop-picture-portal)
[SD-PPP](https://github.com/zombieyang/sd-ppp) 是一个连接 Photoshop 和 ComfyUI/SD WebUI/Forge 的强大插件。它让用户可以直接在 Photoshop 中使用 AI 绘画功能，支持：
  * ✅ 多图层支持（包括文本层/图像层）
  * ✅ 多文档支持
  * ✅ 多 Photoshop 实例支持
  * ✅ 在文档的特定区域中工作
...
> 注意：仅支持 PS 24.4.0+ 版本
### 快速开始[](https://comfyui-wiki.com/zh/resource/others#快速开始)
  1. 使用 ComfyManager 安装 `sd-ppp` 或克隆到 custom_nodes 目录
  2. 安装 Photoshop 插件（通过 CCX 或 UXP 开发工具）
  3. 在 Photoshop 中连接到 ComfyUI
  4. 在 ComfyUI 中添加 get/send 节点


[查看详细安装说明 →](https://github.com/zombieyang/sd-ppp#how-to-install)
Last updated on 2025年3月24日
[ComfyUI官方资源](https://comfyui-wiki.com/zh/resource/comfyui-official-resources "ComfyUI官方资源")[Tencent-Hunyuan 腾讯混元相关资源](https://comfyui-wiki.com/zh/resource/tencent-hunyuan "Tencent-Hunyuan 腾讯混元相关资源")
中文
System
