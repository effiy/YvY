# 原始URL: https://comfyui-wiki.com/zh/resource/unet-models

# 抓取时间: 2025-03-30 21:04:21

[Skip to content](https://comfyui-wiki.com/zh/resource/unet-models#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Stable Diffusion UNET 模型资源](https://comfyui-wiki.com/zh/resource/unet-models#stable-diffusion-unet-模型资源)
  * [UNET 架构及其变体](https://comfyui-wiki.com/zh/resource/unet-models#unet-架构及其变体)
  * [1. 标准 UNET](https://comfyui-wiki.com/zh/resource/unet-models#1-标准-unet)
  * [2. UNet++ (UNet Extended)](https://comfyui-wiki.com/zh/resource/unet-models#2-unet-unet-extended)
  * [3. Attention UNet](https://comfyui-wiki.com/zh/resource/unet-models#3-attention-unet)
  * [4. Residual UNet](https://comfyui-wiki.com/zh/resource/unet-models#4-residual-unet)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[相关资源](https://comfyui-wiki.com/zh/resource "相关资源")Unet
←→
...
模型名称| 链接| 说明  
---|---|---  
CompVis/stable-diffusion-v1-4 UNet| [下载链接](https://huggingface.co/CompVis/stable-diffusion-v1-4/blob/0050854a4556632fe275ed384d277830d86b3bb6/unet/model.onnx)| Stable Diffusion v1.4 的 UNET 模型  
stabilityai/stable-diffusion-xl-base-1.0 UNet| [下载链接](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/blob/dafc14d1345c32e9dc6a93eb7c70d64bf5c0fb9c/unet/model.onnx)| Stable Diffusion XL 1.0 的 UNET 模型  
SD-Turbo UNET| [下载链接](https://huggingface.co/stabilityai/sd-turbo/tree/main/unet)| SD-Turbo 的 UNET 模型，用于快速推理  
SD XL Turbo UNET| [下载链接](https://huggingface.co/stabilityai/sdxl-turbo/tree/main/unet)| SD XL Turbo 的 UNET 模型，用于大规模快速推理  
## UNET 架构及其变体[](https://comfyui-wiki.com/zh/resource/unet-models#unet-架构及其变体)
### 1. 标准 UNET[](https://comfyui-wiki.com/zh/resource/unet-models#1-标准-unet)
  * **论文** : [UNet: Convolutional Networks for Biomedical Image Segmentation](https://arxiv.org/abs/1505.04597)
...
[VAE](https://comfyui-wiki.com/zh/resource/vae-models "VAE")[ComfyUI官方资源](https://comfyui-wiki.com/zh/resource/comfyui-official-resources "ComfyUI官方资源")
中文
System
