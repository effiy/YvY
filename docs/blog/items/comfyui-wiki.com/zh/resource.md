# 原始URL: https://comfyui-wiki.com/zh/resource

# 抓取时间: 2025-03-30 21:04:14

[Skip to content](https://comfyui-wiki.com/zh/resource#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [AIGC社区](https://comfyui-wiki.com/zh/resource#aigc社区)
  * [ComfyUI 自定义节点插件推荐](https://comfyui-wiki.com/zh/resource#comfyui-自定义节点插件推荐)
  * [ComfyUI workflow](https://comfyui-wiki.com/zh/resource#comfyui-workflow)
...
# 哪里可以下载到Stable diffusion AI绘图的模型资源？
以下是我整理的可以下载stable diffusion 大模型资源的网站
All (16)Stable DiffusionLoRAFluxSdxlSd1.5 (2)ControlNet插件EmbeddingsUpscaleVAEUNET工具
### [Stable Diffusion这篇文章整理了来自 Stable diffusion 官方和第三方的模型资源查看文档](https://comfyui-wiki.com/zh/resource/stable-diffusion-models)### [Flux整理了 Flux 模型的各个版本、工具、插件及相关资源的下载链接查看文档](https://comfyui-wiki.com/zh/resource/flux)### [LoRA这篇文章整理了 Stable Diffusion LoRA 模型资源下载查看文档](https://comfyui-wiki.com/zh/resource/lora-models)### [Flux本文汇编了适用于 Flux 生态系统的 ControlNet 模型，包括由 XLabs-AI、InstantX 和 Jasperai 开发的各种 ControlNet 模型，涵盖了边缘检测、深度图和表面法线等多种控制方法。查看文档](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-flux-1)### [SDXL本文整理了 Stable Diffusion XL 模型的 ControlNet 模型，包括不同作者开发的多种 ControlNet 模型。查看文档](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-sdxl)### [v1.1 for SD1.5/SD2这篇文章整理了不同类型的支持 SD1.5 / 2.0 的 ControlNet 模型查看文档](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-1-sd15-sd2)### [V1 for SD1.5这篇文章整理了 ControlNet 作者 lllyasviel 最早提供的 ControlNet 模型资源查看文档](https://comfyui-wiki.com/zh/resource/controlnet-models/controlnet-v1-sd15)### [ControlNet这篇文章整理了ControlNet 相关模型资源，你可以点击查看对应的不同版本的模型信息查看文档](https://comfyui-wiki.com/zh/resource/controlnet-models)### [Custom Nodes本文介绍了一系列优秀的 ComfyUI 自定义节点插件，这些插件可以大大增强 ComfyUI 的功能和使用体验。查看文档](https://comfyui-wiki.com/zh/resource/custom-nodes)### [Embedding这篇文章整理了 Stable Diffusion 模型常用 Negative Embeddings 模型，包括 SD1.5 和 SDXL。查看文档](https://comfyui-wiki.com/zh/resource/embedding-models)### [Upscale Models这篇文章整理了我收集的一些放大模型资源。你可以在 https://openmodeldb.info/ 找到各种用于照片、人物、动画等的放大模型。查看文档](https://comfyui-wiki.com/zh/resource/upscale-models)### [VAE这篇文章整理了我收集的一些 VAE 模型资源。你可以点击查看不同版本的模型信息。查看文档](https://comfyui-wiki.com/zh/resource/vae-models)### [Unet本文介绍了 UNET 模型及其变体，包括常用的 Stable Diffusion UNET 模型资源和各种 UNET 架构的简要说明。查看文档](https://comfyui-wiki.com/zh/resource/unet-models)### [ComfyUI官方资源了解 ComfyUI 官网和 ComfyUI 官方资源，获取最新版本、更新日志和官方公告。查看文档](https://comfyui-wiki.com/zh/resource/comfyui-official-resources)### [ComfyUI 相关工具与资源收集整理 ComfyUI 相关的实用工具和资源查看文档](https://comfyui-wiki.com/zh/resource/others)### [Tencent-Hunyuan 腾讯混元相关资源腾讯混元相关的模型、资源、社区资源等查看文档](https://comfyui-wiki.com/zh/resource/tencent-hunyuan)
## AIGC社区[](https://comfyui-wiki.com/zh/resource#aigc社区)
国内外有许多知名AIGC社区，以下是我推荐的一些可以下载到Stable diffusion大模型及其它LoRA资源的站点
  * [civitai | 非常推荐](https://civitai.com/)
  * [Liblib](https://www.liblib.ai/)
  * [哩布哩布AI](https://www.liblib.art)
  * [吐司](https://www.tusiart.com)
  * [触手AI](https://www.douchu.ai)
  * 待更新


## ComfyUI 自定义节点插件推荐[](https://comfyui-wiki.com/zh/resource#comfyui-自定义节点插件推荐)
你可以在 <https://www.nodecafe.org/> 找到热门的 ComfyUI custom_nodes
## ComfyUI workflow[](https://comfyui-wiki.com/zh/resource#comfyui-workflow)
在下面的网站你可以找到许多的ComfyUI workflow
  * OpenArt <https://openart.ai/workflows/home>
  * comfyworkflows <https://comfyworkflows.com/>


Last updated on 2025年3月24日
[ComfyUI SDXL Turbo 示例](https://comfyui-wiki.com/zh/workflows/sdturbo "ComfyUI SDXL Turbo 示例")[Stable Diffusion](https://comfyui-wiki.com/zh/resource/stable-diffusion-models "Stable Diffusion")
中文
System
