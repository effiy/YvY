# 原始URL: https://comfyui-wiki.com/zh/terms-of-service

# 抓取时间: 2025-03-30 21:04:30

[Skip to content](https://comfyui-wiki.com/zh/terms-of-service#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [1. 服务描述](https://comfyui-wiki.com/zh/terms-of-service#1-服务描述)
  * [2. 所有权](https://comfyui-wiki.com/zh/terms-of-service#2-所有权)
  * [3. 用户数据](https://comfyui-wiki.com/zh/terms-of-service#3-用户数据)
  * [4. 非个人数据收集](https://comfyui-wiki.com/zh/terms-of-service#4-非个人数据收集)
  * [5. 隐私政策](https://comfyui-wiki.com/zh/terms-of-service#5-隐私政策)
  * [6. 适用法律](https://comfyui-wiki.com/zh/terms-of-service#6-适用法律)
  * [7. 条款更新](https://comfyui-wiki.com/zh/terms-of-service#7-条款更新)
  * [8. 联系信息](https://comfyui-wiki.com/zh/terms-of-service#8-联系信息)
  * [9. 条款的接受](https://comfyui-wiki.com/zh/terms-of-service#9-条款的接受)
  * [10. 服务的终止](https://comfyui-wiki.com/zh/terms-of-service#10-服务的终止)
  * [11. 免责声明](https://comfyui-wiki.com/zh/terms-of-service#11-免责声明)
  * [12. 责任限制](https://comfyui-wiki.com/zh/terms-of-service#12-责任限制)
  * [13. 完整协议](https://comfyui-wiki.com/zh/terms-of-service#13-完整协议)
...
# ComfyUI-Wiki 服务条款
**最后更新日期：** 2024年8月6日
本服务条款（以下简称“条款”）规定了您访问和使用ComfyUI-Wiki（以下简称“服务”）的条件，该服务由ComfyUI-Wiki（以下简称“我们”或“本公司”）提供。通过访问或使用服务，您同意遵守本条款。
## 1. 服务描述[](https://comfyui-wiki.com/zh/terms-of-service#1-服务描述)
ComfyUI-Wiki 提供了一个平台，使用户能够创建和管理wiki页面和内容，增强用户协作和知识共享。
## 2. 所有权[](https://comfyui-wiki.com/zh/terms-of-service#2-所有权)
在ComfyUI-Wiki上创建的内容的所有知识产权属于相应的用户或原始创作者。用户需对其所发布的内容负责，并确保他们拥有必要的权利。
## 3. 用户数据[](https://comfyui-wiki.com/zh/terms-of-service#3-用户数据)
我们收集并存储用户数据，包括姓名、电子邮件以及注册过程中提供的其他信息。我们根据我们的隐私政策处理这些数据。
## 4. 非个人数据收集[](https://comfyui-wiki.com/zh/terms-of-service#4-非个人数据收集)
我们使用网页cookies收集非个人数据，以增强您的体验并提供个性化内容。更多信息请参阅我们的隐私政策。
## 5. 隐私政策[](https://comfyui-wiki.com/zh/terms-of-service#5-隐私政策)
我们的隐私政策解释了我们如何收集、使用和披露有关您的信息。通过使用我们的服务，您同意我们的隐私政策，详情可参见[ComfyUI-Wiki隐私政策](http://comfyui-wiki.com/privacy-policy)。
## 6. 适用法律[](https://comfyui-wiki.com/zh/terms-of-service#6-适用法律)
本条款受美国法律管辖并按该法律解释。
## 7. 条款更新[](https://comfyui-wiki.com/zh/terms-of-service#7-条款更新)
我们可能会不时更新本条款以遵守法律、防止滥用和改进服务。我们将通过电子邮件通知用户任何重大变更，并将修订后的条款发布在我们的网站上。
## 8. 联系信息[](https://comfyui-wiki.com/zh/terms-of-service#8-联系信息)
如果您对这些条款或我们的服务有任何疑问或顾虑，请通过将`#`替换为`@`后的电子邮件地址contact#comfyui-wiki.com与我们联系。
## 9. 条款的接受[](https://comfyui-wiki.com/zh/terms-of-service#9-条款的接受)
通过使用ComfyUI-Wiki，您声明您至少已达到您所在国家/地区的法定成年年龄，或者您已达到成年年龄并已同意允许您的未成年家属使用本网站。
## 10. 服务的终止[](https://comfyui-wiki.com/zh/terms-of-service#10-服务的终止)
我们保留随时立即终止或暂停对服务的访问的权利，无需事先通知或承担责任，原因包括但不限于违反条款。
## 11. 免责声明[](https://comfyui-wiki.com/zh/terms-of-service#11-免责声明)
ComfyUI-Wiki 按“现状”和“可用”的基础提供。在法律允许的最大范围内，ComfyUI-Wiki 放弃所有明示或暗示的保证和条件。
## 12. 责任限制[](https://comfyui-wiki.com/zh/terms-of-service#12-责任限制)
在任何情况下，ComfyUI-Wiki均不对因使用我们的服务或本条款而产生的任何特别、间接、附带或后果性损害承担责任。
## 13. 完整协议[](https://comfyui-wiki.com/zh/terms-of-service#13-完整协议)
本条款构成您与ComfyUI-Wiki之间关于使用服务的完整协议，并取代所有先前的协议和理解。
请仔细阅读这些条款，因为它们对您和ComfyUI-Wiki都具有法律约束力。通过使用服务，您承认并同意受这些条款的约束。
