# 原始URL: https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan

# 抓取时间: 2025-03-30 21:04:24

[Skip to content](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [方法一：ComfyUI Desktop 桌面版](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法一comfyui-desktop-桌面版)
  * [方法二：ComfyUI Portable 便携版](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法二comfyui-portable-便携版)
  * [如何查看本机局域网 IP 地址](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#如何查看本机局域网-ip-地址)
  * [Windows系统：](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#windows系统)
  * [方法一：使用命令提示符](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法一使用命令提示符)
  * [方法二：使用设置界面](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法二使用设置界面)
  * [macOS系统：](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#macos系统)
  * [方法一：使用终端](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法一使用终端)
  * [方法二：使用系统偏好设置](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法二使用系统偏好设置)
  * [安全注意事项](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#安全注意事项)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[常见问题](https://comfyui-wiki.com/zh/faq "常见问题")如何在局域网中访问 ComfyUI
←→
...
## 方法一：ComfyUI Desktop 桌面版[](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法一comfyui-desktop-桌面版)
  ...
  2. 进入 设置 -> [服务器配置](https://comfyui-wiki.com/zh/interface/server-config)
  3. 找到”网络”部分
...
[有关服务器配置的详细信息，请查看这里](https://comfyui-wiki.com/zh/interface/server-config)
## 方法二：ComfyUI Portable 便携版[](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan#方法二comfyui-portable-便携版)
...
[解决ComfyUI Manager安全级别报错「This action is not allowed」的完整指南](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error "解决ComfyUI Manager安全级别报错「This action is not allowed」的完整指南")[如何在 ComfyUI 中调整字体大小：分步指南](https://comfyui-wiki.com/zh/faq/how-to-change-font-size "如何在 ComfyUI 中调整字体大小：分步指南")
中文
System
