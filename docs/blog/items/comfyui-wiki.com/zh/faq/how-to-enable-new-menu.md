# 原始URL: https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu

# 抓取时间: 2025-03-30 21:04:25

[Skip to content](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [前置条件](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#前置条件)
  * [启用步骤](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#启用步骤)
  * [步骤 1：更新 ComfyUI](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#步骤-1更新-comfyui)
  * [步骤 2：打开设置面板](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#步骤-2打开设置面板)
  * [步骤 3：配置新菜单](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#步骤-3配置新菜单)
  * [步骤 4：应用更改](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#步骤-4应用更改)
  * [注意事项](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#注意事项)
  * [常见问题](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#常见问题)
  * [相关资源](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#相关资源)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[常见问题](https://comfyui-wiki.com/zh/faq "常见问题")如何启用 ComfyUI 新版本菜单
←→
...
## 前置条件[](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#前置条件)
确保你的 ComfyUI 已更新到 v0.2.0 或更高版本。如果需要更新，请参考 [如何更新 ComfyUI](https://comfyui-wiki.com/zh/tutorial/basic/how-to-update-comfyui)。
## 启用步骤[](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#启用步骤)
### 步骤 1：更新 ComfyUI[](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#步骤-1更新-comfyui)
...
![新菜单界面设置](https://comfyui-wiki.com/_next/static/media/use-comfyui-new-menu.624b7d32.jpg)
## 注意事项[](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#注意事项)
...
## 相关资源[](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu#相关资源)
  ...
  * [ComfyUI v0.2.0 发布说明](https://github.com/comfyanonymous/ComfyUI/releases)


Last updated on 2025年3月24日
[如何更改 ComfyUI 的输出文件夹位置](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder "如何更改 ComfyUI 的输出文件夹位置")[为什么使用相同的种子值，ComfyUI 和 A1111 生成的图像不一样？](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111 "为什么使用相同的种子值，ComfyUI 和 A1111 生成的图像不一样？")
中文
System
