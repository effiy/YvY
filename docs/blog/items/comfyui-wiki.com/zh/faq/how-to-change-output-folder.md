# 原始URL: https://comfyui-wiki.com/zh/faq/how-to-change-output-folder

# 抓取时间: 2025-03-30 21:04:25

[Skip to content](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [方法一：使用启动参数（推荐）](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#方法一使用启动参数推荐)
  * [Windows 用户](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#windows-用户)
  * [Linux/Mac 用户](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#linuxmac-用户)
  * [ComfyUI Portable 版本用户](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#comfyui-portable-版本用户)
  * [方法二：使用 WAS 节点（工作流方案）](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#方法二使用-was-节点工作流方案)
  * [方法三：使用符号链接（高级用户）](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#方法三使用符号链接高级用户)
  * [注意事项](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#注意事项)
  * [高级用法](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#高级用法)
  * [自动创建日期文件夹](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#自动创建日期文件夹)
  * [相关链接](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#相关链接)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[常见问题](https://comfyui-wiki.com/zh/faq "常见问题")如何更改 ComfyUI 的输出文件夹位置
←→
...
## 相关链接[](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder#相关链接)
  * [ComfyUI 官方讨论](https://github.com/comfyanonymous/ComfyUI/discussions/1292)
  * [ComfyUI Reddit 社区讨论](https://www.reddit.com/r/comfyui/comments/153flag/any_easy_way_to_change_the_folder_where_images/)


Last updated on 2025年3月24日
[如何在 ComfyUI 中调整字体大小：分步指南](https://comfyui-wiki.com/zh/faq/how-to-change-font-size "如何在 ComfyUI 中调整字体大小：分步指南")[如何启用 ComfyUI 新版本菜单](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu "如何启用 ComfyUI 新版本菜单")
中文
System
