# 原始URL: https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error

# 抓取时间: 2025-03-30 21:04:24

[Skip to content](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [一、错误原因解析](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#一错误原因解析)
  * [二、核心解决方案：修改安全级别](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#二核心解决方案修改安全级别)
  * [步骤 1：定位配置文件](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#步骤-1定位配置文件)
  * [步骤 2：修改安全参数](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#步骤-2修改安全参数)
  * [步骤 3：重启服务](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#步骤-3重启服务)
  * [验证操作](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#验证操作)
  * [三、替代方案：安全模式安装](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#三替代方案安全模式安装)
  * [四、其它](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#四其它)
  * [1. 未找到 config.ini](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#1-未找到-configini)
  * [2. 云环境特殊处理](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#2-云环境特殊处理)
  * [3. 更新 ComfyUI 和 Manager](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#3-更新-comfyui-和-manager)
  * [五、安全建议](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#五安全建议)
  * [临时开启弱安全模式](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#临时开启弱安全模式)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[常见问题](https://comfyui-wiki.com/zh/faq "常见问题")解决ComfyUI Manager安全级别报错「This action is not allowed」的完整指南
←→
...
## 一、错误原因解析[](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#一错误原因解析)
此报错由 ComfyUI Manager 的**安全分级机制** 触发。系统默认设置为 `security_level = normal` 时，会阻止未经验证的第三方 Git 仓库安装。该机制旨在防范恶意代码注入，但会导致部分插件安装失败。
其实在 [ComfyUI Manager](https://github.com/ltdrdata/ComfyUI-Manager) 的仓库中已经有说明如何解决这个问题，通过修改 `config.ini` 文件来修改安全级为 `weak` 即可解决。
## 二、核心解决方案：修改安全级别[](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#二核心解决方案修改安全级别)
💡
...
### 验证操作[](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#验证操作)
在 Manager 中尝试通过 Git URL 安装插件（如输入 [https://github.com/comfyanonymous/ComfyUI_bitsandbytes_NF4），若不再报错则成功。](https://github.com/comfyanonymous/ComfyUI_bitsandbytes_NF4%EF%BC%89%EF%BC%8C%E8%8B%A5%E4%B8%8D%E5%86%8D%E6%8A%A5%E9%94%99%E5%88%99%E6%88%90%E5%8A%9F%E3%80%82)
## 三、替代方案：安全模式安装[](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error#三替代方案安全模式安装)
...
[ComfyUI Fast Groups 替代方案和使用指南](https://comfyui-wiki.com/zh/faq/comfyui-fast-groups-alternatives "ComfyUI Fast Groups 替代方案和使用指南")[如何在局域网中访问 ComfyUI](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan "如何在局域网中访问 ComfyUI")
中文
System
