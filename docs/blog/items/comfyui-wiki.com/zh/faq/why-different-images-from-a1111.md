# 原始URL: https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111

# 抓取时间: 2025-03-30 21:04:26

[Skip to content](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [噪声生成的差异](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#噪声生成的差异)
  * [ComfyUI 的方式](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#comfyui-的方式)
  * [A1111 的方式](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#a1111-的方式)
  * [性能影响](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#性能影响)
  * [提示词权重处理](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#提示词权重处理)
  * [ComfyUI 的处理方式](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#comfyui-的处理方式)
  * [A1111 的处理方式](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#a1111-的处理方式)
  * [示例对比](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#示例对比)
  * [实际应用建议](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#实际应用建议)
  * [其他差异](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#其他差异)
  * [注意事项](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#注意事项)
  * [相关资源](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#相关资源)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[常见问题](https://comfyui-wiki.com/zh/faq "常见问题")为什么使用相同的种子值，ComfyUI 和 A1111 生成的图像不一样？
←→
...
## 相关资源[](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111#相关资源)
  ...
  * [Automatic1111 WebUI 文档](https://github.com/AUTOMATIC1111/stable-diffusion-webui)


Last updated on 2025年3月24日
[如何启用 ComfyUI 新版本菜单](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu "如何启用 ComfyUI 新版本菜单")
中文
System
