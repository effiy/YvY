# 原始URL: https://comfyui-wiki.com/zh/workflows/stable-cascade

# 抓取时间: 2025-03-30 21:04:04

[Skip to content](https://comfyui-wiki.com/zh/workflows/stable-cascade#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文本到图像](https://comfyui-wiki.com/zh/workflows/stable-cascade#文本到图像)
  * [图像到图像](https://comfyui-wiki.com/zh/workflows/stable-cascade#图像到图像)
  * [图像变化](https://comfyui-wiki.com/zh/workflows/stable-cascade#图像变化)
  * [ControlNet](https://comfyui-wiki.com/zh/workflows/stable-cascade#controlnet)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")13. Stable Cascade 工作流
←→
...
## 文本到图像[](https://comfyui-wiki.com/zh/workflows/stable-cascade#文本到图像)
这是一个基本的文本到图像工作流程：
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__text_to_image.png)
## 图像到图像[](https://comfyui-wiki.com/zh/workflows/stable-cascade#图像到图像)
以下是如何通过编码图像并将其传递给 Stage C 来执行基本图像到图像的示例：
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__image_to_image.png)
## 图像变化[](https://comfyui-wiki.com/zh/workflows/stable-cascade#图像变化)
Stable Cascade 支持使用 CLIP vision 的输出创建图像的变化。以下工作流程是一个示例：
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__image_remixing.png)
查看下一个工作流程，了解如何将多个图像混合在一起：
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__image_remixing_multiple.png)
您可以在 [unCLIP 示例页面](https://comfyui-wiki.com/zh/workflows/unclip) 上找到上述工作流程的输入图像。
## ControlNet[](https://comfyui-wiki.com/zh/workflows/stable-cascade#controlnet)
您可以从 [这里](https://huggingface.co/stabilityai/stable-cascade/tree/main/controlnet) 下载 Stable Cascade Controlnets。在这些示例中，我通过在文件名前面添加 stable_cascade_ 来重命名文件，例如：[stable_cascade_canny.safetensors](https://huggingface.co/stabilityai/stable-cascade/blob/main/controlnet/canny.safetensors)，[stable_cascade_inpainting.safetensors](https://huggingface.co/stabilityai/stable-cascade/blob/main/controlnet/inpainting.safetensors)
以下是如何使用 Canny Controlnet 的示例：
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__canny_controlnet.png)
以下是如何使用 Inpaint Controlnet 的示例，示例输入图像可以在 [这里](https://comfyui-wiki.com/examples/inpaint/yosemite_inpaint_example.png) 找到。提醒一下，您可以在 LoadImage 节点上右键单击图像并使用掩码编辑器编辑它们。
![Example](https://comfyui-wiki.com/examples/stable_cascade/stable_cascade__inpaint_controlnet.png)
Last updated on 2025年3月24日
[12. SDXL 工作流](https://comfyui-wiki.com/zh/workflows/sdxl "12. SDXL 工作流")[14. UnCLIP 工作流](https://comfyui-wiki.com/zh/workflows/unclip "14. UnCLIP 工作流")
中文
System
