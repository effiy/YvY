# 原始URL: https://comfyui-wiki.com/zh/workflows/inpaint

# 抓取时间: 2025-03-30 21:03:33

[Skip to content](https://comfyui-wiki.com/zh/workflows/inpaint#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [外延（Outpainting）](https://comfyui-wiki.com/zh/workflows/inpaint#外延outpainting)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")3. 局部重绘工作流
←→
...
![Example](https://comfyui-wiki.com/examples/inpaint/inpaint_example.png)
在这个示例中，我们将使用这张图片。下载它并将其放置在您的输入文件夹中。
![Example](https://comfyui-wiki.com/examples/inpaint/yosemite_inpaint_example.png)
...
以下图像可以在 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 中加载以获取完整的工作流程。
使用v2修复模型修复一只猫：
![Example](https://comfyui-wiki.com/examples/inpaint/inpain_model_cat.png)
使用v2修复模型修复一个女人：
![Example](https://comfyui-wiki.com/examples/inpaint/inpain_model_woman.png)
它也适用于非修复模型。以下是使用anythingV3模型的示例：
![Example](https://comfyui-wiki.com/examples/inpaint/inpaint_anythingv3_woman.png)
### 外延（Outpainting）[](https://comfyui-wiki.com/zh/workflows/inpaint#外延outpainting)
您也可以使用类似的工作流程进行外延。外延与内插修复是相同的。有一个“Pad Image for Outpainting”节点可以自动填充图像以进行外延，同时创建正确的遮罩。在这个例子中，这张图片将被外延：
![Example](https://comfyui-wiki.com/examples/inpaint/yosemite_outpaint_example.png)
使用v2修复模型和“Pad Image for Outpainting”节点（在ComfyUI中加载它以查看工作流程）：
![例子](https://comfyui-wiki.com/examples/inpaint/inpain_model_outpainting.png)
Last updated on 2025年3月24日
[2. 两步文生图工作流](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img "2. 两步文生图工作流")[4. 区域合成工作流](https://comfyui-wiki.com/zh/workflows/area-composition "4. 区域合成工作流")
中文
System
