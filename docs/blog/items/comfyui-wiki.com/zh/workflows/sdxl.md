# 原始URL: https://comfyui-wiki.com/zh/workflows/sdxl

# 抓取时间: 2025-03-30 21:04:04

[Skip to content](https://comfyui-wiki.com/zh/workflows/sdxl#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ReVision](https://comfyui-wiki.com/zh/workflows/sdxl#revision)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")12. SDXL 工作流
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# SDXL 示例
SDXL基础检查点可以在 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 中像任何常规检查点一样使用。唯一重要的是，为了获得最佳性能，分辨率应设置为1024x1024或具有相同像素数量但不同宽高比的其他分辨率。 例如：896x1152或1536x640是好的分辨率。
使用基础和细化器的示例工作流程如下。您可以下载这张图片，然后加载到ComfyUI中或将其拖放到ComfyUI上以获取它。
![Example](https://comfyui-wiki.com/examples/sdxl/sdxl_simple_example.png)
您还可以像这个工作流程一样为基地和细化器提供不同的提示。
![Example](https://comfyui-wiki.com/examples/sdxl/sdxl_refiner_prompt_example.png)
### ReVision[](https://comfyui-wiki.com/zh/workflows/sdxl#revision)
ReVision非常类似于 [unCLIP](https://comfyui-wiki.com/zh/workflows/unclip)，但在更概念化的层面上表现。您可以传递一个或多个图像给它，它将从图像中获取概念，并使用它们作为灵感创建新图像。
首先下载 [CLIP-G Vision](https://huggingface.co/comfyanonymous/clip_vision_g/blob/main/clip_vision_g.safetensors) 并将其放入您的ComfyUI/models/clip_vision/目录中。
这是一个可以拖放到ComfyUI中或加载到ComfyUI中的示例工作流程。在以下示例中，正面文本提示被清零，以便最终输出更紧密地跟随输入图像。
![Example](https://comfyui-wiki.com/examples/sdxl/sdxl_revision_zero_positive.png)
如果您想使用文本提示，可以使用这个示例：
![Example](https://comfyui-wiki.com/examples/sdxl/sdxl_revision_text_prompts.png)
...
[11. 模型合并工作流](https://comfyui-wiki.com/zh/workflows/model-merging "11. 模型合并工作流")[13. Stable Cascade 工作流](https://comfyui-wiki.com/zh/workflows/stable-cascade "13. Stable Cascade 工作流")
中文
System
