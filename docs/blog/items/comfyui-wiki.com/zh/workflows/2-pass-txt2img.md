# 原始URL: https://comfyui-wiki.com/zh/workflows/2-pass-txt2img

# 抓取时间: 2025-03-30 21:03:19

[Skip to content](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [非潜在放大](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img#非潜在放大)
  * [更多示例](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img#更多示例)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")2. 两步文生图工作流
←→
...
你可以在 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 中加载这些图像以获得完整的工作流程。
...
![两阶段文本到图像（高分辨率修复）- ComfyUI 工作流示例](https://comfyui-wiki.com/examples/2_pass_txt2img/hiresfix_latent_workflow.png)
## 非潜在放大[](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img#非潜在放大)
以下是如何使用 [esrgan放大器](https://comfyui-wiki.com/zh/workflows/upscale-models) 进行放大步骤的示例。由于ESRGAN在像素空间中操作，因此图像必须在放大后转换为像素空间，然后再转换回潜在空间。
![非潜在放大](https://comfyui-wiki.com/examples/2_pass_txt2img/hiresfix_esrgan_workflow.png)
## 更多示例[](https://comfyui-wiki.com/zh/workflows/2-pass-txt2img#更多示例)
这是一个更复杂的两阶段工作流程示例，这张图像首先使用WD1.5 beta 3幻觉模型生成，潜在放大，然后使用cardosAnime_v10进行第二阶段处理：
![更多示例](https://comfyui-wiki.com/examples/2_pass_txt2img/latent_upscale_different_prompt_model.png)
Last updated on 2025年3月24日
[1. 图生图工作流](https://comfyui-wiki.com/zh/workflows/img2img "1. 图生图工作流")[3. 局部重绘工作流](https://comfyui-wiki.com/zh/workflows/inpaint "3. 局部重绘工作流")
中文
System
