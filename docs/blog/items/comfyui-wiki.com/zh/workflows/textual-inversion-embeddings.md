# 原始URL: https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings

# 抓取时间: 2025-03-30 21:03:51

[Skip to content](https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")9. 文本反转嵌入工作流
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 文本反演嵌入示例
以下是如何使用文本反演/嵌入的示例。
![Example](https://comfyui-wiki.com/examples/textual_inversion_embeddings/embedding_example.png)
...
[8. 噪声潜空间合成工作流](https://comfyui-wiki.com/zh/workflows/noisy-latent-composition "8. 噪声潜空间合成工作流")[10. 模型编辑工作流](https://comfyui-wiki.com/zh/workflows/edit-models "10. 模型编辑工作流")
中文
System
