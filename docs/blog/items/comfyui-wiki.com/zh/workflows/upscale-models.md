# 原始URL: https://comfyui-wiki.com/zh/workflows/upscale-models

# 抓取时间: 2025-03-30 21:03:27

[Skip to content](https://comfyui-wiki.com/zh/workflows/upscale-models#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")5. 超分辨率模型工作流
←→
...
示例如下：
![Example](https://comfyui-wiki.com/examples/upscale_models/esrgan_example.png)
您可以在 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 中加载此图像以获取工作流程。
如果您正在寻找要使用的放大模型，您可以在 [OpenModelDB](https://openmodeldb.info/) 上找到一些。
Last updated on 2025年3月24日
[4. 区域合成工作流](https://comfyui-wiki.com/zh/workflows/area-composition "4. 区域合成工作流")[6. LoRA 模型工作流](https://comfyui-wiki.com/zh/workflows/lora "6. LoRA 模型工作流")
中文
System
