# 原始URL: https://comfyui-wiki.com/zh/workflows/controlnet

# 抓取时间: 2025-03-30 21:03:39

[Skip to content](https://comfyui-wiki.com/zh/workflows/controlnet#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [scribble（涂鸦） ControlNet](https://comfyui-wiki.com/zh/workflows/controlnet#scribble涂鸦-controlnet)
  * [T2I-Adapter与ControlNets](https://comfyui-wiki.com/zh/workflows/controlnet#t2i-adapter与controlnets)
  * [姿势 Pose ControlNet](https://comfyui-wiki.com/zh/workflows/controlnet#姿势-pose-controlnet)
  * [混合ControlNets](https://comfyui-wiki.com/zh/workflows/controlnet#混合controlnets)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")7. ControlNet 工作流
←→
...
ControlNetApply 节点不会为您将常规图像转换为深度图、Canny 图等。您必须单独进行此操作，或使用节点预处理您的图像，您可以在[这里](https://github.com/Fannovel16/comfy_controlnet_preprocessors)找到这些节点。
您可以在此处找到最新的 ControlNet 模型文件：[原始版本](https://huggingface.co/lllyasviel/ControlNet-v1-1/tree/main) 或 [较小的fp16 safetensors版本](https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/tree/main)
对于SDXL， stability.ai 发布了 Control Loras ，您可以在[这里（等级256）](https://huggingface.co/stabilityai/control-lora/tree/main/control-LoRAs-rank256) 或 [这里（等级128）](https://huggingface.co/stabilityai/control-lora/tree/main/control-LoRAs-rank128)找到。它们的使用方式与常规ControlNet模型文件完全相同（将它们放在同一个目录中）。
ControlNet 模型文件应放在 ComfyUI/models/controlnet 目录中。
### scribble（涂鸦） ControlNet[](https://comfyui-wiki.com/zh/workflows/controlnet#scribble涂鸦-controlnet)
这是一个如何使用 controlnets 的简单示例，此示例使用 scribble controlnet 和 [AnythingV3](https://civitai.com/models/66/anything-v3) 模型。您可以在[ComfyUI](https://github.com/comfyanonymous/ComfyUI)中加载此图像以获取完整的工作流程。
![Example](https://comfyui-wiki.com/examples/controlnet/controlnet_example.png)
这是我在此工作流程中使用的输入图像：
![输入图像](https://comfyui-wiki.com/examples/controlnet/input_scribble_example.png)
### T2I-Adapter与ControlNets[](https://comfyui-wiki.com/zh/workflows/controlnet#t2i-adapter与controlnets)
...
![输入图像](https://comfyui-wiki.com/examples/controlnet/shark_depthmap.png)
以下是如何使用深度 T2I-Adapter：
![Example](https://comfyui-wiki.com/examples/controlnet/depth_t2i_adapter.png)
...
![Example](https://comfyui-wiki.com/examples/controlnet/depth_controlnet.png)
您可以在[ComfyUI](https://github.com/comfyanonymous/ComfyUI)中加载这些图像以获取完整的工作流程。
### 姿势 Pose ControlNet[](https://comfyui-wiki.com/zh/workflows/controlnet#姿势-pose-controlnet)
这是此示例中将使用的输入图像：
![Example](https://comfyui-wiki.com/examples/controlnet/pose_worship.png)
以下是使用AnythingV3进行第一次通过，使用controlnet，然后使用AOM3A3（abyss orange mix 3）进行第二次通过，而不使用controlnet，并使用它们的VAE的示例。
![Example](https://comfyui-wiki.com/examples/controlnet/2_pass_pose_worship.png)
您可以在[ComfyUI](https://github.com/comfyanonymous/ComfyUI)中加载此图像以获取完整的工作流程。
### 混合ControlNets[](https://comfyui-wiki.com/zh/workflows/controlnet#混合controlnets)
可以像这样应用多个ControlNets和T2I-Adapters，结果很有趣：
![Example](https://comfyui-wiki.com/examples/controlnet/mixing_controlnets.png)
您可以在[ComfyUI](https://github.com/comfyanonymous/ComfyUI)中加载此图像以获取完整的工作流程。
输入图像：
![示例](https://comfyui-wiki.com/examples/controlnet/pose_present.png)
Last updated on 2025年3月24日
[6. LoRA 模型工作流](https://comfyui-wiki.com/zh/workflows/lora "6. LoRA 模型工作流")[8. 噪声潜空间合成工作流](https://comfyui-wiki.com/zh/workflows/noisy-latent-composition "8. 噪声潜空间合成工作流")
中文
System
