# 原始URL: https://comfyui-wiki.com/zh/workflows/video

# 抓取时间: 2025-03-30 21:04:14

[Skip to content](https://comfyui-wiki.com/zh/workflows/video#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [图像到视频](https://comfyui-wiki.com/zh/workflows/video#图像到视频)
  * [一些参数的解释：](https://comfyui-wiki.com/zh/workflows/video#一些参数的解释)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")18. 视频生成工作流
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 视频示例
## 图像到视频[](https://comfyui-wiki.com/zh/workflows/video#图像到视频)
截至撰写本文时，有两个图像到视频检查点。以下是生成14帧视频的官方检查点 [链接](https://huggingface.co/stabilityai/stable-video-diffusion-img2vid/blob/main/svd.safetensors) 和生成25帧视频的 [链接](https://huggingface.co/stabilityai/stable-video-diffusion-img2vid-xt/blob/main/svd_xt.safetensors)。将它们放入 ComfyUI/models/checkpoints 文件夹中。
使用图像到视频模型的最基本方法是通过给它一个初始图像，如下所示的工作流程，该工作流程使用14帧模型。 您可以下载此 webp 动画图像并加载它或将其拖放到 [ComfyUI](https://github.com/comfyanonymous/ComfyUI) 上以获取工作流程。
![Example](https://comfyui-wiki.com/examples/video/image_to_video.webp)
[工作流程以 Json 格式](https://comfyui-wiki.com/examples/video/workflow_image_to_video.json)
如果您想要确切的输入图像，可以在 [unCLIP 示例页面](https://comfyui-wiki.com/zh/workflows/unclip) 上找到它。
您也可以像这样使用工作流程，该工作流程使用 SDXL 生成一个初始图像，然后将其传递给25帧模型：
![Example](https://comfyui-wiki.com/examples/video/txt_to_image_to_video.webp)
[工作流程以 Json 格式](https://comfyui-wiki.com/examples/video/workflow_txt_to_img_to_video.json)
#### 一些参数的解释：[](https://comfyui-wiki.com/zh/workflows/video#一些参数的解释)
...
[17. 3D 示例工作流](https://comfyui-wiki.com/zh/workflows/3d "17. 3D 示例工作流")[LCM 示例](https://comfyui-wiki.com/zh/workflows/lcm "LCM 示例")
中文
System
