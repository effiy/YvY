# 原始URL: https://comfyui-wiki.com/zh/workflows/noisy-latent-composition

# 抓取时间: 2025-03-30 21:03:51

[Skip to content](https://comfyui-wiki.com/zh/workflows/noisy-latent-composition#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")8. 噪声潜空间合成工作流
←→
...
![Example](https://comfyui-wiki.com/examples/noisy_latent_composition/noisy_latents_3_subjects.png)
改变主体位置的示例：
![Example](https://comfyui-wiki.com/examples/noisy_latent_composition/noisy_latents_3_subjects_.png)
...
[7. ControlNet 工作流](https://comfyui-wiki.com/zh/workflows/controlnet "7. ControlNet 工作流")[9. 文本反转嵌入工作流](https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings "9. 文本反转嵌入工作流")
中文
System
