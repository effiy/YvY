# 原始URL: https://comfyui-wiki.com/zh/workflows/lora

# 抓取时间: 2025-03-30 21:03:27

[Skip to content](https://comfyui-wiki.com/zh/workflows/lora#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")6. LoRA 模型工作流
←→
...
![Example](https://comfyui-wiki.com/examples/lora/lora.png)
你可以通过像这样链接多个LoraLoader节点来应用多个Loras：
![Example](https://comfyui-wiki.com/examples/lora/lora_multiple.png)
Last updated on 2025年3月24日
[5. 超分辨率模型工作流](https://comfyui-wiki.com/zh/workflows/upscale-models "5. 超分辨率模型工作流")[7. ControlNet 工作流](https://comfyui-wiki.com/zh/workflows/controlnet "7. ControlNet 工作流")
中文
System
