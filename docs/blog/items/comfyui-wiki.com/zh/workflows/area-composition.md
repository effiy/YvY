# 原始URL: https://comfyui-wiki.com/zh/workflows/area-composition

# 抓取时间: 2025-03-30 21:03:43

[Skip to content](https://comfyui-wiki.com/zh/workflows/area-composition#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [使用Anything-V3的区域组合 + 第二阶段使用AbyssOrangeMix2_hard](https://comfyui-wiki.com/zh/workflows/area-composition#使用anything-v3的区域组合--第二阶段使用abyssorangemix2_hard)
  * [使用区域组合提高图像一致性](https://comfyui-wiki.com/zh/workflows/area-composition#使用区域组合提高图像一致性)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")4. 区域合成工作流
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 区域组合示例 - ComfyUI工作流
以下是一些示例，展示了如何使用ConditioningSetArea节点。你可以在[ComfyUI](https://github.com/comfyanonymous/ComfyUI)中加载这些图像以获得完整的工作流程。
## 使用Anything-V3的区域组合 + 第二阶段使用AbyssOrangeMix2_hard[](https://comfyui-wiki.com/zh/workflows/area-composition#使用anything-v3的区域组合--第二阶段使用abyssorangemix2_hard)
这张图片包含了4个不同的区域：夜晚、傍晚、白天、早晨
![Example](https://comfyui-wiki.com/examples/area_composition/night_evening_day_morning.png)
在ComfyUI中，工作流程看起来像这样：
![Example](https://comfyui-wiki.com/examples/area_composition/workflow_night_evening_day_morning.png)
这张图片包含了与前一张相同的区域，但是顺序相反。
![Example](https://comfyui-wiki.com/examples/area_composition/morning_day_evening_night.png)
通过添加另一个区域提示，将主体添加到图片的底部中心。
![Example](https://comfyui-wiki.com/examples/area_composition/night_evening_day_morning_subject.png)
## 使用区域组合提高图像一致性[](https://comfyui-wiki.com/zh/workflows/area-composition#使用区域组合提高图像一致性)
...
![Example](https://comfyui-wiki.com/examples/area_composition/square_area_for_subject.png)
在图像右侧添加一个红发主体，使用区域提示。
第一阶段输出（1280x704）：
![Example](https://comfyui-wiki.com/examples/area_composition/square_area_for_2_subjects_first_pass.png)
第二阶段输出（1920x1088）：
![Example](https://comfyui-wiki.com/examples/area_composition/square_area_for_2_subjects.png)
...
[3. 局部重绘工作流](https://comfyui-wiki.com/zh/workflows/inpaint "3. 局部重绘工作流")[5. 超分辨率模型工作流](https://comfyui-wiki.com/zh/workflows/upscale-models "5. 超分辨率模型工作流")
中文
System
