# 原始URL: https://comfyui-wiki.com/zh/workflows/edit-models

# 抓取时间: 2025-03-30 21:03:56

[Skip to content](https://comfyui-wiki.com/zh/workflows/edit-models#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")10. 模型编辑工作流
←→
...
以下是稳定性SDXL编辑模型的工作流程，检查点可以从[这里](https://huggingface.co/stabilityai/cosxl)下载。要使用它，请下载cosxl_edit.safetensors文件并将其放入ComfyUI/models/checkpoints文件夹中。
![Example](https://comfyui-wiki.com/examples/edit_models/sdxl_edit_model.png)
您可以下载上面的图像，然后拖拽或加载到ComfyUI上以获取嵌入在图像中的工作流程。
上述示例中使用的输入图像可以在[这里](https://comfyui-wiki.com/examples/unclip/mountains.png)找到。
Last updated on 2025年3月24日
[9. 文本反转嵌入工作流](https://comfyui-wiki.com/zh/workflows/textual-inversion-embeddings "9. 文本反转嵌入工作流")[11. 模型合并工作流](https://comfyui-wiki.com/zh/workflows/model-merging "11. 模型合并工作流")
中文
System
