# 原始URL: https://comfyui-wiki.com/zh/workflows/model-merging

# 抓取时间: 2025-03-30 21:03:57

[Skip to content](https://comfyui-wiki.com/zh/workflows/model-merging#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [高级合并](https://comfyui-wiki.com/zh/workflows/model-merging#高级合并)
  * [CosXL](https://comfyui-wiki.com/zh/workflows/model-merging#cosxl)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")11. 模型合并工作流
←→
...
![Example](https://comfyui-wiki.com/examples/model_merging/model_merging_3_checkpoints.png)
由于Loras是模型权重上的补丁，因此它们也可以合并到模型中：
![Example](https://comfyui-wiki.com/examples/model_merging/model_merging_lora.png)
...
![Example](https://comfyui-wiki.com/examples/model_merging/model_merging_inpaint.png)
您应该注意的一个重要事项是，模型会以用于硬件上的推理的精度合并和保存，因此通常是16位浮点。如果您想在32位浮点下进行合并，启动ComfyUI：—force-fp32
### 高级合并[](https://comfyui-wiki.com/zh/workflows/model-merging#高级合并)
#### CosXL[](https://comfyui-wiki.com/zh/workflows/model-merging#cosxl)
以下是如何通过合并从常规SDXL模型创建CosXL模型的示例。要求是 [CosXL基础模型](https://huggingface.co/stabilityai/cosxl)，[SDXL基础模型](https://huggingface.co/stabilityai/stable-diffusion-xl-base-1.0/blob/main/sd_xl_base_1.0_0.9vae.safetensors) 和您想要转换的SDXL模型。在这个示例中，我使用了 [albedobase-xl](https://civitai.com/models/140737/albedobase-xl)。
![Example](https://comfyui-wiki.com/examples/model_merging/model_merging_cosxl.png)
Last updated on 2025年3月24日
[10. 模型编辑工作流](https://comfyui-wiki.com/zh/workflows/edit-models "10. 模型编辑工作流")[12. SDXL 工作流](https://comfyui-wiki.com/zh/workflows/sdxl "12. SDXL 工作流")
中文
System
