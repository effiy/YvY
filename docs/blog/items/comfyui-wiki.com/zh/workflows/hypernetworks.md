# 原始URL: https://comfyui-wiki.com/zh/workflows/hypernetworks

# 抓取时间: 2025-03-30 21:04:09

[Skip to content](https://comfyui-wiki.com/zh/workflows/hypernetworks#reach-skip-nav)
...
[ComfyUI 官方示例](https://comfyui-wiki.com/zh/workflows "ComfyUI 官方示例")15. Hypernetworks 工作流
←→
...
![Example](https://comfyui-wiki.com/examples/hypernetworks/hypernetwork_example.png)
你可以通过顺序链接多个超网络加载器节点来应用多个超网络。
Last updated on 2025年3月24日
[14. UnCLIP 工作流](https://comfyui-wiki.com/zh/workflows/unclip "14. UnCLIP 工作流")[16. Gligen 工作流](https://comfyui-wiki.com/zh/workflows/gligen "16. Gligen 工作流")
中文
System
