# 原始URL: https://comfyui-wiki.com/zh/interface

# 抓取时间: 2025-03-30 21:01:57

[Skip to content](https://comfyui-wiki.com/zh/interface#reach-skip-nav)
...
# ComfyUI 用户界面讲解
💡
自 ComfyUI.ORG 发布 ComfyUI v0.2.0 以来，用户交互界面进行了重新设计。这里文档目前没有更新，但许多设置仍然保持不变。如果你想找到更多，请访问官方博客[https://blog.comfy.org/comfyui-v0-2-0-release/。](https://blog.comfy.org/comfyui-v0-2-0-release/%E3%80%82)
这部分是关于 ComfyUI 的用户界面的，主要包含 ComfyUI 的基础使用操作、文件交互、快捷键等内容了，通过这部分你将能够了解到以下内容，不过由于 ComfyUI 一直在持续迭代，在实际使用中，可能界面与我目前版本的说明有些许差异
### [1. 界面指南本章节为ComfyUI用户界面说明，包含基本操作，菜单设置，节点操作等常见用户界面选项查看文档](https://comfyui-wiki.com/zh/interface/basic)### [2. 节点操作指南本章节为ComfyUI节点菜单选项说明，包含节点菜单，节点报错状态等常见节点操作选项查看文档](https://comfyui-wiki.com/zh/interface/node-options)### [3. 工作流详细介绍 ComfyUI 工作流的基本概念、使用方法、导入导出等操作，适合新手入门学习查看文档](https://comfyui-wiki.com/zh/interface/workflow)### [4. 提示词本章节为ComfyUI提示词技巧说明，包含提示词权重调整，随机调用提示词内容等常见提示词技巧查看文档](https://comfyui-wiki.com/zh/interface/prompt)### [5.1 设置菜单本章节为ComfyUI系统菜单设置选项说明查看文档](https://comfyui-wiki.com/zh/interface/menu)### [5.2 ComfyComfyUI 设置菜单Comfy 相关配置设置左右详解查看文档](https://comfyui-wiki.com/zh/interface/comfy)### [5.3 画面介绍 ComfyUI中与画面操作界面相关的设置选项说明，包含画布设置、图形设置、链接设置、节点设置等配置选项的详细说明查看文档](https://comfyui-wiki.com/zh/interface/lite-graph)### [5.4 外观ComfyUI 外观菜单（Appearance）设置选项有关说明详解，包括主题样式配置、自定义主题设置、侧边栏设置等一系列外观设置查看文档](https://comfyui-wiki.com/zh/interface/appearance)### [5.5 遮罩编辑器一文详解 ComfyUI 中遮罩编辑器（Mask Editor）的使用方法，以及对应设置等查看文档](https://comfyui-wiki.com/zh/interface/maskeditor)### [5.6 快捷键ComfyUI中的常用快捷键和自定义快捷键的方法查看文档](https://comfyui-wiki.com/zh/interface/shortcuts)### [5.7 扩展ComfyUI 设置菜单中的扩展设置使用说明及功能讲解查看文档](https://comfyui-wiki.com/zh/interface/extension)### [5.8 服务器配置ComfyUI 服务相关配置及网络配置局域网共享等设置说明查看文档](https://comfyui-wiki.com/zh/interface/server-config)### [5.9 关于查看文档](https://comfyui-wiki.com/zh/interface/about)### [6. 文件结构全面解析 comfyUI 安装包的文件夹结构。了解 comfyUI 安装中每个目录和文件的用途及内容。查看文档](https://comfyui-wiki.com/zh/interface/files)
Last updated on 2025年3月24日
[3.6 安装 VAE](https://comfyui-wiki.com/zh/install/install-models/install-vae "3.6 安装 VAE")[1. 界面指南](https://comfyui-wiki.com/zh/interface/basic "1. 界面指南")
中文
System
