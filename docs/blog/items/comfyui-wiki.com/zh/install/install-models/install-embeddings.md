# 原始URL: https://comfyui-wiki.com/zh/install/install-models/install-embeddings

# 抓取时间: 2025-03-30 21:01:55

[Skip to content](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [要如何安装 Embeddings（Textual Inversion） 模型？](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#要如何安装-embeddingstextual-inversion-模型)
  * [Embeddings（Textual Inversion）是什么？](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#embeddingstextual-inversion是什么)
  * [哪里可以下载Embeddings（Textual Inversion） 模型？](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#哪里可以下载embeddingstextual-inversion-模型)
  * [ComfyUI中如何使用Embeddings模型？](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#comfyui中如何使用embeddings模型)
  * [其它相关内容](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#其它相关内容)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[3. 安装模型](https://comfyui-wiki.com/zh/install/install-models "3. 安装模型")3.3 安装 Embeddings
←→
...
如在下图中，在 [civitai](https://civitai.com)筛选模型时 选择 Embeddings即可筛选出 embedding 模型
![civitai_filters](https://comfyui-wiki.com/_next/static/media/embedding-fliter.04b7ff18.jpg)
## ComfyUI中如何使用Embeddings模型？[](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#comfyui中如何使用embeddings模型)
...
## 其它相关内容[](https://comfyui-wiki.com/zh/install/install-models/install-embeddings#其它相关内容)
  * 相关 ComfyUI 节点:[CLIP文本编码器](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/clip-text-encode)
  * 推荐辅助插件：[ComfyUI-Custom-Scripts](https://github.com/pythongosssss/ComfyUI-Custom-Scripts) 使用该插件你可以在 CLIP 文本编码器中输入“embedding:” 来快速输入 embedding 模型所在路径


![CLIPTextEncode](https://comfyui-wiki.com/_next/static/media/comfyui-textencode-embedding.47d671cd.jpg)
  * [Embedding 模型推荐](https://comfyui-wiki.com/zh/resource/embedding-models)
  * [ComfyUI 中如何使用 Embedding 模型](https://comfyui-wiki.com/zh/tutorial/basic/embedding)


Last updated on 2025年3月24日
[3.2 安装 ControlNet](https://comfyui-wiki.com/zh/install/install-models/install-controlnet "3.2 安装 ControlNet")[3.4 安装 Hypernetwork](https://comfyui-wiki.com/zh/install/install-models/install-hypernetwork "3.4 安装 Hypernetwork")
中文
System
