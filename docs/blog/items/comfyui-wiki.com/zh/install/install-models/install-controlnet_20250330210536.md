# 原始URL: https://comfyui-wiki.com/zh/install/install-models/install-controlnet

# 抓取时间: 2025-03-30 21:05:36

[Skip to content](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [下载 ControlNet 模型](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#下载-controlnet-模型)
  * [安装步骤](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#安装步骤)
  * [下载模型文件](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#下载模型文件)
  * [放置模型文件](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#放置模型文件)
  * [重启或刷新 ComfyUI](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#重启或刷新-comfyui)
  * [使用 ControlNet 模型](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#使用-controlnet-模型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[3. 安装模型](https://comfyui-wiki.com/zh/install/install-models "3. 安装模型")3.2 安装 ControlNet
←→
...
[ControlNet 模型下载资源](https://comfyui-wiki.com/zh/resource/controlnet-models)
## 安装步骤[](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#安装步骤)
### 下载模型文件[](https://comfyui-wiki.com/zh/install/install-models/install-controlnet#下载模型文件)
...
[如何在 ComfyUI 中使用 ControlNet 模型](https://comfyui-wiki.com/zh/tutorial/advanced/how-to-install-and-use-controlnet-models-in-comfyui)
通过正确安装和使用 ControlNet 模型,您可以更精确地控制 AI 图像生成过程,创造出更符合特定需求和想象的图像。
Last updated on 2025年3月24日
[3.1 安装检查点](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint "3.1 安装检查点")[3.3 安装 Embeddings](https://comfyui-wiki.com/zh/install/install-models/install-embeddings "3.3 安装 Embeddings")
中文
System
