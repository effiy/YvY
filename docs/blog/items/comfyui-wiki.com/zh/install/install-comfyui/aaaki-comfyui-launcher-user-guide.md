# 原始URL: https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide

# 抓取时间: 2025-03-30 21:01:53

[Skip to content](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [秋叶启动器下载](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#秋叶启动器下载)
  * [单独秋叶 A 启动器的](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#单独秋叶-a-启动器的)
  * [整合包版本](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#整合包版本)
  * [秋叶 ComfyUI 版本管理板块](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#秋叶-comfyui-版本管理板块)
  * [秋叶 ComfyUI 启动器安装新扩展的两种方式](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#秋叶-comfyui-启动器安装新扩展的两种方式)
  * [找到`版本管理（versions）/安装新扩展(install_extension)`](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#找到版本管理versions安装新扩展install_extension)
  * [浏览 / 在顶部输入框位置搜索你想要安装的ComfyUI插件名称](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#浏览--在顶部输入框位置搜索你想要安装的comfyui插件名称)
  * [安装 ComfyUI 插件（自定义节点）](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#安装-comfyui-插件自定义节点)
  * [查看是否安装成功](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#查看是否安装成功)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[1. 安装 ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui "1. 安装 ComfyUI")1.7 秋叶启动器指南
←→
...
秋叶启动器是由中国国内作者[@秋葉aaaki](https://space.bilibili.com/12566101) 开发的 ComfyUI 启动器，提供了一系列的功能整合，方便用户快速安装和使用 ComfyUI, 特别对于中国境内用户提供了 Github 仓库资源国内镜像，能够解决类似 Github 网络问题导致的安装失败等问题 使用aaaki启动器并不会和使用ComfyUI官方的便携版本产生冲突，两者可以同时使用
主要提供以下功能：
  1. **插件管理**
...
### 秋叶 ComfyUI 启动器安装新扩展的两种方式[](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#秋叶-comfyui-启动器安装新扩展的两种方式)
### 找到`版本管理（versions）/安装新扩展(install_extension)`[](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#找到版本管理versions安装新扩展install_extension)
![aaaki_version_install_extension](https://comfyui-wiki.com/aaaki/aaaki_version_install_extension.jpg)
在这个板块，你可以搜索已经提供好的对应插件 如果列表没有信息，可以尝试刷新一下，或者重启秋叶启动器，来更新这个列表的信息
### 浏览 / 在顶部输入框位置搜索你想要安装的ComfyUI插件名称[](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#浏览--在顶部输入框位置搜索你想要安装的comfyui插件名称)
  1. 你可以选择浏览当前的插件信息或者如在搜索栏搜索插件名称如： `ComfyUI-manager`


💡
如果你想要下载的插件没有搜索结果，可能是目前秋叶启动器服务端没有整合对应的插件信息，你可以尝试使用本教程的其它方法进行安装
  1. 在底部输入框`扩展URL（Extension URL）` 你也可以直接输入插件的 Git地址 来进行安装 直接使用 github 的 git 地址可能会因为网络问题而导致安装失败，如果安装失败你可以尝试将对应的插件转存到[码云](https://gitee.com/) 具体参见下面页面中对应部分的说明


[💾 ComfyUI 插件安装](https://comfyui-wiki.com/zh/install/install-custom-nodes)
### 安装 ComfyUI 插件（自定义节点）[](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#安装-comfyui-插件自定义节点)
在找到你需要的 comfyUI 插件（自定义节点）后，点击对应项目后的 `安装(install)` 按钮 等待程序运行，如果无误的话你将会看到安装成功提示
### 查看是否安装成功[](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide#查看是否安装成功)
安装成功后，你可以在插件管理面板看到你刚刚安装的插件信息
![aaaki_version_extension](https://comfyui-wiki.com/aaaki/aaaki_version_extension.webp)
💡
如果安装失败，请检查你的网络是否正常，是否有使用VPN等等，由于对应启动器使用的镜像可能是中国国内，如果你在国外的话可能存在网络速度问题。
Last updated on 2025年3月24日
[1.6 Install Git](https://comfyui-wiki.com/zh/install/install-comfyui/install-git "1.6 Install Git")[1.8 GPU 购买参考](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide "1.8 GPU 购买参考")
中文
System
