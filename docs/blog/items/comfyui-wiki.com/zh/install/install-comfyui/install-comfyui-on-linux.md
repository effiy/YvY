# 原始URL: https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux

# 抓取时间: 2025-03-30 21:01:52

[Skip to content](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [1. 克隆仓库](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#1-克隆仓库)
  * [2. 放置模型文件](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#2-放置模型文件)
  * [3. 安装PyTorch](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#3-安装pytorch)
  * [4. 安装依赖](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#4-安装依赖)
  * [5.运行ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#5运行comfyui)
  * [6.AMD GPU用户注意事项](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#6amd-gpu用户注意事项)
  * [7.Intel GPU用户](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#7intel-gpu用户)
  * [8.Mac硅芯片用户](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#8mac硅芯片用户)
  * [遇到问题？](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#遇到问题)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[1. 安装 ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui "1. 安装 ComfyUI")1.4 Linux
←→
...
## 遇到问题？[](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux#遇到问题)
如果在安装过程中遇到任何问题，可以参考[ComfyUI的 Github](https://github.com/comfyanonymous/ComfyUI)或社区论坛获取帮助。
Last updated on 2025年3月24日
[1.3 Mac](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-mac "1.3 Mac")[1.5 Run on Cloud](https://comfyui-wiki.com/zh/install/install-comfyui/run-comfyui-on-cloud "1.5 Run on Cloud")
中文
System
