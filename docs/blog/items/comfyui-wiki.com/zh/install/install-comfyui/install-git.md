# 原始URL: https://comfyui-wiki.com/zh/install/install-comfyui/install-git

# 抓取时间: 2025-03-30 21:01:52

[Skip to content](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Git 可视化学习](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#git-可视化学习)
  * [系统安装教程](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#系统安装教程)
  * [Windows 系统](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#windows-系统)
  * [Mac 系统](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#mac-系统)
  * [Linux 系统](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#linux-系统)
  * [ComfyUI 相关下载指南](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#comfyui-相关下载指南)
  * [插件下载](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#插件下载)
  * [方法一：使用 GitHub Desktop（新手使用）](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#方法一使用-github-desktop新手使用)
  * [方法二：使用命令行](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#方法二使用命令行)
  * [模型下载](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#模型下载)
  * [方法一：使用 GitHub Desktop](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#方法一使用-github-desktop)
  * [方法二：使用命令行](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#方法二使用命令行-1)
  * [常见问题](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#常见问题)
  * [进阶使用技巧](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#进阶使用技巧)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[1. 安装 ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui "1. 安装 ComfyUI")1.6 Install Git
←→
...
#### 推荐学习路径
  * 访问 [Git 可视化学习](https://learngitbranching.js.org/?locale=zh_CN) - 通过交互式游戏学习 Git
  * 阅读 [Pro Git 中文版](https://git-scm.com/book/zh/v2) - 系统学习参考
...
### Windows 系统[](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#windows-系统)
  ...
  3. **命令行工具使用**
     * **打开命令行方式** :
       * 使用 Windows Terminal (推荐): 按 `Win + X` 选择 “Windows Terminal”
       * 使用命令提示符: 按 `Win + R`,输入 `cmd` 回车
       * 使用 Git Bash: 在文件夹右键选择 “Git Bash Here”
     * **基本命令示例** :
```
# 进入指定目录
cd C:\path\to\ComfyUI
...
a) **通过官网安装**
     ...
     * 下载并安装 macOS 版本
     * 或使用 Xcode 命令行工具: `xcode-select --install`
b) **使用 Homebrew 安装(推荐)**
```
# 安装 Homebrew
...
```
  ...
  2. **命令行工具使用**
     * **打开终端方式** :
       * 使用系统自带 Terminal: `Command + 空格` 搜索 “Terminal”
       * 使用 iTerm2 (推荐): 
...
```
  ...
  3. **GitHub Desktop (可选)**
     * 下载 [GitHub Desktop](https://desktop.github.com/) Mac 版
...
#### 方法一：使用 GitHub Desktop[](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#方法一使用-github-desktop)
  1. **下载完整模型仓库**
     ...
     * 选择保存到对应的模型目录
     * 例如 Checkpoint 模型保存到 `models/checkpoints`
...
### 下载问题解决
  ...
  * 空间不足: 检查硬盘剩余空间
  * 权限问题: 确认文件夹写入权限
  * 克隆失败: 尝试使用 `git clone --depth 1` 只下载最新版本


## 进阶使用技巧[](https://comfyui-wiki.com/zh/install/install-comfyui/install-git#进阶使用技巧)
#### Git 常用命令
  * `git pull`: 更新仓库到最新版本
  * `git checkout [分支名]`: 切换到指定版本
  * `git clean -df`: 清理未跟踪的文件
  * `git reset --hard`: 重置到最新版本


Last updated on 2025年3月24日
[1.5 Run on Cloud](https://comfyui-wiki.com/zh/install/install-comfyui/run-comfyui-on-cloud "1.5 Run on Cloud")[1.7 秋叶启动器指南](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide "1.7 秋叶启动器指南")
中文
System
