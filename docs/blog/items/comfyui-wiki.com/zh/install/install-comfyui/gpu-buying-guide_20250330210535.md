# 原始URL: https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide

# 抓取时间: 2025-03-30 21:05:35

[Skip to content](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [显卡架构与性能说明](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#显卡架构与性能说明)
  * [GPU性能对比表](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#gpu性能对比表)
  * [不同平台支持情况](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#不同平台支持情况)
  * [Windows平台 (S级推荐)](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#windows平台-s级推荐)
  * [Linux平台 (B级推荐)](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#linux平台-b级推荐)
  * [MacOS平台 (C级推荐)](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#macos平台-c级推荐)
  * [AMD Windows平台 (D级推荐)](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#amd-windows平台-d级推荐)
  * [具体使用场景推荐](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#具体使用场景推荐)
  * [1. 个人爱好者](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#1-个人爱好者)
  * [2. 半专业用户](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#2-半专业用户)
  * [3. 专业创作者](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#3-专业创作者)
  * [不同模型的显存需求](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#不同模型的显存需求)
  * [特定应用场景配置建议](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#特定应用场景配置建议)
  * [Flux模型使用场景](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#flux模型使用场景)
  * [Flux模型性能优化建议](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#flux模型性能优化建议)
  * [AI视频生成场景](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#ai视频生成场景)
  * [性能提升建议](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#性能提升建议)
  * [注意事项](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide#注意事项)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")[1. 安装 ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui "1. 安装 ComfyUI")1.8 GPU 购买参考
←→
...
[1.7 秋叶启动器指南](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide "1.7 秋叶启动器指南")[2. 安装自定义节点](https://comfyui-wiki.com/zh/install/install-custom-nodes "2. 安装自定义节点")
中文
System
