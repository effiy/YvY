# 原始URL: https://comfyui-wiki.com/zh/install/install-models

# 抓取时间: 2025-03-30 21:01:54

[Skip to content](https://comfyui-wiki.com/zh/install/install-models#reach-skip-nav)
...
[安装指南](https://comfyui-wiki.com/zh/install "安装指南")3. 安装模型
←→
...
[2. 安装自定义节点](https://comfyui-wiki.com/zh/install/install-custom-nodes "2. 安装自定义节点")[3.1 安装检查点](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint "3.1 安装检查点")
中文
System
