# 原始URL: https://comfyui-wiki.com/zh/privacy-policy

# 抓取时间: 2025-03-30 21:04:30

[Skip to content](https://comfyui-wiki.com/zh/privacy-policy#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [1. 引言](https://comfyui-wiki.com/zh/privacy-policy#1-引言)
  * [2. 网站地址](https://comfyui-wiki.com/zh/privacy-policy#2-网站地址)
  * [3. 我们收集的信息](https://comfyui-wiki.com/zh/privacy-policy#3-我们收集的信息)
  * [4. 非个人数据收集](https://comfyui-wiki.com/zh/privacy-policy#4-非个人数据收集)
  * [5. 数据使用](https://comfyui-wiki.com/zh/privacy-policy#5-数据使用)
  * [6. 数据存储和安全](https://comfyui-wiki.com/zh/privacy-policy#6-数据存储和安全)
  * [7. 数据保留](https://comfyui-wiki.com/zh/privacy-policy#7-数据保留)
  * [8. 第三方服务](https://comfyui-wiki.com/zh/privacy-policy#8-第三方服务)
  * [9. 儿童隐私](https://comfyui-wiki.com/zh/privacy-policy#9-儿童隐私)
  * [10. 隐私政策更新](https://comfyui-wiki.com/zh/privacy-policy#10-隐私政策更新)
  * [11. 联系信息](https://comfyui-wiki.com/zh/privacy-policy#11-联系信息)
  * [12. 用户同意](https://comfyui-wiki.com/zh/privacy-policy#12-用户同意)
...
**更新日期：** 2024年8月6日
## 1. 引言[](https://comfyui-wiki.com/zh/privacy-policy#1-引言)
感谢您选择ComfyUI-Wiki。本隐私政策详细说明了我们如何收集、使用、保护和共享您的信息。
## 2. 网站地址[](https://comfyui-wiki.com/zh/privacy-policy#2-网站地址)
我们的网站位于 <http://comfyui-wiki.com>。
## 3. 我们收集的信息[](https://comfyui-wiki.com/zh/privacy-policy#3-我们收集的信息)
由于我们的网站目前没有支付和登录功能，我们不收集任何个人数据。但是，为了提升您的浏览体验，我们可能会使用cookies和其他跟踪技术来收集非个人数据。
## 4. 非个人数据收集[](https://comfyui-wiki.com/zh/privacy-policy#4-非个人数据收集)
我们可能会收集以下非个人数据：
  * 网页浏览习惯，例如页面访问顺序和停留时间。
  * 设备信息，如屏幕分辨率和操作系统类型。
  * 地理位置数据，用于提供更个性化的内容和语言设置。
...
## 6. 数据存储和安全[](https://comfyui-wiki.com/zh/privacy-policy#6-数据存储和安全)
我们采取适当的安全措施来保护收集的非个人数据，包括数据加密和安全访问控制。
## 7. 数据保留[](https://comfyui-wiki.com/zh/privacy-policy#7-数据保留)
我们仅在必要时保留非个人数据，并在不再需要时从我们的系统中删除。
## 8. 第三方服务[](https://comfyui-wiki.com/zh/privacy-policy#8-第三方服务)
我们的网站可能会使用第三方服务，例如分析工具和广告网络。这些服务可能有它们自己的隐私政策。
## 9. 儿童隐私[](https://comfyui-wiki.com/zh/privacy-policy#9-儿童隐私)
ComfyUI-Wiki 不针对未成年人，我们不会故意收集未成年人的个人信息。
## 10. 隐私政策更新[](https://comfyui-wiki.com/zh/privacy-policy#10-隐私政策更新)
我们将通过网站公告和/或电子邮件通知用户本隐私政策的任何更新。
## 11. 联系信息[](https://comfyui-wiki.com/zh/privacy-policy#11-联系信息)
如果您对我们的隐私政策有任何问题或疑虑，请通过电子邮件与我们联系。我们的联系邮箱地址为：将`#`替换为`@`，即 `contact#comfyui-wiki.com`。
## 12. 用户同意[](https://comfyui-wiki.com/zh/privacy-policy#12-用户同意)
通过使用我们的网站，您同意我们按照本隐私政策收集和使用非个人数据。
