# 原始URL: https://comfyui-wiki.com/zh/interface/extension

# 抓取时间: 2025-03-30 21:02:01

[Skip to content](https://comfyui-wiki.com/zh/interface/extension#reach-skip-nav)
...
[界面及设置](https://comfyui-wiki.com/zh/interface "界面及设置")5.7 扩展
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 扩展（Extension） - ComfyUI 设置菜单中的扩展设置
![ComfyUI 设置菜单 - 扩展菜单](https://comfyui-wiki.com/_next/static/media/extension.40a451fa.jpg)
当前的许多 ComfyUI 功能都是以扩展的方式来进行实现的，包括许多 `Comfy Core` 的功能。扩展面板可以临时禁用或启用某个扩展功能如 MaskEditor，或者第三方的功能扩展，启用或禁用对应的扩展后重新加载（reload）对应窗口，即可应用对应的功能启用 / 禁用。
Last updated on 2025年3月24日
[5.6 快捷键](https://comfyui-wiki.com/zh/interface/shortcuts "5.6 快捷键")[5.8 服务器配置](https://comfyui-wiki.com/zh/interface/server-config "5.8 服务器配置")
中文
System
