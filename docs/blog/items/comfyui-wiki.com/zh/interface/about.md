# 原始URL: https://comfyui-wiki.com/zh/interface/about

# 抓取时间: 2025-03-30 21:02:03

[Skip to content](https://comfyui-wiki.com/zh/interface/about#reach-skip-nav)
...
[界面及设置](https://comfyui-wiki.com/zh/interface "界面及设置")5.9 关于
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 关于 - ComfyUI 设置菜单
![ComfyUI 设置菜单 - 关于菜单](https://comfyui-wiki.com/_next/static/media/about.67747185.jpg)
在这个设置菜单里，你可以找到当前 ComfyUI 版本和运行环境的信息，如：
  * Python Version：当前运行的 Python 版本
  * Arguments：Python 运行参数
  * RAM Total: 总内存
  * RAM Free: 可用内存
  * 设备(Devices): 对应的设备信息如显卡信息等


Last updated on 2025年3月24日
[5.8 服务器配置](https://comfyui-wiki.com/zh/interface/server-config "5.8 服务器配置")[6. 文件结构](https://comfyui-wiki.com/zh/interface/files "6. 文件结构")
中文
System
