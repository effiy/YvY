# 原始URL: https://comfyui-wiki.com/zh/interface/shortcuts

# 抓取时间: 2025-03-30 21:02:01

[Skip to content](https://comfyui-wiki.com/zh/interface/shortcuts#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ComfyUI 自定义快捷键设置](https://comfyui-wiki.com/zh/interface/shortcuts#comfyui-自定义快捷键设置)
  * [ComfyUI 的常用快捷键快捷键及对应功能](https://comfyui-wiki.com/zh/interface/shortcuts#comfyui-的常用快捷键快捷键及对应功能)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[界面及设置](https://comfyui-wiki.com/zh/interface "界面及设置")5.6 快捷键
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# ComfyUI 快捷键自定义设置及常用快捷键
目前 ComfyUI 有预设一些快捷键，下面是[ComfyUI-Wiki](https://comfyui-wiki.com/zh/)整理的相关快捷键说明，在最新的版本迭代中，ComfyUI 已经支持了自定义快捷键
## ComfyUI 自定义快捷键设置[](https://comfyui-wiki.com/zh/interface/shortcuts#comfyui-自定义快捷键设置)
在最新版本的 ComfyUI 中，用户可以自定义快捷键，具体设置方法如下：
![ComfyUI 自定义快捷键设置](https://comfyui-wiki.com/_next/static/media/setting-menu-keybinding.cbf1d4bf.jpg)
  1. 点击设置设置菜单在设置面板中找到`Keybinding`
  2. 在`Keybinding`面板中，当鼠标悬浮在快捷键上时，会出现编辑和删除按钮
  3. 点击编辑按钮，可以编辑已有的快捷键，点击删除按钮，可以删除已有的快捷键


## ComfyUI 的常用快捷键快捷键及对应功能[](https://comfyui-wiki.com/zh/interface/shortcuts#comfyui-的常用快捷键快捷键及对应功能)
下方表格为comfyUI快捷键及对应功能说明
快捷键| 快捷键说明  
---|---  
Ctrl + Enter| 将当前工作流程加入图像生成队列中  
Ctrl + Shift + Enter| 将当前工作流程作为第一个生图的加入到图像生成队列中  
Ctrl + Z/Ctrl + Y| 撤销/重做  
Ctrl + S| 保存工作流  
Ctrl + O| 加载（打开）工作流  
Ctrl + A| 选择全部节点  
Alt + C| 折叠/取消折叠所选节点  
Ctrl + M| 屏蔽/解除屏蔽当前工作节点  
Ctrl + B| 忽略选中的节点 (使对应节点不参与到生图中来)  
Delete/Backspace| 删除选中的节点  
Ctrl + Delete/Backspace| 删除当前工作流  
Space| 使用鼠标拖动画布  
Ctrl/Shift + Click（点击）| 把点击的节点加入到选中  
Ctrl + C/Ctrl + V| 复制和粘贴选中节点（不保持对应节点与其它未选定节点输出的连接）  
Ctrl + C/Ctrl + Shift + V| 复制和粘贴选中节点（保持对应节点与其它未选定节点输出的连接）  
Shift + Drag（拖动）| 同时移动多个所选节点  
Alt + Drag（拖动）| 复制选中节点  
Ctrl + D| 加载默认工作流  
Ctrl + D| 加载默认工作流  
Q| 切换生图队列列表的可见性  
...
Ctrl + 按住鼠标左键拖动| 框选同时选中多个节点  
对于 macOS 用户，`Ctrl` 也可以替换为 `Command` 使用，如果你在实际使用中发现 `command` 键无法生效，可以看看是不是某些浏览器插件导致的，或者切换其它浏览器查看效果，在我在 Mac系统下的使用，有时会出现在 command 不生效，但是 ctrl 依旧可以使用的情况
Last updated on 2025年3月24日
[5.5 遮罩编辑器](https://comfyui-wiki.com/zh/interface/maskeditor "5.5 遮罩编辑器")[5.7 扩展](https://comfyui-wiki.com/zh/interface/extension "5.7 扩展")
中文
System
