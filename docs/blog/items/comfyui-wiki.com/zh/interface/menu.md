# 原始URL: https://comfyui-wiki.com/zh/interface/menu

# 抓取时间: 2025-03-30 21:01:59

[Skip to content](https://comfyui-wiki.com/zh/interface/menu#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [如何进入设置菜单](https://comfyui-wiki.com/zh/interface/menu#如何进入设置菜单)
  * [新版本 ComfyUI 界面菜单设置入口](https://comfyui-wiki.com/zh/interface/menu#新版本-comfyui-界面菜单设置入口)
  * [旧版本 ComfyUI 界面菜单设置入口](https://comfyui-wiki.com/zh/interface/menu#旧版本-comfyui-界面菜单设置入口)
  * [详细菜单设置说明](https://comfyui-wiki.com/zh/interface/menu#详细菜单设置说明)
  * [旧版本菜单界面](https://comfyui-wiki.com/zh/interface/menu#旧版本菜单界面)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[界面及设置](https://comfyui-wiki.com/zh/interface "界面及设置")5.1 设置菜单
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# 菜单设置 - ComfyUI 菜单设置说明
![ComfyUI 设置菜单](https://comfyui-wiki.com/_next/static/media/setting-language.f8b09ed4.jpg)
这个部分主要讲解 ComfyUI 设置菜单相关功能
  * [ComfyUI Desktop 版](https://comfyui-wiki.com/zh/install/install-comfyui/comfyui-desktop-installation-guide) 的设置菜单与其它版本的菜单稍有差异
  * 旧版本菜单在迭代后完全进行了改版
...
### 新版本 ComfyUI 界面菜单设置入口[](https://comfyui-wiki.com/zh/interface/menu#新版本-comfyui-界面菜单设置入口)
如果你使用新版本（默认）界面，点击屏幕中的齿轮图标，即可打开进入设置菜单，参考下图箭头位置 ![设置菜单入口](https://comfyui-wiki.com/_next/static/media/menu-new.950946d4.jpg)
### 旧版本 ComfyUI 界面菜单设置入口[](https://comfyui-wiki.com/zh/interface/menu#旧版本-comfyui-界面菜单设置入口)
如果切换到了旧版本界面，点击齿轮的 icon 即可进入设置菜单，参考下图箭头位置 ![设置菜单入口](https://comfyui-wiki.com/_next/static/media/menu-old.ee4a0eca.jpg)
## 详细菜单设置说明[](https://comfyui-wiki.com/zh/interface/menu#详细菜单设置说明)
对应菜单各个部分的设置说明如下，请访问对应的文章获取对应的菜单设置说明
  * [Comfy](https://comfyui-wiki.com/zh/interface/comfy)
  * [画面（Lite Graph）](https://comfyui-wiki.com/zh/interface/lite-graph)
  * [外观(Appearance)](https://comfyui-wiki.com/zh/interface/appearance)
  * 遮罩编辑器(Mask Editor)
  * Comfy 桌面版(Comfy-Desktop)
  * [快捷键(Keybinding)](https://comfyui-wiki.com/zh/interface/shortcuts)
  * 扩展(Extension)
  * [服务器配置(Server-Config)](https://comfyui-wiki.com/zh/interface/server-config)


## 旧版本菜单界面[](https://comfyui-wiki.com/zh/interface/menu#旧版本菜单界面)
此部分保留了旧版本 ComfyUI 菜单的截图，如果你在使用比较老的 ComfyUI 版本，那么你应该可以看到这个界面，但由于 ComfyUI 的更新，故本文不再对这部分的菜单进行详细的说明
![ComfyUI 旧版本菜单界面](https://comfyui-wiki.com/_next/static/media/menu.005a02f8.jpg)
Last updated on 2025年3月24日
[4. 提示词](https://comfyui-wiki.com/zh/interface/prompt "4. 提示词")[5.2 Comfy](https://comfyui-wiki.com/zh/interface/comfy "5.2 Comfy")
中文
System
