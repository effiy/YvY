# 原始URL: https://comfyui-wiki.com/zh/interface/prompt

# 抓取时间: 2025-03-30 21:01:59

[Skip to content](https://comfyui-wiki.com/zh/interface/prompt#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [🚧prompt 书写有什么技巧？要如何写AI绘图的prompt](https://comfyui-wiki.com/zh/interface/prompt#prompt-书写有什么技巧要如何写ai绘图的prompt)
  * [在ComfyUI中如何调整提示词权重？](https://comfyui-wiki.com/zh/interface/prompt#在comfyui中如何调整提示词权重)
  * [1、通过英文括号并注明权重](https://comfyui-wiki.com/zh/interface/prompt#1通过英文括号并注明权重)
  * [2、通过英文括号`()`加权](https://comfyui-wiki.com/zh/interface/prompt#2通过英文括号加权)
  * [增加权重快捷键](https://comfyui-wiki.com/zh/interface/prompt#增加权重快捷键)
  * [如何让ComfyUI随机调用prompt内容？](https://comfyui-wiki.com/zh/interface/prompt#如何让comfyui随机调用prompt内容)
  * [常用prompt 推荐](https://comfyui-wiki.com/zh/interface/prompt#常用prompt-推荐)
  * [提升画质prompt](https://comfyui-wiki.com/zh/interface/prompt#提升画质prompt)
  * [prompt 文档推荐](https://comfyui-wiki.com/zh/interface/prompt#prompt-文档推荐)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[界面及设置](https://comfyui-wiki.com/zh/interface "界面及设置")4. 提示词
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# ComfyUI prompt技巧
Prompt 输入不支持中文，建议使用翻译插件或者使用翻译软件来进行翻译。 翻译插件推荐：[沙拉查词](https://saladict.crimx.com/)
## 🚧prompt 书写有什么技巧？要如何写AI绘图的prompt[](https://comfyui-wiki.com/zh/interface/prompt#prompt-书写有什么技巧要如何写ai绘图的prompt)
### 在ComfyUI中如何调整提示词权重？[](https://comfyui-wiki.com/zh/interface/prompt#在comfyui中如何调整提示词权重)
以下是comfyUI中调整提示词权重的方法：
#### 1、通过英文括号并注明权重[](https://comfyui-wiki.com/zh/interface/prompt#1通过英文括号并注明权重)
使用`(prompt:权重)`
> 如： `(1girl:1.1)`
#### 2、通过英文括号`()`加权[](https://comfyui-wiki.com/zh/interface/prompt#2通过英文括号加权)
你可以使用`(prompt)`的方式让提示词权重提升为原来的**1.1** 倍
> 如： `(1girl)`
#### 增加权重快捷键[](https://comfyui-wiki.com/zh/interface/prompt#增加权重快捷键)
选中prompt后
  * 键盘 `Ctrl + Up↑（方向键上）` 可提升对应prompt **0.05** 权重
  * 键盘 `Ctrl + Down↓（方向键下）` 可降低对应prompt **0.05** 权重


## 如何让ComfyUI随机调用prompt内容？[](https://comfyui-wiki.com/zh/interface/prompt#如何让comfyui随机调用prompt内容)
使用`{选择1|选择2|选择3|...}`可以让ComfyUI随机选择一个prompt参与生图流程
> 如： `{red|blue|green}`则会从其中选择一个颜色
### 常用prompt 推荐[](https://comfyui-wiki.com/zh/interface/prompt#常用prompt-推荐)
#### 提升画质prompt[](https://comfyui-wiki.com/zh/interface/prompt#提升画质prompt)
用途| 描述  
---|---  
HDR, UHD, 64K| 提升照片质量，增强动态范围（HDR）、超高分辨率（UHD，包括4K、8K和64K）  
Highly detailed| 增加画面精细度，展现更多细节  
Studio lighting| 添加专业演播室灯光效果，为图像赋予丰富纹理  
Professional| 调整色彩对比度与细节层次，显著提升图片的专业感  
Vivid Colors| 强化颜色鲜艳度，为图像注入生动活力  
Bokeh| 实现背景虚化，类似iPhone人像模式，突出主体  
High resolution scan| 高精度扫描，使照片具有复古质感，增添年代气息  
Sketch| 将图片转化为素描风格  
Painting| 将图片转译为绘画效果  
#### prompt 文档推荐[](https://comfyui-wiki.com/zh/interface/prompt#prompt-文档推荐)
...
[3. 工作流](https://comfyui-wiki.com/zh/interface/workflow "3. 工作流")[5.1 设置菜单](https://comfyui-wiki.com/zh/interface/menu "5.1 设置菜单")
中文
System
