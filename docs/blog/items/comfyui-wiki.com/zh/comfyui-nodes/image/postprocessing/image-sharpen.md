# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-sharpen

# 抓取时间: 2025-03-30 21:02:49

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-sharpen#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-sharpen#输入类型)
  * [输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-sharpen#输出类型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Image](https://comfyui-wiki.com/zh/comfyui-nodes/image/animation "Image")[postprocessing](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-blend "postprocessing")Image Sharpen 图像锐化
←→
...
![](https://comfyui-wiki.com/_next/static/media/ImageSharpen.4aeb3db0.jpg) 此节点通过强调图像的边缘和细节来增强图像的清晰度。它对图像应用锐化滤镜，可以调整强度和半径，使图像看起来更清晰和鲜明。
## 输入类型[](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-sharpen#输入类型)
参数名称| 数据类型| 作用  
---|---|---  
...
[Image Quantize](https://comfyui-wiki.com/zh/comfyui-nodes/image/postprocessing/image-quantize "Image Quantize")[Canny 节点](https://comfyui-wiki.com/zh/comfyui-nodes/image/preprocessors/canny "Canny 节点")
中文
System
