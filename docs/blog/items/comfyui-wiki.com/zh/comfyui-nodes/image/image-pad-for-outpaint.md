# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint

# 抓取时间: 2025-03-30 21:02:46

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint#文档说明)
  * [输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint#输入类型)
  * [输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint#输出类型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Image](https://comfyui-wiki.com/zh/comfyui-nodes/image/animation "Image")Image Pad For Outpainting 外补画板
←→
...
## 文档说明[](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-pad-for-outpaint#文档说明)
  * 类名：`ImagePadForOutpaint`
  * 类别：`image`
  * 输出节点：`False` 此节点设计用于通过在图像周围添加填充来准备图像进行外延处理。它调整图像尺寸以确保与外延算法兼容，从而方便生成超出原始边界的扩展图像区域。
...
[Invert Image 图像反转](https://comfyui-wiki.com/zh/comfyui-nodes/image/image-invert "Invert Image 图像反转")[Load Image 加载图像](https://comfyui-wiki.com/zh/comfyui-nodes/image/load-image "Load Image 加载图像")
中文
System
