# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler

# 抓取时间: 2025-03-30 21:03:15

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler#文档说明)
  * [Input 输入](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler#input-输入)
  * [Output 输出](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler#output-输出)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Sampling](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/custom-sampling "Sampling")KSampler
←→
...
![comfyUI节点-KSampler K采样器 ｜ComfyUI组件节点](https://comfyui-wiki.com/sampling/KSampler.jpg)
## 文档说明[](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler#文档说明)
  * 类名：`KSampler`
  * 类别：`采样`
  * 输出节点：`否` KSampler这个采样器，是这样工作的：它会根据提供的特定的模型和正、负两种条件，来改造提供的原始潜在图像信息。 首先，它会根据设定好的**seed随机种子** 和**denoise降噪强度** ，给原始图像数据加入一些噪声，然后输入预设的**Model模型** 结合**positive正向** 和**negative负向** 的引导条件，去生成图像
...
Positive正向条件| conditioning条件| 用于引导降噪的正向条件，可理解为**想要** 在画面中出现的内容  
Negative负向条件| conditioning条件| 用于引导降噪的负向条件，可理解为**不想要** 在画面中出现的内容  
...
[Split Sigmas](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/custom-sampling/sigmas/split-sigmas "Split Sigmas")[KSampler (Advanced)](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler-advanced "KSampler \(Advanced\)")
中文
System
