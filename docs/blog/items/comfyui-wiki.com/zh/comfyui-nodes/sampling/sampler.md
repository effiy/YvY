# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler

# 抓取时间: 2025-03-30 21:03:16

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [旧版采样器](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#旧版采样器)
  * [DPM采样器](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#dpm采样器)
  * [新版采样器](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#新版采样器)
  * [scheduler 调度器](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#scheduler-调度器)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Sampling](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/custom-sampling "Sampling")Sampler 采样器详解
←→
...
### 新版采样器[](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/sampler#新版采样器)
  ...
  * **a** 为英文`ancestral（祖先采样器）`的缩写，这样的采样器因为会在采样过程中持续添加噪声，会使得每步采样生成的画面都具有一定随机性，也就是**不收敛**


  1. 名称中带GPU的


  * 诸如`dpmpp_sde_gpu`这样的采样器是针对GPU硬件进行了优化的版本，它们能够在图形处理器上高效运行大规模并行计算任务，从而显著加快图像生成速度。
...
[KSampler (Advanced)](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/k-sampler-advanced "KSampler \(Advanced\)")[Video Linear CFG Guidance](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/video-models/video-linear-cfg-guidance "Video Linear CFG Guidance")
中文
System
