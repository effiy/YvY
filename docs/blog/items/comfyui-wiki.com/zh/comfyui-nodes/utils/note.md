# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/utils/note

# 抓取时间: 2025-03-30 21:03:17

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/utils/note#reach-skip-nav)
...
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")UtilsNote 注释节点
←→
[新闻|字节跳动发布 InfiniteYou：保留用户身份特征的灵活图像再创作框架2025/03/21](https://comfyui-wiki.com/zh/news/2025-03-21-bytedance-infiniteyou)
# Note 注释节点
![ComfyUI Node Menu - Note Annotation Node](https://comfyui-wiki.com/utils/Note.jpg)
节点名称：Note 注释节点（备注） 节点用途用于在工作流中添加文本备注
Last updated on 2025年3月24日
[Video Linear CFG Guidance](https://comfyui-wiki.com/zh/comfyui-nodes/sampling/video-models/video-linear-cfg-guidance "Video Linear CFG Guidance")[Primitive 元节点](https://comfyui-wiki.com/zh/comfyui-nodes/utils/primitive "Primitive 元节点")
中文
System
