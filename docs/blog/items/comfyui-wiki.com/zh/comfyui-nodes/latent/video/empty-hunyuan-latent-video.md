# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video

# 抓取时间: 2025-03-30 21:03:01

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [Empty Hunyuan Latent Video 节点概述](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-节点概述)
  * [类名](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#类名)
  * [Empty Hunyuan Latent Video 输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-输入类型)
  * [Empty Hunyuan Latent Video 输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-输出类型)
  * [Empty Hunyuan Latent Video 工作流示例](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-工作流示例)
  * [与该节点相关的一些资源](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#与该节点相关的一些资源)
  * [Empty Hunyuan Latent Video 节点源码](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-节点源码)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Latent](https://comfyui-wiki.com/zh/comfyui-nodes/latent/latent-upscale "Latent")videoEmpty Hunyuan Latent Video 空Latent视频（混元）节点教程
←→
...
## Empty Hunyuan Latent Video 节点概述[](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-节点概述)
`EmptyHunyuanLatentVideo` 节点和 [EmptyLatent Image](https://comfyui-wiki.com/zh/comfyui-nodes/latent/empty-latent-image) 有点类似 你可以这样理解它的功能，在绘画中作家需要画布来进行作画，对应的尺寸大小和长度就是画布的特征，批次信息则为提供几张画布而这个节点就是提供了一个全新的空白的画布，用于后续的视频生成。
## 类名[](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#类名)
...
## Empty Hunyuan Latent Video 工作流示例[](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#empty-hunyuan-latent-video-工作流示例)
[腾讯混元视频模型工作流](https://comfyui-wiki.com/zh/tutorial/advanced/hunyuan-text-to-video-workflow-guide-and-example)
## 与该节点相关的一些资源[](https://comfyui-wiki.com/zh/comfyui-nodes/latent/video/empty-hunyuan-latent-video#与该节点相关的一些资源)
下面是 [ComfyUI Wiki](https://comfyui-wiki.com/)为大家整理的相关资源
  * [Hunyuan Video](https://huggingface.co/tencent/HunyuanVideo)
  * [ComfyUI_examples - Hunyuan Video Model](https://comfyanonymous.github.io/ComfyUI_examples/hunyuan_video/)
...
[Rotate Latent](https://comfyui-wiki.com/zh/comfyui-nodes/latent/transform/latent-rotate "Rotate Latent")[Checkpoint Loader (Simple)](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/checkpoint-loader-simple "Checkpoint Loader \(Simple\)")
中文
System
