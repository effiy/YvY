# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine

# 抓取时间: 2025-03-30 21:02:31

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine#文档说明)
  * [输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine#输入类型)
  * [输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine#输出类型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Conditioning](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/3d-models "Conditioning")Conditioning(Combine) - 条件合并节点
←→
...
![comfyUI节点-Conditioning\(Combine\)｜条件合并](https://comfyui-wiki.com/conditioning/Conditioning\(Combine\).jpg)
## 文档说明[](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine#文档说明)
  * 类名：`条件合并`
  * 类别：`条件`
  * 输出节点：`False`
...
[条件平均](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average "条件平均")[Conditioning (Concat) - 条件联结节点](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-concat "Conditioning \(Concat\) - 条件联结节点")
中文
System
