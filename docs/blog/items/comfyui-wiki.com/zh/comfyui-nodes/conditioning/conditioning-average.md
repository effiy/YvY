# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average

# 抓取时间: 2025-03-30 21:02:29

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average#文档说明)
  * [输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average#输入类型)
  * [输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average#输出类型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Conditioning](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/3d-models "Conditioning")条件平均
←→
...
## 文档说明[](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-average#文档说明)
  * 类名：`条件平均`
  * 类别：`条件`
  * 输出节点：`False` 此节点设计用于混合两组条件数据，根据指定的强度应用加权平均。这一过程允许动态调整条件影响，便于微调生成的内容或特征。
...
[CLIP视觉编码](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/clip-vision-encode "CLIP视觉编码")[Conditioning(Combine) - 条件合并节点](https://comfyui-wiki.com/zh/comfyui-nodes/conditioning/conditioning-combine "Conditioning\(Combine\) - 条件合并节点")
中文
System
