# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl

# 抓取时间: 2025-03-30 21:02:16

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [CLIP文本编码SDXL-节点描述](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#clip文本编码sdxl-节点描述)
  * [CLIP文本编码SDXL-输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#clip文本编码sdxl-输入类型)
  * [CLIP文本编码SDXL-输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#clip文本编码sdxl-输出类型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")AdvancedconditioningCLIP文本编码SDXL-ComfyUI节点
←→
...
![comfyUI节点-CLIPTextEncodeSDXLRefiner|CLIP文本编码SDXL（Refiner）](https://comfyui-wiki.com/advanced/conditioning/CLIPTextEncodeSDXL.jpg)
## CLIP文本编码SDXL-节点描述[](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl#clip文本编码sdxl-节点描述)
...
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[CLIP文本编码SDXL（Refiner）-ComfyUI节点](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning/clip-text-encode-sdxl-refiner "CLIP文本编码SDXL（Refiner）-ComfyUI节点")
中文
System
