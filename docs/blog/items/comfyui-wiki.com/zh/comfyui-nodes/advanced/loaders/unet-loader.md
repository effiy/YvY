# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader

# 抓取时间: 2025-03-30 21:02:22

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明 - UNET Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#文档说明---unet-loader)
  * [输入类型 - UNET Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#输入类型---unet-loader)
  * [输出类型 - UNET Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#输出类型---unet-loader)
  * [UNET Loader Guide | Load Diffusion Model Workflow Example](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#unet-loader-guide--load-diffusion-model-workflow-example)
  * [下载 FLux.1 UNET 模型](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#下载-flux1-unet-模型)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Advanced](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning "Advanced")[loaders](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/clip-loader "loaders")UNET Loader | UNET加载器-ComfyUI节点
←→
...
UNETLoader 节点旨在通过名称加载 U-Net 模型，方便在系统中使用预训练的 U-Net 架构。 这个节点名称已更新为 `Load Diffusion Model`.
## 输入类型 - UNET Loader[](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader#输入类型---unet-loader)
参数名称| 数据类型| 作用  
---|---|---  
...
`flux1-dev.safetensors`| 23.8GB| [Download](https://huggingface.co/black-forest-labs/FLUX.1-dev/blob/main/flux1-dev.safetensors)| 高显存用户  
  1. 下载 `flux1-schnell.safetensors`
  2. 将对应的文件存放至 `ComfyUI/models/unet/` folder


Last updated on 2025年3月24日
[双CLIP加载器-ComfyUI节点](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader "双CLIP加载器-ComfyUI节点")[模型连续采样算法EDM](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/model/model-sampling-continuous-edm "模型连续采样算法EDM")
中文
System
