# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader

# 抓取时间: 2025-03-30 21:02:22

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [文档说明 - 双 CLIP 加载器 | Dual CLIP Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#文档说明---双-clip-加载器--dual-clip-loader)
  * [下载 ComfyUI flux_text_encoders clip 模型](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#下载-comfyui-flux_text_encoders-clip-模型)
  * [输入类型 - 双 CLIP 加载器 | Dual CLIP Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#输入类型---双-clip-加载器--dual-clip-loader)
  * [输出类型 - 双 CLIP 加载器 | Dual CLIP Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#输出类型---双-clip-加载器--dual-clip-loader)
  * [工作流示例 - 双 CLIP 加载器 | Dual CLIP Loader](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#工作流示例---双-clip-加载器--dual-clip-loader)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Advanced](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/conditioning "Advanced")[loaders](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/clip-loader "loaders")双CLIP加载器-ComfyUI节点
←→
...
## 下载 ComfyUI flux_text_encoders clip 模型[](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/dual-clip-loader#下载-comfyui-flux_text_encoders-clip-模型)
💡
此处内容针对的是使用 Flux.1 进行绘图时 FP8 的 CLIP 模型，如果你需要使用 GGUF 的 CLIP 则需要安装 [ComfyUI-GGUF插件](https://github.com/ComfyUI/ComfyUI-GGUF) 如果你正在开始学习使用 Flux 模型进行绘图，请参考我撰写的针对 Flux.1 各个版本的文生图工作流教程[Flux.1 ComfyUI 指南与工作流示例](https://comfyui-wiki.com/zh/tutorial/advanced/flux1-comfyui-guide-workflow-and-examples)
[ComfyUI flux_text_encoders 在 hugging face 上](https://huggingface.co/comfyanonymous/flux_text_encoders/tree/main)
模型文件名| 文件大小| 备注| 链接  
---|---|---|---  
`clip_l.safetensors`| 246 MB| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/clip_l.safetensors)  
`t5xxl_fp8_e4m3fn.safetensors` (推荐)| 4.89 GB| 低内存使用（8-12GB）| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp8_e4m3fn.safetensors)  
`t5xxl_fp16.safetensors`| 9.79 GB| 如果你有高显存和内存（超过32GB内存），则可以获得更好的结果。| [下载](https://huggingface.co/comfyanonymous/flux_text_encoders/blob/main/t5xxl_fp16.safetensors)  
  1. 下载 **clip_l.safetensors**
  2. 根据你的显存和内存情况，下载 **t5xxl_fp8_e4m3fn.safetensors** 或 **t5xxl_fp16.safetensors**
  3. 将下载的模型文件放置在 `ComfyUI/models/clip/` 文件夹中
...
[Diffuser Loader｜扩散加载器-ComfyUI节点](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/deprecated-diffusers-loader "Diffuser Loader｜扩散加载器-ComfyUI节点")[UNET Loader | UNET加载器-ComfyUI节点](https://comfyui-wiki.com/zh/comfyui-nodes/advanced/loaders/unet-loader "UNET Loader | UNET加载器-ComfyUI节点")
中文
System
