# 原始URL: https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only

# 抓取时间: 2025-03-30 21:03:05

[Skip to content](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [前提条件](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#前提条件)
  * [输入类型](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#输入类型)
  * [输出类型](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#输出类型)
  * [Lora 加载器（仅模型） 使用工作流示例](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#lora-加载器仅模型-使用工作流示例)
  * [什么是LoRA?](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#什么是lora)


[](https://forms.gle/LRjjgeMwDYLdwXbk9)
[节点详解](https://comfyui-wiki.com/zh/comfyui-nodes "节点详解")[Loaders](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/checkpoint-loader-simple "Loaders")Lora Loader Model Only
←→
...
[LoRA模型资源](https://comfyui-wiki.com/zh/resource/lora-models)
如果你不知道如何安装，下面是LoRA模型安装的教程
[LoRA模型安装指南](https://comfyui-wiki.com/zh/install/install-models/install-lora)
## 输入类型[](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader-model-only#输入类型)
参数名称| 数据类型| 作用  
---|---|---  
...
[Lora Loader - ComfyUI 节点说明](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/lora-loader "Lora Loader - ComfyUI 节点说明")[Style Model Loader](https://comfyui-wiki.com/zh/comfyui-nodes/loaders/style-model-loader "Style Model Loader")
中文
System
