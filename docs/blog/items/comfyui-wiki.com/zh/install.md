# 原始URL: https://comfyui-wiki.com/zh/install

# 抓取时间: 2025-03-30 21:01:50

[Skip to content](https://comfyui-wiki.com/zh/install#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [ComfyUI 在不同设备上的安装方法](https://comfyui-wiki.com/zh/install#comfyui-在不同设备上的安装方法)
  * [ComfyUI 中不同类型模型的安装方法](https://comfyui-wiki.com/zh/install#comfyui-中不同类型模型的安装方法)
  * [ComfyUI 自定义插件的安装方法](https://comfyui-wiki.com/zh/install#comfyui-自定义插件的安装方法)
...
# ComfyUI 安装指南
本节主要涵盖了 ComfyUI 中常见的安装类型说明，包括软件本身、插件、绘图模型等。我们将为您提供详细的安装步骤和注意事项，帮助您顺利搭建 AI 图像生成环境。
## ComfyUI 在不同设备上的安装方法[](https://comfyui-wiki.com/zh/install#comfyui-在不同设备上的安装方法)
本部分将介绍如何在各种设备和操作系统上安装 ComfyUI，包括 Windows、Mac、Linux 等平台。我们提供了详细的步骤指南，确保您能够在自己的设备上成功安装 ComfyUI。
All (8)ComfyUI安装教程WindowsMacLinuxColabGPU硬件
[![1.1 ComfyUI Desktop](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/comfyui-desktop-installation-guide)
[1.1 ComfyUI Desktop](https://comfyui-wiki.com/zh/install/install-comfyui/comfyui-desktop-installation-guide)
ComfyUI Desktop 的完整安装和使用教程，包括下载、安装、配置和基本使用说明
ComfyUI
安装教程
[![1.2 Windows](https://comfyui-wiki.com/cover/images/windows.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-windows)
[1.2 Windows](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-windows)
ComfyUI常见安装问题解析
Windows
[![1.3 Mac](https://comfyui-wiki.com/cover/images/macos.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-mac)
[1.3 Mac](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-mac)
本文详细介绍了如何在 Mac 系统上安装和配置 ComfyUI，包括环境准备、依赖安装、模型配置等步骤，帮助用户快速搭建 AI 绘图环境。
Mac
[![1.4 Linux](https://comfyui-wiki.com/cover/images/linux.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux)
[1.4 Linux](https://comfyui-wiki.com/zh/install/install-comfyui/install-comfyui-on-linux)
本文详细介绍了如何在 Linux 系统上安装和配置 ComfyUI，包括环境准备、依赖安装、模型配置等步骤，帮助用户快速搭建 AI 绘图环境。
Linux
[![1.5 Run on Cloud](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/run-comfyui-on-cloud)
[1.5 Run on Cloud](https://comfyui-wiki.com/zh/install/install-comfyui/run-comfyui-on-cloud)
本文介绍了如何在云端平台上运行 ComfyUI，包括使用 Google Colab 和其他在线平台的方法。
Colab
[![1.6 Install Git](https://comfyui-wiki.com/cover/images/git.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/install-git)
[1.6 Install Git](https://comfyui-wiki.com/zh/install/install-comfyui/install-git)
快速学习如何安装 Git 并使用它来下载 ComfyUI 插件和模型，包含可视化学习教程
[![1.7 秋叶启动器指南](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide)
[1.7 秋叶启动器指南](https://comfyui-wiki.com/zh/install/install-comfyui/aaaki-comfyui-launcher-user-guide)
秋叶 ComfyUI 整合包是一个工具，允许你轻松管理和安装各种 ComfyUI 插件。它提供了一个用户友好的界面来搜索、安装和更新插件，使你更容易定制和增强你的 ComfyUI 体验。
[![1.8 GPU 购买参考](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide)
[1.8 GPU 购买参考](https://comfyui-wiki.com/zh/install/install-comfyui/gpu-buying-guide)
详细介绍在使用AI绘图软件(如ComfyUI)时,应该如何选择合适的GPU,包括不同品牌和型号的性能对比及推荐
GPU
硬件
## ComfyUI 中不同类型模型的安装方法[](https://comfyui-wiki.com/zh/install#comfyui-中不同类型模型的安装方法)
了解如何在 ComfyUI 中安装和使用各种类型的模型，如 Stable Diffusion 检查点、LoRA 模型、嵌入、VAE、ControlNet 模型等。这些模型将大大增强您的 AI 图像生成能力。
All (6)CheckpointControlNetEmbeddingsHypernetworkLoRAVae
[![3.1 安装检查点](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint)
[3.1 安装检查点](https://comfyui-wiki.com/zh/install/install-models/install-checkpoint)
本文详细介绍了如何在 ComfyUI 中安装和使用 stable diffusion 模型，包括下载模型、安装模型、验证安装是否成功等步骤，帮助用户快速搭建 AI 绘图环境。
Checkpoint
[![3.2 安装 ControlNet](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-controlnet)
[3.2 安装 ControlNet](https://comfyui-wiki.com/zh/install/install-models/install-controlnet)
本文简要介绍了在 ComfyUI 中安装 ControlNet 模型的方法,包括模型下载和安装步骤。
ControlNet
[![3.3 安装 Embeddings](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-embeddings)
[3.3 安装 Embeddings](https://comfyui-wiki.com/zh/install/install-models/install-embeddings)
本文详细介绍了如何在 ComfyUI 中安装和使用 Embeddings（Textual Inversion）模型，包括下载模型、安装模型、验证安装是否成功等步骤，帮助用户快速搭建 AI 绘图环境。
Embeddings
[![3.4 安装 Hypernetwork](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-hypernetwork)
[3.4 安装 Hypernetwork](https://comfyui-wiki.com/zh/install/install-models/install-hypernetwork)
本文详细介绍了如何在 ComfyUI 中安装和使用 Hypernetwork 模型，包括下载模型、安装模型、验证安装是否成功等步骤，帮助用户快速搭建 AI 绘图环境。
Hypernetwork
[![3.5 安装 LoRA](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-lora)
[3.5 安装 LoRA](https://comfyui-wiki.com/zh/install/install-models/install-lora)
本文详细介绍了如何在 ComfyUI 中安装和使用 LoRA 模型，包括下载模型、安装模型、验证安装是否成功等步骤，帮助用户快速搭建 AI 绘图环境。
LoRA
[![3.6 安装 VAE](https://comfyui-wiki.com/thumbnail.jpg)](https://comfyui-wiki.com/zh/install/install-models/install-vae)
[3.6 安装 VAE](https://comfyui-wiki.com/zh/install/install-models/install-vae)
本文详细介绍了在comfyUI中安装和使用VAE模型的方法,包括VAE模型的原理、下载途径、安装步骤以及在comfyUI中的使用方式。
Vae
## ComfyUI 自定义插件的安装方法[](https://comfyui-wiki.com/zh/install#comfyui-自定义插件的安装方法)
自定义插件可以极大地扩展 ComfyUI 的功能。本节将指导您如何正确安装和管理这些插件，以充分发挥 ComfyUI 的潜力。
[ComfyUI 插件安装详细教程](https://comfyui-wiki.com/zh/install/install-custom-nodes)
Last updated on 2025年3月24日
[1. 安装 ComfyUI](https://comfyui-wiki.com/zh/install/install-comfyui "1. 安装 ComfyUI")
中文
System
