# 原始URL: https://comfyui-wiki.com/zh/faq

# 抓取时间: 2025-03-30 21:04:23

[Skip to content](https://comfyui-wiki.com/zh/faq#reach-skip-nav)
...
[![RunComfy](https://comfyui-wiki.com/patron/runcomfy-logo.png)RunComfyComfyUI Cloud](https://www.runcomfy.com)[![Comfy Deploy](https://comfyui-wiki.com/patron/comfydeploy-logo.png)Comfy DeployRun and deploy your ComfyUI workflows](https://comfydeploy.com/?utm_source='comfyui-wiki'&utm_content='sidebar')[![Comfy Online](https://comfyui-wiki.com/patron/comfyonline-logo.png)Comfy OnlineRun ComfyUI workflows online and deploy APIs with one click](https://www.comfyonline.app/)[![Comfy.ICU](https://comfyui-wiki.com/patron/comfy-icu-logo.png)Comfy.ICURun ComfyUI in the cloud](https://comfy.icu/)[![InstaSD](https://comfyui-wiki.com/patron/instasd-logo.png)InstaSDHow creative teams run & deploy workflows](https://www.instasd.com/)
  * [问题分类](https://comfyui-wiki.com/zh/faq#问题分类)
  * [常见问题列表](https://comfyui-wiki.com/zh/faq#常见问题列表)
  * [寻求帮助](https://comfyui-wiki.com/zh/faq#寻求帮助)
  * [贡献](https://comfyui-wiki.com/zh/faq#贡献)
...
# ComfyUI 常见问题解答
本页面收集了 ComfyUI 使用过程中的常见问题和解答。我们将这些问题分类整理，方便你快速找到所需的信息。
## 问题分类[](https://comfyui-wiki.com/zh/faq#问题分类)
你可以根据以下分类查找相关问题：
  * **基础使用问题** ：界面操作、基本功能等
  * **模型相关问题** ：模型加载、配置、性能等
...
## 常见问题列表[](https://comfyui-wiki.com/zh/faq#常见问题列表)
All (7)ComfyUI Manager网络设置配置
[![解决ComfyUI Manager安全级别报错「This action is not allowed」的完整指南](https://comfyui-wiki.com/thumbnail.svg)2025年3月9日解决ComfyUI Manager安全级别报错「This action is not allowed」的完整指南当通过 Git URL 安装 ComfyUI 插件时遇到 `This action is not allowed with this security level configuration` 报错，本质是ComfyUI Manager的安全策略限制了外部代码执行。本教程提供了方案，覆盖 Windows/macOS/Linux 全平台操作。](https://comfyui-wiki.com/zh/faq/fix-comfyui-manager-security-level-error)[![ComfyUI Fast Groups 替代方案和使用指南](https://comfyui-wiki.com/thumbnail.svg)2024年3月21日ComfyUI Fast Groups 替代方案和使用指南探讨 ComfyUI 中 Fast Groups Muter 的替代方案和使用技巧，帮助用户更好地管理工作流程中的节点组。](https://comfyui-wiki.com/zh/faq/comfyui-fast-groups-alternatives)[![如何在 ComfyUI 中调整字体大小：分步指南](https://comfyui-wiki.com/thumbnail.svg)2024年3月21日如何在 ComfyUI 中调整字体大小：分步指南详细的分步指南，教你如何在 ComfyUI 中调整不同区域的字体大小](https://comfyui-wiki.com/zh/faq/how-to-change-font-size)[![如何更改 ComfyUI 的输出文件夹位置](https://comfyui-wiki.com/thumbnail.svg)2024年3月21日如何更改 ComfyUI 的输出文件夹位置本文详细介绍了在 ComfyUI 中更改默认输出文件夹的多种方法](https://comfyui-wiki.com/zh/faq/how-to-change-output-folder)[![如何启用 ComfyUI 新版本菜单](https://comfyui-wiki.com/thumbnail.svg)2024年3月21日如何启用 ComfyUI 新版本菜单详细介绍如何在 ComfyUI v0.2.0 及以上版本中启用新版本菜单界面](https://comfyui-wiki.com/zh/faq/how-to-enable-new-menu)[![为什么使用相同的种子值，ComfyUI 和 A1111 生成的图像不一样？](https://comfyui-wiki.com/thumbnail.svg)2024年3月21日为什么使用相同的种子值，ComfyUI 和 A1111 生成的图像不一样？详细解释 ComfyUI 和 Automatic1111 WebUI 在图像生成方面的差异，包括噪声生成和提示词权重的处理方式](https://comfyui-wiki.com/zh/faq/why-different-images-from-a1111)[![如何在局域网中访问 ComfyUI](https://comfyui-wiki.com/thumbnail.svg)Invalid Date如何在局域网中访问 ComfyUI学习如何在便携版和桌面版中设置 ComfyUI 服务器以支持局域网访问](https://comfyui-wiki.com/zh/faq/how-to-access-comfyui-on-lan)
## 寻求帮助[](https://comfyui-wiki.com/zh/faq#寻求帮助)
如果你在 ComfyUI Wiki 中没有找到需要的答案，可以尝试在以下社区寻求帮助：
  1. **官方社区**
     * [ComfyUI GitHub Issues](https://github.com/comfyanonymous/ComfyUI/issues) - 提交问题或查找已有解决方案
     * [ComfyUI Discord](https://discord.com/invite/comfyorg) - 与其他用户和开发者实时交流
  2. **社区讨论**
     * [Reddit r/ComfyUI](https://www.reddit.com/r/comfyui/) - 分享经验和寻求帮助
     * [GitHub Discussions](https://github.com/comfyanonymous/ComfyUI/discussions) - 参与技术讨论


如果你发现了有价值的解决方案，欢迎通过[反馈表单](https://forms.gle/LRjjgeMwDYLdwXbk9)提交给我们，帮助完善 ComfyUI Wiki 的内容。
## 贡献[](https://comfyui-wiki.com/zh/faq#贡献)
欢迎帮助我们完善这个 FAQ：
  1. 提交新的常见问题
  2. 改进现有答案
...
你可以通过我们的[反馈表单](https://forms.gle/LRjjgeMwDYLdwXbk9)提交内容，或发送邮件至 contact@comfyui-wiki.com。
如果你发现：
  * 内容错误
  * 需要更新的内容
  * 缺失的信息
...
都可以通过反馈表单告诉我们。我们会及时处理你的反馈，共同改进 ComfyUI Wiki 的内容质量。
Last updated on 2025年3月24日
[Tencent-Hunyuan 腾讯混元相关资源](https://comfyui-wiki.com/zh/resource/tencent-hunyuan "Tencent-Hunyuan 腾讯混元相关资源")[ComfyUI Fast Groups 替代方案和使用指南](https://comfyui-wiki.com/zh/faq/comfyui-fast-groups-alternatives "ComfyUI Fast Groups 替代方案和使用指南")
中文
System
